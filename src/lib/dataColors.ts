...
export const DATA_COLORS = Object.freeze({
  ...
  offPlan:    { text: 'text-[color:var(--emerald-1)]', bg: 'bg-[color:var(--emerald-1)]', gradient: 'from-[color:var(--emerald-1)] to-[color:var(--emerald-2)]', light: 'bg-[color:var(--emerald-soft-bg)]', border: 'border-[color:var(--emerald-1)]/30', dot: 'bg-[color:var(--emerald-1)]' },
  ...
  // Metrics
  growth:     { text: 'text-[color:var(--emerald-1)]', bg: 'bg-[color:var(--emerald-1)]' },
  decline:    { text: 'text-red-600',     bg: 'bg-red-500' },
  issue:      { text: 'text-red-600',     bg: 'bg-red-100',     border: 'border-red-300' },
  
  // Investment
  roi:        { text: 'text-[color:var(--emerald-1)]', bg: 'bg-[color:var(--emerald-1)]', light: 'bg-[color:var(--emerald-soft-bg)]', border: 'border-[color:var(--emerald-1)]/30', ring: 'ring-[color:var(--emerald-ring)]' },
  ...
  price:      { text: 'text-[color:var(--emerald-1)]', bg: 'bg-[color:var(--emerald-1)]' },
  volume:     { text: 'text-purple-600',  bg: 'bg-purple-500' },

  // Property types
  villa:      { text: 'text-[color:var(--emerald-1)]', dot: 'bg-[color:var(--emerald-1)]' },
  ...
  // Activity levels
  active:     { text: 'text-[color:var(--emerald-1)]', bg: 'bg-[color:var(--emerald-soft-bg)]',  border: 'border-[color:var(--emerald-1)]/40' },
  ...
  demand:     { text: 'text-[color:var(--emerald-1)]', bg: 'bg-[color:var(--emerald-1)]', gradient: 'from-[color:var(--emerald-1)] to-[color:var(--emerald-2)]', light: 'bg-[color:var(--emerald-soft-bg)]' },
});
