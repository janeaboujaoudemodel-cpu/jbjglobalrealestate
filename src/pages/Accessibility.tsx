          ...
          <main className="flex-1 min-w-0">
            ...
            <section id="standards" className="scroll-mt-8">
              ...
              <CCard className="space-y-4 text-[#1A1A1A]/70 leading-relaxed">
                ...
                <div className="mt-4 bg-[#C8A766]/10 border border-[#C8A766]/20 rounded-lg p-4"><p className="text-[#1A1A1A]/70 text-sm">We continuously review and improve accessibility features as part of our ongoing digital enhancement process.</p></div>
              </CCard>
            </section>
            <GoldDivider />
            ...
            <section id="feedback" className="scroll-mt-8">
              ...
              <CCard className="space-y-4 text-[#1A1A1A]/70 leading-relaxed">
                ...
                <div className="bg-[#C8A766]/10 border border-[#C8A766]/20 rounded-lg p-5 mt-4">
                  ...
                  <p className="text-sm text-[#1A1A1A]/70 mt-2">Email: <a href="mailto:accessibility@JBJ.ae" className="text-[#C8A766] hover:underline">accessibility@JBJ.ae</a></p>
                  <p className="text-sm text-[#1A1A1A]/70 mt-1">Or use our <Link to="/contact" className="text-[#C8A766] hover:underline">contact form</Link>.</p>
