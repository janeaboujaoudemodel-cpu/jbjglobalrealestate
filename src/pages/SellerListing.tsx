            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-6 md:p-8 shadow-xl">
              <AnimatePresence mode="wait">
                ...
                {currentStep === 4 && (
                  ...
                  >
                    <div>
                      <h2 className="text-xl font-bold text-white mb-2">Condition & Upgrades</h2>
                      <p className="text-zinc-400 text-sm">Tell us about the property's condition and any improvements</p>
                    </div>
                    ...
                    {form.watch("has_upgrades") && (
                      <div>
                        <Label className="text-white">Upgrade Details</Label>
                        <Textarea
                    ...
                    <div>
                      <Label className="text-white mb-3 block">Key Highlights (up to 10)</Label>
                ...
                {currentStep === 5 && (
                  ...
                  >
                    <div>
                      <h2 className="text-xl font-bold text-white mb-2">Media Uploads</h2>
                      <p className="text-zinc-400 text-sm">Upload photos and videos of your property</p>
                    </div>

                    <div className="space-y-6">
                      {/* Photos */}
                      <div>
                        <Label className="text-white mb-2 block">Property Photos</Label>
                        <div className="border-2 border-dashed border-zinc-700 rounded-lg p-6 text-center hover:border-gold/50 transition-colors">
                          ...
                          <label htmlFor="photo-upload" className="cursor-pointer">
                            ...
                            <p className="text-zinc-500 text-xs mt-1">JPG, PNG up to 10MB each</p>
                          </label>
                        </div>
                        {photoFiles.length > 0 && (
                      ...
                      {/* Videos */}
                      <div>
                        <Label className="text-white mb-2 block">Property Videos (optional)</Label>
                        <div className="border-2 border-dashed border-zinc-700 rounded-lg p-6 text-center hover:border-gold/50 transition-colors">
                          <input
                            type="file"
                            multiple
                          ...
                          <label htmlFor="video-upload" className="cursor-pointer">
                            ...
                            <p className="text-zinc-500 text-xs mt-1">MP4, MOV up to 100MB each</p>
                          </label>
                        </div>
                        {videoFiles.length > 0 && (
                      ...
                      {/* Floor Plans */}
                      <div>
                        <Label className="text-white mb-2 block">Floor Plans (optional)</Label>
                        <div className="border-2 border-dashed border-zinc-700 rounded-lg p-6 text-center hover:border-gold/50 transition-colors">
                          <input
                            type="file"
                            multiple
                          ...
                          <label htmlFor="floorplan-upload" className="cursor-pointer">
                            ...
                            <p className="text-zinc-400">Click to upload floor plans</p>
                            <p className="text-zinc-500 text-xs mt-1">PDF, JPG, PNG</p>
                          </label>
                        </div>
                ...
                {currentStep === 6 && (
                  ...
                  >
                    <div>
                      <h2 className="text-xl font-bold text-white mb-2">Documents Vault</h2>
                      <p className="text-zinc-400 text-sm">Upload required documents securely. These are only visible to you and our team.</p>
                    </div>

                    <div className="bg-gold/10 border border-gold/20 rounded-lg p-4 flex items-start gap-3">
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <div className={`border-2 border-dashed rounded-lg p-6 text-center transition-colors ${
                          ...
                          <label htmlFor="titledeed-upload" className="cursor-pointer">
                            <FileText className="w-8 h-8 text-zinc-500 mx-auto mb-2" />
                            <p className="text-zinc-400">Upload Title Deed</p>
                          </label>
                        </div>
                        {titleDeedFile && (
                      ...
                      <div>
                        <Label className="text-white mb-2 block">Passport / Emirates ID</Label>
                        <div className="border-2 border-dashed border-zinc-700 rounded-lg p-6 text-center hover:border-gold/50 transition-colors">
                          <input
                            type="file"
                            accept="application/pdf,image/*"
                          ...
                          <label htmlFor="passport-upload" className="cursor-pointer">
                            ...
                            <p className="text-zinc-400">Upload ID Document</p>
                          </label>
                        </div>
                        {passportFile && (
                          <p className="text-gold text-sm mt-2 flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <div className={`border-2 border-dashed rounded-lg p-6 text-center transition-colors ${
                            ...
                            <label htmlFor="poa-upload" className="cursor-pointer">
                              <FileText className="w-8 h-8 text-zinc-500 mx-auto mb-2" />
                              <p className="text-zinc-400">Upload POA Document</p>
                            </label>
                          </div>
                          {poaFile && (
                            <p className="text-gold text-sm mt-2 flex items-center gap-2">
                      ...
                      <div>
                        <Label className="text-white mb-2 block">Additional Documents (optional)</Label>
                        <div className="border-2 border-dashed border-zinc-700 rounded-lg p-6 text-center hover:border-gold/50 transition-colors">
                          <input
                            type="file"
                            multiple
                          ...
                          <label htmlFor="additional-upload" className="cursor-pointer">
                            <Upload className="w-8 h-8 text-zinc-500 mx-auto mb-2" />
                            <p className="text-zinc-400">Upload any other documents</p>
                          </label>
                        </div>
                ...
                {currentStep === 7 && (
                  ...
                  >
                    <div>
                      ...
                      <p className="text-zinc-400 text-sm">Please review your information before submitting</p>
                    </div>
                      ...
                      <div className="bg-zinc-800/50 border border-zinc-700 rounded-lg p-4">
                        ...
                        <div className="grid grid-cols-2 gap-2 text-sm">
                          ...
                          {form.getValues("bedrooms") !== undefined && (
                            <>
                              <p className="text-zinc-400">Bedrooms:</p>
                    ...
                    <div className="flex items-start space-x-3 p-4 bg-gold/5 border border-gold/20 rounded-lg">
                      <Checkbox
