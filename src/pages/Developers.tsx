    ...
    <>
      ...
      <div className="min-h-screen bg-[hsl(var(--premium-bg))]">
        ...
        {isFilterFixed && createPortal(
          <section className="fixed top-[48px] left-0 lg:left-[200px] [body.jj-vertical-nav-collapsed_&]:lg:left-[48px] right-0 z-[9998] backdrop-blur-md bg-gradient-to-br from-[#FDFBF7]/90 via-[#F5F0E6]/90 to-[#EDE4D3]/90 py-4 border-b border-gold/30 shadow-lg">
            <div className="container mx-auto px-3 sm:px-4">
              <div className="bg-gradient-to-br from-champagne-light via-champagne to-champagne-dark border border-gold/30 rounded-2xl p-4 sm:p-5 shadow-lg">
                <FilterShortcutBar
                  variant="light"
