...
const Auth = forwardRef<HTMLDivElement>((_, ref) => {
  ...
  const handleSocialSignIn = async (provider: "google" | "apple") => {
    ...
    try {
      ...
      if (result?.error) {
        toast.error(`We're sorry, there was an issue with ${provider === "google" ? "Google" : "Apple"} sign-in. Please try again or use email/password.`);
      }
    } catch {
            ...
            <>
              ...
              <div className="flex gap-3 mb-4">
                <Button
                  ...
                  className="flex-1 h-12 bg-white hover:bg-gray-50 text-black font-medium rounded-xl flex items-center justify-center gap-2 border border-gray-300 hover:border-gold/50 transition-all duration-300 shadow-sm"
                >
                ...
                <Button
                  ...
                  disabled={isSubmitting}
                  className="flex-1 h-12 bg-black hover:bg-zinc-900 text-white font-medium rounded-xl flex items-center justify-center gap-2 border border-black transition-all duration-300 shadow-sm"
                >
