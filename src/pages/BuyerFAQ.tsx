...
import {
  HelpCircle, Home, Banknote, Users, LucideIcon,
    ...
    <>
      ...
      <FAQPageShell
        hero={{
          ...
          subtitle: "Everything you need to know about buying property in the UAE — costs, mortgages, process, and beyond.",
        }}
        categories={categories}
        currentPath="/buyer-faq"
        cta={{
          body: "Our team is here to help with any property buying questions.",
