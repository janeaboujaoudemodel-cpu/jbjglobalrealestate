  ...
  return (
    <div data-neon-page className="min-h-screen bg-[#FDFBF7]">
      ...
      <FAQHero
        ...
        title={<>Buyer Questions <span className="text-[#1A1A1A]">Answered</span></>}
        ...
        actions={
          <>
            <Button 
              className="relative bg-gradient-to-r from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] border border-[#B89555]/40 px-6 py-3 shadow-[0_4px_20px_rgba(200,167,102,0.3)] hover:bg-[#1A1A1A] hover:text-white hover:[&_svg]:text-[#B89555] hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(184,149,85,0.35)] transition-all duration-300"
        ...
        <div className="container mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="max-w-3xl mx-auto">
            <div className="bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] border-2 border-[#B89555]/40 rounded-2xl p-8 md:p-12 text-center">
              ...
              <p className="text-[#1A1A1A]/70 mb-8 max-w-xl mx-auto">Our team is here to help with any property buying questions.</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] border-2 border-[#B89555]/40 rounded-xl p-6">
              <p className="text-center text-[#1A1A1A]/70 text-sm"><span className="text-[#1A1A1A] font-medium">Disclaimer:</span> All content is educational and informational. Decisions should reflect individual objectives.</p>
            </div>
          </div>
        </div>
      </section>
