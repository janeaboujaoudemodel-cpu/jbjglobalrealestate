...
const CRMLeadDetail = () => {
  ...
  useEffect(() => {
    ...
    supabase.rpc('log_crm_lead_access', { p_lead_id: id, p_user_id: user.id, p_access_type: 'view' } as any).then(() => {});
  }, [user, id, navigate]);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <Card className="border-2 border-[#B89555]/30 bg-gradient-to-br from-[hsl(40,33%,98%)]/95 to-[hsl(36,25%,88%)]/80 shadow-[0_8px_30px_rgba(200,167,102,0.12)]">
            ...
            <CardContent className="grid grid-cols-1 gap-2">
              <Button className="w-full justify-start jj-surface-emerald hover:jj-surface-emerald text-white text-sm h-9" onClick={() => setActiveTab("whatsapp")} disabled={!lead.phone_e164}>
