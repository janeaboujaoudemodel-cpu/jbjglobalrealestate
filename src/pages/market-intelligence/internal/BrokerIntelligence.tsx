          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-white/90">All tools in one place • Market signals • AI Assistant • Contracts</p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <Tabs defaultValue="signals" className="w-full">
            <TabsList className="bg-[#FDFBF7] border border-[#1A1A1A] w-full flex flex-wrap justify-start gap-1 h-auto p-1">
              ...
              <TabsTrigger 
                value="calendar" 
                className="flex items-center gap-2 data-[state=active]:jj-surface-emerald-soft data-[state=active]:text-emerald-400"
              >
