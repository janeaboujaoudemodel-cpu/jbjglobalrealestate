          ...
          <div className="space-y-10">
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-[#1A1A1A]/70 leading-relaxed mt-4 pt-4 border-t border-gold/30">
              ...
              >
                ...
                <div className="bg-[#FDFBF7]/80 rounded-lg border-2 border-gold/50 p-6">
                  ...
                  <p className="text-[#1A1A1A]/70 text-xs mt-6 pt-4 border-t border-gold/30">
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-[#1A1A1A]/70 leading-relaxed mt-6 pt-4 border-t border-gold/30">
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-[#1A1A1A]/70 leading-relaxed mt-6 pt-4 border-t border-gold/30 italic">
