...
const PropertiesReelly = () => {
  ...
  return (
    <>
      ...
      <section 
        className={cn(
          "fixed top-[40px] z-[9998] backdrop-blur-md bg-gradient-to-br from-champagne-light/90 via-champagne/90 to-champagne-dark/90 py-2 border-b border-gold/30 right-0",
