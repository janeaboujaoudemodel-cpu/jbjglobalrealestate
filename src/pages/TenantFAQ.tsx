...
const TenantFAQ = () => {
  ...
  return (
    <div data-neon-page className="min-h-screen bg-gradient-to-br from-[hsl(32,28%,13%)] via-[hsl(33,27%,15%)] to-[hsl(33,28%,11%)]">
      ...
      <FAQHero badge="Tenant FAQ" badgeIcon={HelpCircle} title={<>Tenant Questions <span className="text-[#1A1A1A]">Answered</span></>} description="Everything you need to know about renting property in the UAE." backgroundImage="https://images.unsplash.com/photo-1560518883-ce09059eeffa?auto=format&fit=crop&w=2000&q=80"
        actions={<>
