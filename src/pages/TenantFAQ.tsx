...
import { HelpCircle, Shield, Home, Users, LucideIcon, Wrench, AlertTriangle } from "lucide-react";
...
const TenantFAQ = () => {
  ...
  return (
    <>
      <SEOHead
        title="Tenant FAQ | Renting Questions Answered | JBJ Global Real Estate"
        description="Answers to common tenant questions about renting in the UAE — deposits, rights, maintenance, and moving out."
        canonicalPath="/tenant-faq"
      ...
      <FAQPageShell
        hero={{
          ...
          title: "Tenant Questions Answered",
          subtitle: "Everything you need to know about renting property in the UAE.",
        }}
        categories={categories}
        currentPath="/tenant-faq"
        cta={{
          body: "Our leasing team is ready to assist with any tenant questions.",
          guideHref: "/tenant-guide",
          guideLabel: "Read Tenant Guide",
        }}
      />
    </>
  );
