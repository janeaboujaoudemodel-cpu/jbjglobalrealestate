...
const EmployeeChatPage: React.FC = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] flex items-center justify-center">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-[#1A1A1A]/60 text-sm font-medium">Loading Team Chat...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6]">
      ...
      {/* Header */}
      <div className="bg-[#FDFBF7]/60 backdrop-blur-sm border-b border-[#B89555]/20">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-4">
            <Card className="bg-[#FDFBF7] border border-[#B89555]/20 shadow-sm">
              <CardContent className="p-3 sm:p-4 flex items-center gap-3">
                <div className="p-2 rounded-lg jj-surface-emerald-soft border border-[color:var(--emerald-1)]/30/20">
                  <Wifi className="h-4 w-4 text-[color:var(--emerald-1)]" />
                </div>
                <div>
                  <p className="text-xl font-bold text-[#1A1A1A]">{onlineCount}</p>
                  <p className="text-xs text-[#1A1A1A]/60">Online Now</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-[#FDFBF7] border border-[#B89555]/20 shadow-sm">
              <CardContent className="p-3 sm:p-4 flex items-center gap-3">
                ...
                <div>
                  <p className="text-xl font-bold text-[#1A1A1A]">{totalEmployees}</p>
                  <p className="text-xs text-[#1A1A1A]/60">Total Team</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-[#FDFBF7] border border-[#B89555]/20 shadow-sm">
              <CardContent className="p-3 sm:p-4 flex items-center gap-3">
                ...
                <div>
                  <p className="text-xl font-bold text-[#1A1A1A]">24/7</p>
                  <p className="text-xs text-[#1A1A1A]/60">Available</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-[#FDFBF7] border border-[#B89555]/20 shadow-sm">
              <CardContent className="p-3 sm:p-4 flex items-center gap-3">
                ...
                <div>
                  <p className="text-xl font-bold text-[#1A1A1A]">Secure</p>
                  <p className="text-xs text-[#1A1A1A]/60">Encrypted</p>
                </div>
              </CardContent>
            </Card>
          </div>
