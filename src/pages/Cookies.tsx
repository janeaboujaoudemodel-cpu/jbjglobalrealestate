        ...
        <section className="relative py-28 md:py-36 overflow-hidden bg-gradient-to-b from-[#1a1714] to-[#151210] border-b border-[#C8A766]/20">
          ...
          <div className="max-w-5xl mx-auto px-4 relative z-10">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-gray-600 text-sm mt-6">Last updated: February 2026</p>
            </motion.div>
          </div>
        </section>
          ...
          <main className="flex-1 min-w-0">
            ...
            <div className="lg:hidden mb-10 p-5 rounded-2xl border border-[#C8A766]/20 bg-[#1a1714]/80">
              ...
              <nav className="space-y-1">
                {tocItems.map(({ id, label }) => (
                  <button key={id} onClick={() => scrollTo(id)} className="block w-full text-left text-sm text-gray-600 hover:text-[#C8A766] px-3 py-1.5 rounded-lg transition-colors">{label}</button>
                ))}
              </nav>
            </div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <CCard key={i}>
                    ...
                    <p className="text-gray-700 leading-relaxed mb-3">{c.desc}</p>
                    <ul className="list-disc pl-6 space-y-1.5 text-gray-700">{c.items.map((it, j) => <li key={j}>{it}</li>)}</ul>
                    {c.note && <p className="text-gray-600 text-sm mt-3 italic">{c.note}</p>}
                  </CCard>
                ))}
              </div>
            </section>
            ...
            <section id="how-we-use-cookies" className="scroll-mt-8">
              ...
              <CCard className="space-y-4 text-gray-700 leading-relaxed">
                ...
                <p className="text-gray-600 text-sm mt-2">Cookies do not grant us access to your device beyond stored cookie data.</p>
              </CCard>
            </section>
            <GoldDivider />
            ...
            <section id="third-party-cookies" className="scroll-mt-8">
              ...
              <CCard className="space-y-4 text-gray-700 leading-relaxed">
                ...
                <p className="text-gray-600 text-sm">We do not control third-party cookie practices.</p>
              </CCard>
            </section>
            <GoldDivider />
            ...
            <section id="managing-cookies" className="scroll-mt-8">
              ...
              <CCard className="space-y-4 text-gray-700 leading-relaxed">
                ...
                <div className="mt-4 bg-[#C8A766]/10 border border-[#C8A766]/20 rounded-lg p-4">
                  <p className="text-gray-600 text-sm">Please note that disabling certain cookies may impact website functionality and your overall experience.</p>
                </div>
              </CCard>
            </section>
            <GoldDivider />
            ...
            <section id="data-collected" className="scroll-mt-8">
              ...
              <CCard className="space-y-4 text-gray-700 leading-relaxed">
                ...
                <p className="text-gray-600 text-sm mt-2">This data is typically aggregated and anonymised.</p>
              </CCard>
            </section>
            <GoldDivider />
            ...
            <section id="contact" className="scroll-mt-8">
              ...
              <CCard className="text-gray-700 leading-relaxed">
