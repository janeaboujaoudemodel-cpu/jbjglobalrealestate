  ...
  return (
    ...
    >
      ...
      <span
        ...
        data-allow-dark-cta
        data-no-contrast-guard
        className="allow-white pointer-events-none absolute bottom-full left-1/2 z-[61] mb-3 origin-bottom -translate-x-1/2 translate-y-1.5 scale-0 whitespace-nowrap rounded-full px-4 py-2 text-[12px] font-semibold uppercase tracking-[0.18em] text-white transition-all duration-200 group-hover:translate-y-0 group-hover:scale-100"
        style={{
