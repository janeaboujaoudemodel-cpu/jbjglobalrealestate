      ...
      <div className={`min-h-screen bg-[#1A1A1A] flex flex-col items-center justify-center px-4 py-12 md:py-16 relative overflow-hidden ${isRTL ? 'rtl' : 'ltr'}`}>
        ...
        >
          ...
          >
            {/* WhatsApp */}
            <a
              href="https://wa.me/971541515015?text=Hello%2C%20I%20would%20like%20to%20inquire%20about%20your%20services."
              target="_blank"
            ...
            >
              ...
              <span dir="ltr" className="font-medium tracking-wide">+971 54 15 15 015</span>
            </a>
