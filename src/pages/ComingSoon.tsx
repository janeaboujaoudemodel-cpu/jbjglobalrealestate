        ...
        >
          ...
          >
            ...
            <a
              ...
              className="group flex items-center gap-3 text-white/70 hover:text-gold transition-all duration-300"
            >
              <span className="flex items-center justify-center w-12 h-12 rounded-full bg-gold/10 group-hover:bg-gold/20 transition-colors border border-gold/30">
