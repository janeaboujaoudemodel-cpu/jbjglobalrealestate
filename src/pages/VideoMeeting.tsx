  ...
  return (
    ...
    >
          ...
          >
            ...
            {participants.map((participant) => (
              <div key={participant.oderId} className="relative bg-[#FDFBF7] rounded-2xl overflow-hidden group">
                ...
                <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between">
                  <span className="bg-[#1A1A1A]/50 px-3 py-1 rounded-lg text-white text-sm backdrop-blur-sm">
      ...
      <div className="flex items-center justify-center gap-3 py-4 bg-[#FDFBF7]/80 border-t border-[#1A1A1A]">
        ...
        >
          <div className={`w-4 h-4 rounded-full ${isRecording ? 'bg-[#FDFBF7] animate-pulse' : 'bg-red-500'}`} />
        </Button>
        ...
        <DialogContent className="bg-[#FDFBF7] border-[#1A1A1A]">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              ...
              <Button 
                variant="outline" 
                onClick={() => window.location.href = 'https://wa.me/971541515015?text=I%20need%20help%20with%20JBJ%20Video%20Meet'}
              >
                WhatsApp
              </Button>
              <Button 
