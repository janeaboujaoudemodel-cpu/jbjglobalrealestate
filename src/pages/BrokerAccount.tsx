                  ...
                  <div className="space-y-3">
                    {modules.map((module) => {
                      ...
                      return (
                        <div 
                          key={module.id} 
                          className={`flex items-center justify-between p-4 rounded-lg border ${isComplete ? 'jj-surface-emerald-soft border-[color:var(--emerald-1)]/30/20' : 'bg-muted/30'}`}
                        >
                          <div className="flex items-center gap-3">
                            {isComplete ? (
                      ...
                      <div className="space-y-3">
                        {callLogs.map((call) => (
                          <div key={call.id} className="flex items-center justify-between p-3 border rounded-lg">
                            <div className="flex items-center gap-3">
                              <div className={`p-2 rounded-full ${call.call_type === 'inbound' ? 'jj-surface-emerald-soft' : 'bg-blue-500/20'}`}>
