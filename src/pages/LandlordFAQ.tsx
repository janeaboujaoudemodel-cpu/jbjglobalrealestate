...
import { HelpCircle, FileText, Home, Users, LucideIcon, Wrench, Scale } from "lucide-react";
...
const LandlordFAQ = () => {
  ...
  return (
    <>
      <SEOHead
        title="Landlord FAQ | Property Leasing Questions | JBJ Global Real Estate"
        description="Answers for landlords about leasing, tenant management, maintenance, and rental regulations in the UAE."
        canonicalPath="/landlord-faq"
        faqItems={allFaqItems}
      />
      <FAQPageShell
        hero={{
          eyebrow: "Landlord FAQ",
          eyebrowIcon: HelpCircle,
          title: "Landlord Questions Answered",
          subtitle: "Everything you need to know about leasing your property in the UAE.",
        }}
        categories={categories}
        currentPath="/landlord-faq"
        cta={{
          body: "Our leasing team is here to help with any landlord questions.",
          guideHref: "/landlord-guide",
          guideLabel: "Read Landlord Guide",
        }}
      />
    </>
  );
