    ...
    <div className="min-h-screen bg-background py-8 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        {certificate && (
          <>
            {/* Status Card */}
            <Card className={`mb-6 ${!certificate.is_revoked ? 'border-[color:var(--emerald-1)]/30/50 jj-surface-emerald-soft' : 'border-red-500/50 bg-red-500/5'}`}>
              <CardContent className="p-6">
                <div className="flex items-center gap-4">
                  <div className={`w-16 h-16 rounded-full flex items-center justify-center ${!certificate.is_revoked ? 'jj-surface-emerald-soft' : 'bg-red-500/20'}`}>
                  ...
                  <div>
                    <Badge className={!certificate.is_revoked ? 'jj-surface-emerald text-white' : 'bg-red-500 text-white'}>
                      {!certificate.is_revoked ? (
