...
const sourceCopyMap: Record<string, { label: string; question: string; titlePrefix: string }> = {
  ticket: {
    label: "Support Experience",
    question: "How was your support ticket experience?",
    titlePrefix: "Support Ticket Experience",
  },
  listing: {
    label: "Listing Experience",
    question: "How was your listing submission experience?",
    titlePrefix: "Listing Submission Experience",
  },
  career: {
    label: "Career Experience",
    question: "How was your job application experience?",
    titlePrefix: "Job Application Experience",
  },
  job: {
    label: "Career Experience",
    question: "How was your job application experience?",
  ...
  inquiry: {
    label: "Inquiry Experience",
    question: "How was your inquiry experience with our team?",
    titlePrefix: "Inquiry Experience",
  },
  password_change: {
    label: "Security Experience",
    question: "How was your account security update experience?",
    titlePrefix: "Password Change Experience",
  },
  password: {
    label: "Security Experience",
    question: "How was your account security update experience?",
...
const Reviews = () => {
  ...
  const source = (searchParams.get("source") || "website").toLowerCase();
  const quickMode = searchParams.get("mode") === "quick" || source !== "website";

  const contextualCopy = sourceCopyMap[source] || {
    label: "JBJ Client Experience",
    question: "How was your experience with JBJ Global Real Estate?",
    titlePrefix: "JBJ Platform Experience",
  };

  const reviewTitlePrefill = `${contextualCopy.titlePrefix} - ${new Date().toLocaleDateString("en-GB")}`;
          ...
          <section className="py-24">
            <div className="container mx-auto px-4 max-w-3xl">
              <div className="rounded-2xl border border-border bg-card p-6 md:p-10 text-center">
                <p className="text-sm text-muted-foreground mb-2">From your email action: {contextualCopy.label}</p>
                <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Share Your Review</h1>
                <p className="text-muted-foreground mb-6">{contextualCopy.question}</p>
                <FeatureReviewPrompt
                  featureKey={`reviews-email-${source}`}
                  featureLabel={contextualCopy.label}
                  question={contextualCopy.question}
                  initialTitle={reviewTitlePrefill}
                  trigger={
