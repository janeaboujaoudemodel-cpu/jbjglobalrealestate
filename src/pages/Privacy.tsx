...
const BulletList = ({ items }: { items: string[] }) => (
  <ul className="space-y-2 ml-1">
    {items.map((item, i) => (
      <li key={i} className="flex items-start gap-3 text-[#5A4A2E] leading-relaxed text-[15px]">
      ...
      <section className="relative py-28 md:py-36 overflow-hidden bg-gradient-to-b from-[#1a1714] to-[#151210] border-b border-[#C8A766]/20">
        ...
        <div className="max-w-5xl mx-auto px-4 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <p className="text-[#5A4A2E] text-base md:text-lg max-w-3xl leading-relaxed mb-2">This Privacy Policy explains how we collect, use, process, and protect personal data when you interact with our website and services.</p>
            <p className="text-[#5A4A2E] text-base max-w-3xl leading-relaxed">We are committed to safeguarding your information in accordance with applicable UAE data protection principles.</p>
          </motion.div>
        </div>
      </section>
          ...
          <aside className="hidden lg:block w-64 shrink-0">
            <div className="sticky top-24 p-5 rounded-2xl border border-[#C8A766]/20 bg-[#1a1714]/80 backdrop-blur-sm">
              ...
              <nav className="space-y-1">
                {tocItems.map(item => (
                  <button key={item.id} onClick={() => scrollTo(item.id)} className="block w-full text-left text-sm text-[#5A4A2E] hover:text-[#C8A766] hover:bg-[#C8A766]/5 px-3 py-1.5 rounded-lg transition-colors">{item.label}</button>
                ))}
              </nav>
            </div>
          </aside>
          ...
          <main className="flex-1 min-w-0">
            <div className="lg:hidden mb-10 p-5 rounded-2xl border border-[#C8A766]/20 bg-[#1a1714]/80">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-1">
                {tocItems.map(item => (<button key={item.id} onClick={() => scrollTo(item.id)} className="text-left text-sm text-[#5A4A2E] hover:text-[#C8A766] px-3 py-1.5 rounded-lg hover:bg-[#C8A766]/5 transition-colors">{item.label}</button>))}
              </div>
            </div>
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <CCard className="space-y-4">
                <p className="text-[#5A4A2E] leading-relaxed"><strong className="text-[#1A1A1A]">"Personal Data"</strong> means any information that identifies or can identify an individual.</p>
                <p className="text-[#5A4A2E] leading-relaxed"><strong className="text-[#1A1A1A]">"Processing"</strong> means collection, storage, usage, disclosure, or deletion of personal data.</p>
                <p className="text-[#5A4A2E] leading-relaxed"><strong className="text-[#1A1A1A]">"User"</strong> refers to any website visitor or service client.</p>
              </CCard>
            </motion.div>
            <GoldDivider />
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <CCard><p className="text-[#5A4A2E] leading-relaxed mb-4">This Policy applies to:</p><BulletList items={["Website visitors","Clients","Inquiry form submissions","Newsletter subscribers","Service applicants"]} /></CCard>
            </motion.div>
            <GoldDivider />
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <CCard>
                <p className="text-[#5A4A2E] leading-relaxed mb-6">We may collect the following categories of personal data:</p>
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <CCard><p className="text-[#5A4A2E] leading-relaxed mb-4">We collect data:</p><BulletList items={["When you submit inquiry forms","When you request services","When you subscribe to updates","Through cookies and analytics tools","Through direct communication"]} /></CCard>
            </motion.div>
            <GoldDivider />

            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              <ClauseTitle id="legal-basis" number={5}>Legal Basis for Processing</ClauseTitle>
              <CCard><p className="text-[#5A4A2E] leading-relaxed mb-4">We process personal data based on:</p><BulletList items={["Consent","Contractual necessity","Legal obligations","Legitimate business interests"]} /></CCard>
            </motion.div>
            <GoldDivider />
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <CCard>
                <p className="text-[#5A4A2E] leading-relaxed mb-4">We use data to:</p>
                ...
                <div className="mt-6 flex items-start gap-3 p-4 rounded-xl bg-[#C8A766]/10 border border-[#C8A766]/20">
                  ...
                  <p className="text-sm text-[#5A4A2E] font-medium">We do not sell personal data.</p>
                </div>
              </CCard>
            </motion.div>
            <GoldDivider />
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <CCard><p className="text-[#5A4A2E] leading-relaxed mb-4">We may share data with:</p><BulletList items={["Licensed immigration consultants","Real estate developers","Legal advisors","Government authorities (where required)","Technology service providers"]} /><p className="text-[#5A4A2E] text-sm mt-4 leading-relaxed">All sharing is done only as necessary and under appropriate safeguards.</p></CCard>
            </motion.div>
            <GoldDivider />

            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              <ClauseTitle id="transfers" number={8}>International Transfers</ClauseTitle>
              <CCard><p className="text-[#5A4A2E] leading-relaxed mb-4">If data is transferred outside the UAE:</p><BulletList items={["Reasonable safeguards will be applied","Transfers will comply with applicable laws"]} /></CCard>
            </motion.div>
            <GoldDivider />

            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              <ClauseTitle id="retention" number={9}>Data Retention</ClauseTitle>
              <CCard><p className="text-[#5A4A2E] leading-relaxed mb-4">We retain personal data only for as long as:</p><BulletList items={["Necessary to provide services","Required by law","Required for dispute resolution"]} /><p className="text-[#5A4A2E] text-sm mt-4 leading-relaxed">Afterward, data will be securely deleted.</p></CCard>
            </motion.div>
            <GoldDivider />

            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              <ClauseTitle id="security" number={10}>Data Security</ClauseTitle>
              <CCard><p className="text-[#5A4A2E] leading-relaxed mb-4">We implement:</p><BulletList items={["Secure servers","Encrypted communications","Access controls","Internal confidentiality protocols"]} /><p className="text-[#5A4A2E] text-sm mt-4 leading-relaxed">No online transmission is 100% secure, but we apply reasonable protection measures.</p></CCard>
            </motion.div>
            <GoldDivider />

            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              <ClauseTitle id="rights" number={11}>Your Rights</ClauseTitle>
              <CCard><p className="text-[#5A4A2E] leading-relaxed mb-4">Users may have the right to:</p><BulletList items={["Access their personal data","Request correction","Request deletion (where legally permissible)","Withdraw consent","Request restriction of processing"]} /><p className="text-[#5A4A2E] text-sm mt-4 leading-relaxed">Requests may be submitted via official contact channels.</p></CCard>
            </motion.div>
            <GoldDivider />

            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              <ClauseTitle id="cookies" number={12}>Cookies & Tracking</ClauseTitle>
              <CCard><p className="text-[#5A4A2E] leading-relaxed mb-4">This website uses cookies for:</p><BulletList items={["Functionality","Analytics","Performance optimization"]} /><p className="text-[#5A4A2E] text-sm mt-4 leading-relaxed">Users may manage cookie preferences via browser settings. A detailed <Link to="/cookies" className="text-[#C8A766] hover:underline">Cookie Policy</Link> page provides further breakdown.</p></CCard>
            </motion.div>
            <GoldDivider />

            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              <ClauseTitle id="children" number={13}>Children's Privacy</ClauseTitle>
              <CCard><p className="text-[#5A4A2E] leading-relaxed">This website is not intended for individuals under 18 years of age. We do not knowingly collect personal data from minors.</p></CCard>
            </motion.div>
            <GoldDivider />

            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              <ClauseTitle id="changes" number={14}>Changes to This Policy</ClauseTitle>
              <CCard><p className="text-[#5A4A2E] leading-relaxed">We may update this Privacy Policy periodically. Updated versions will be posted on this page.</p></CCard>
            </motion.div>
            <GoldDivider />
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <CCard>
                <p className="text-[#5A4A2E] leading-relaxed mb-4">For privacy-related inquiries:</p>
                <div className="flex items-start gap-3 p-4 rounded-xl bg-[#C8A766]/10 border border-[#C8A766]/20">
                  ...
                  <div>
                    ...
                    <p className="text-[#5A4A2E] text-sm">Dubai, United Arab Emirates</p>
                    <p className="text-[#5A4A2E] text-sm mt-1">Email: <a href="mailto:privacy@JBJ.ae" className="text-[#C8A766] hover:underline">privacy@JBJ.ae</a></p>
                  </div>
                </div>
              </CCard>
            </motion.div>
