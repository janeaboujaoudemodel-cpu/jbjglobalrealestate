...
const brokerOperations = [
  ...
  },
  {
    ...
    subtitle: "Broker Operations Support",
    description: "RERA compliance, property documentation, and broker operational support.",
    icon: User,
    color: "text-gold",
    bgColor: "bg-gold/10",
      ...
      <Link to={item.link} className="block group h-full">
        <Card className="bg-white border border-zinc-200 hover:border-gold shadow-lg shadow-zinc-200/50 hover:shadow-xl hover:shadow-gold/20 transition-all duration-300 h-full group-hover:scale-[1.02]">
          <CardContent className="p-5">
            ...
            <p className="text-gold text-sm mb-2">{item.subtitle}</p>
