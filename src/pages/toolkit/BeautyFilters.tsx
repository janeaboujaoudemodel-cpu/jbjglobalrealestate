...
const PRESETS = [
  ...
  { id: 'bright',    name: '☀️ Bright & Clean', adj: { exposure: 15, brightness: 10, contrast: 5, saturation: 8 } },
  { id: 'warm',      name: '🌅 Warm Glow',      adj: { brightness: 5, contrast: 5, saturation: 12, warmth: 30, vignette: 10 } },
  { id: 'cool',      name: '❄️ Cool Pro',       adj: { contrast: 10, saturation: -5, warmth: -20, vignette: 15 } },
  ...
  { id: 'matte',     name: '🎞️ Matte Film',      adj: { contrast: -10, fade: 35, brightness: 5, shadows: 20 } },
