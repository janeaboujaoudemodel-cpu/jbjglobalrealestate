      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div>
                      <h4 className="text-sm font-semibold text-[color:var(--emerald-1)] mb-2">Allowed Changes</h4>
        ...
        >
          <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full jj-emerald-solid/10 border border-[color:var(--emerald-1)]/30/30">
            ...
            <span className="text-[color:var(--emerald-1)]">Fully Locked</span>
            <span className="text-[color:var(--emerald-1)]">•</span>
            <span className="text-[color:var(--emerald-1)]">Institution-Ready</span>
            <span className="text-[color:var(--emerald-1)]">•</span>
            <span className="text-[color:var(--emerald-1)]">Scalable</span>
          </div>
