      ...
      <section className="max-w-4xl mx-auto px-6 py-16 space-y-12">
        ...
        <div className="bg-card border border-[#B89555]/30 rounded-2xl p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href="tel:+9741515015" className="inline-flex items-center gap-2 px-6 py-3 border border-[#B89555]/30 hover:bg-[#EFE6D6]/10 text-foreground rounded-xl font-semibold transition-colors">
              <Phone className="w-4 h-4" /> +974 15 15 015
            </a>
          </div>
        </div>
