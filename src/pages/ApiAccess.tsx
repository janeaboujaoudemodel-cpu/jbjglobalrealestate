  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative py-28 px-6 bg-gradient-to-br from-card via-background to-card border-b border-border">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#EFE6D6]/10 border border-[#B89555]/30 rounded-full mb-6">
            ...
            <span className="text-sm font-medium text-[#1A1A1A]">Protected Platform</span>
          </div>
      ...
      <section className="max-w-4xl mx-auto px-6 py-16 space-y-12">
        {/* Notice */}
        <div className="bg-card border border-[#B89555]/30 rounded-2xl p-8">
          <div className="flex items-start gap-4">
            <Lock className="w-8 h-8 text-[#1A1A1A] flex-shrink-0 mt-1" />
            <div>
        ...
        <div className="bg-card border border-border rounded-2xl p-8">
          ...
          <ol className="space-y-4 text-muted-foreground">
            <li className="flex gap-3">
              <span className="w-7 h-7 rounded-full bg-[#EFE6D6]/20 text-[#1A1A1A] flex items-center justify-center text-sm font-bold flex-shrink-0">1</span>
              <p>Contact our team via the details below with your company name, use case, and expected API usage volume.</p>
            </li>
            <li className="flex gap-3">
              <span className="w-7 h-7 rounded-full bg-[#EFE6D6]/20 text-[#1A1A1A] flex items-center justify-center text-sm font-bold flex-shrink-0">2</span>
              <p>Our legal team will review your request and share the API Terms of Use agreement for signing.</p>
            </li>
            <li className="flex gap-3">
              <span className="w-7 h-7 rounded-full bg-[#EFE6D6]/20 text-[#1A1A1A] flex items-center justify-center text-sm font-bold flex-shrink-0">3</span>
        ...
        {/* Contact */}
        <div className="bg-card border border-[#B89555]/30 rounded-2xl p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href="tel:+971541515015" className="inline-flex items-center gap-2 px-6 py-3 border border-[#B89555]/30 hover:bg-[#EFE6D6]/10 text-foreground rounded-xl font-semibold transition-colors">
              <Phone className="w-4 h-4" /> +971 54 15 15 015   </a>
          </div>
        </div>
