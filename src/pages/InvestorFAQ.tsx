...
const InvestorFAQ = () => {
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      {/* Guide Navigation */}
      <section className="py-12 bg-gradient-to-br from-[#FDFBF7] via-[#F5F0E6] to-[#EDE4D3] border-t border-gold/20">
        <div className="container mx-auto px-4">
      ...
      {/* Disclaimer */}
      <section className="py-8 bg-gradient-to-br from-[#FDFBF7] via-[#F5F0E6] to-[#EDE4D3] border-t border-gold/20">
        <div className="container mx-auto px-4">
