      ...
      <section className="py-20 md:py-28 bg-black relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <div className="h-px w-24 mx-auto bg-gradient-to-r from-transparent via-gold to-transparent mb-10" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-10">
              ...
              >
                <Link 
                  ...
                  className="block p-6 md:p-8 bg-zinc-900/50 border border-white/10 rounded-lg hover:border-gold/50 hover:bg-zinc-900 transition-all duration-300 group"
                >
                  ...
                  <h3 className="text-xl font-semibold text-white mb-2">Buyer</h3>
                  <p className="text-sm text-white/50">
                    Looking for your dream property in the UAE
                  </p>
                </Link>
              </motion.div>
              ...
              >
                ...
                >
                  ...
                  <h3 className="text-xl font-semibold text-white mb-2">Broker</h3>
                  <p className="text-sm text-white/50">
              ...
              >
                ...
                >
                  ...
                  <h3 className="text-xl font-semibold text-white mb-2">Visitor</h3>
                  <p className="text-sm text-white/50">
                    Explore and stay updated on UAE real estate
                  </p>
                </Link>
              </motion.div>
            </div>
            ...
            {/* Gold decorative line */}
            <div className="h-px w-16 mx-auto bg-gradient-to-r from-transparent via-gold/50 to-transparent" />
          </motion.div>
        </div>
      </section>
