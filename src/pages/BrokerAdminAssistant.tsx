        ...
        <div className="container mx-auto px-4 py-6 max-w-7xl">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Your dedicated broker network administrator • Available 24/7</p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            ...
            <Card className="bg-[#0E0E0E] border-yellow-500/20">
              <CardContent className="p-4 flex items-center justify-between">
                <div>
                  <p className="text-xs text-gray-400">⏳ Pending Onboarding</p>
            ...
            <Card className="bg-[#0E0E0E] border-orange-500/20">
              <CardContent className="p-4 flex items-center justify-between">
                <div>
                  <p className="text-xs text-gray-400">⚠️ RERA Expiring</p>
                      ...
                      <div className="mt-4 space-y-4">
                        {pendingBrokers.map((broker) => (
                          <div key={broker.id} className="p-4 bg-zinc-900 rounded-lg border border-zinc-800">
                            ...
                            <p className="text-sm text-gray-400">Start Date: {broker.startDate}</p>
              ...
              <TabsContent value="compliance" className="mt-0">
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
                  <Card className="bg-[#0E0E0E] border-emerald-500/20">
                    ...
                    <CardContent>
                      <p className="text-gray-400">Track RERA licenses, compliance documents, and renewal deadlines for all brokers.</p>
                    </CardContent>
                  </Card>
                </motion.div>
              </TabsContent>
              ...
              <TabsContent value="directory" className="mt-0">
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
                  <Card className="bg-[#0E0E0E] border-emerald-500/20">
                    ...
                    <CardContent>
                      <p className="text-gray-400">Complete directory of all active and inactive brokers with contact information and performance metrics.</p>
                    </CardContent>
                  </Card>
                </motion.div>
              </TabsContent>
              ...
              <TabsContent value="training" className="mt-0">
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
                  <Card className="bg-[#0E0E0E] border-emerald-500/20">
                    ...
                    <CardContent>
                      <p className="text-gray-400">Manage broker training modules, track completion, and issue certifications.</p>
                    </CardContent>
                  </Card>
                </motion.div>
              </TabsContent>
              ...
              <TabsContent value="communications" className="mt-0">
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
                  <Card className="bg-[#0E0E0E] border-emerald-500/20">
                    ...
                    <CardContent>
                      <p className="text-gray-400">Send announcements, reminders, and individual messages to brokers.</p>
                    </CardContent>
                  </Card>
                </motion.div>
              </TabsContent>
              ...
              <TabsContent value="documents" className="mt-0">
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
                  <Card className="bg-[#0E0E0E] border-emerald-500/20">
                    ...
                    <CardContent>
                      <p className="text-gray-400">Manage broker contracts, licenses, and compliance documentation.</p>
                    </CardContent>
                  </Card>
                </motion.div>
              </TabsContent>
              ...
              <TabsContent value="schedule" className="mt-0">
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
                  <Card className="bg-[#0E0E0E] border-emerald-500/20">
                    ...
                    <CardContent>
                      <p className="text-gray-400">Schedule onboarding sessions, training, and broker meetings.</p>
                    </CardContent>
                  </Card>
                </motion.div>
              </TabsContent>
