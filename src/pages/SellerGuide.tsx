...
const SellerGuide = () => {
  ...
  const tocItems = [
    ...
    { id: 'faq', title: 'Seller FAQ', icon: HelpCircle },
  ];

  // Folded in from the standalone /seller-faq page (Guide Consolidation Stage 2).
  const sellerFaqCategories: GuideFAQCategory[] = [
    {
      id: "selling-basics",
  ...
  return (
    <>
      <SEOHead
        ...
        faqItems={sellerFaqCategories.flatMap((c) => c.questions)}
      />
      ...
      <main data-neon-page className="min-h-screen">
              ...
              <div className="jj-card-inner p-6 md:p-8 mb-6 hover:border-[#B89555] hover:shadow-xl hover:shadow-gold/20 transition-all">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-[#1A1A1A]/70">Standard market rate: {agencyCommission.rate}</p>
                  </div>
                </div>
                <p className="text-[#1A1A1A]/70 mb-4">{agencyCommission.paidBy}</p>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {governmentFees.map((fee, index) => (
                    <div key={index} className="jj-card-inner rounded-lg p-4">
                      ...
                      <p className="text-[#1A1A1A]/70 text-sm">{fee.description}</p>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <div className="jj-guide-content">
            ...
            >
              <motion.div variants={fadeInUp} className="jj-box-active p-6 md:p-8">
                ...
                <p className="text-[#1A1A1A]/70 mb-4">If your property has an existing mortgage:</p>
          ...
          <div className="jj-guide-content">
            ...
            >
              <motion.div variants={fadeInUp} className="jj-box-active p-6 md:p-8">
                ...
                <p className="text-[#1A1A1A]/70 mb-4">Off-plan resale depends on:</p>
                <ul className="space-y-3 mb-4">
        ...
        {/* Seller FAQ — folded in from the standalone /seller-faq page (Guide Consolidation Stage 2) */}
        <GuideFAQSection id="faq" title="Seller Questions Answered" categories={sellerFaqCategories} />
