                          ...
                          <div key={chat.id} className="flex items-center justify-between p-3 bg-[#F7F2EA]/50 rounded-lg">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-xs text-white/90">{chat.message_count} messages</p>
                              </div>
                            </div>
                            <span className="text-xs text-white/90">{format(new Date(chat.created_at), 'MMM d')}</span>
                          </div>
                        ))}
                      </div>
                    )}
            ...
            <CardContent className="p-6 md:p-8">
              <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <Button 
                  ...
                  className="bg-gradient-to-r from-gold to-amber-600 text-[#1A1A1A] font-bold px-6 whitespace-nowrap"
                >
                  Get Certified
