  ...
  return (
    <div className={`min-h-screen bg-black flex ${isFixed && !bottomReached ? '' : ''}`}>
      ...
      {isFixed && !bottomReached && createPortal(
        <div
          className="fixed top-[48px] left-0 right-0 z-[9998] shadow-[0_4px_20px_rgba(200,167,102,0.15)] backdrop-blur-md bg-gradient-to-r from-[#FDFBF7]/90 via-[#F5F0E6]/90 to-[#EDE4D3]/90 border-b border-gold/20 py-2 px-2 sm:py-3 sm:px-4 transition-all duration-200 lg:left-[200px] [body.jj-vertical-nav-collapsed_&]:lg:left-[48px]"
        >
