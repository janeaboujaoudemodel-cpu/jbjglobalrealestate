                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {!isLast ? (
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 h-10 px-4 rounded-md font-semibold bg-[#0A0A0A] hover:bg-[#1F1F1F] border border-[#B89555]/70 shadow-[0_4px_12px_rgba(16,37,64,0.25)]"
                          data-allow-dark-cta
                          data-no-contrast-guard
        ...
        <div className="mt-auto pt-5 pb-3 flex items-center justify-between gap-3">
          ...
          {locked ? (
            ...
            <button
              type="button"
              onClick={onStart}
              className="shrink-0 whitespace-nowrap inline-flex items-center gap-1.5 h-9 px-3.5 rounded-md text-sm font-semibold bg-[#0A0A0A] hover:bg-[#1F1F1F] border border-[#B89555]/70 shadow-[0_4px_12px_rgba(16,37,64,0.25)] leading-none"
              data-allow-dark-cta
              data-no-contrast-guard
              style={{ color: "#FFFFFF", WebkitTextFillColor: "#FFFFFF" }}
            >
