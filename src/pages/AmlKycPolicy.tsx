          ...
          <div className="max-w-5xl mx-auto px-4 relative z-10">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full mb-6 border border-[#B89555]/30 bg-[#1A1A1A]/30 backdrop-blur-sm">
                ...
                <span className="text-[#B89555] font-semibold text-xs uppercase tracking-[0.2em]">Compliance</span>
              </div>
        ...
        <div className="max-w-6xl mx-auto px-4 py-12 md:py-16 flex gap-8">
          ...
          <main className="flex-1 min-w-0">
            ...
            <section id="regulatory-framework" className="scroll-mt-8">
              <h2 className="text-2xl font-bold text-white mb-4" style={{ fontFamily: "Playfair Display, Georgia, serif" }}><span className="text-[#B89555] mr-3">1.</span>Regulatory Framework</h2>
              <CCard className="space-y-4 text-[#1A1A1A]/70 leading-relaxed">
                ...
                <div className="mt-4 bg-[#EFE6D6]/10 border border-[#B89555]/20 rounded-lg p-4"><p className="text-[#1A1A1A]/70 text-sm">We operate in accordance with applicable UAE laws and regulatory frameworks. We are not a regulatory authority.</p></div>
              </CCard>
            </section>
            <GoldDivider />

            <section id="client-verification" className="scroll-mt-8">
              <h2 className="text-2xl font-bold text-white mb-4" style={{ fontFamily: "Playfair Display, Georgia, serif" }}><span className="text-[#B89555] mr-3">2.</span>Client Verification &amp; Due Diligence</h2>
              <CCard className="space-y-4 text-[#1A1A1A]/70 leading-relaxed">
                ...
                <div className="grid gap-3 mt-4">
                  {[
                    ...
                    <div key={item.title} className="bg-[#EFE6D6]/10 border border-[#B89555]/20 rounded-lg p-4">
            ...
            <section id="enhanced-review" className="scroll-mt-8">
              <h2 className="text-2xl font-bold text-white mb-4" style={{ fontFamily: "Playfair Display, Georgia, serif" }}><span className="text-[#B89555] mr-3">3.</span>Enhanced Due Diligence</h2>
              <CCard className="space-y-4 text-[#1A1A1A]/70 leading-relaxed">
            ...
            <section id="suspicious-activity" className="scroll-mt-8">
              <h2 className="text-2xl font-bold text-white mb-4" style={{ fontFamily: "Playfair Display, Georgia, serif" }}><span className="text-[#B89555] mr-3">4.</span>Internal Escalation &amp; Reporting</h2>
              <CCard className="space-y-4 text-[#1A1A1A]/70 leading-relaxed">
                ...
                <p className="text-[#1A1A1A]/70 text-sm mt-2">All internal reviews are conducted with discretion and in accordance with established procedures.</p>
              </CCard>
            </section>
            <GoldDivider />

            <section id="record-management" className="scroll-mt-8">
              <h2 className="text-2xl font-bold text-white mb-4" style={{ fontFamily: "Playfair Display, Georgia, serif" }}><span className="text-[#B89555] mr-3">5.</span>Secure Record Management</h2>
              <CCard className="space-y-4 text-[#1A1A1A]/70 leading-relaxed">
                ...
                <p className="text-sm text-[#1A1A1A]/70 mt-2">For further information on data handling, please refer to our <Link to="/privacy" className="text-[#B89555] hover:underline">Privacy Policy</Link>.</p>
              </CCard>
            </section>
            <GoldDivider />

            <section id="client-obligations" className="scroll-mt-8">
              <h2 className="text-2xl font-bold text-white mb-4" style={{ fontFamily: "Playfair Display, Georgia, serif" }}><span className="text-[#B89555] mr-3">6.</span>Client Obligations</h2>
              <CCard className="space-y-4 text-[#1A1A1A]/70 leading-relaxed">
            ...
            <div className="mt-16 pt-8 border-t border-[#B89555]/15 text-center">
              <p className="text-[#1A1A1A]/70 text-xs leading-relaxed mb-6">This AML &amp; KYC Policy may be updated periodically to reflect regulatory developments.</p>
