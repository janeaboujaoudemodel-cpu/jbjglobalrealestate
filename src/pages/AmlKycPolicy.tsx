          ...
          <main className="flex-1 min-w-0">
            ...
            <section id="regulatory-framework" className="scroll-mt-8">
              ...
              <CCard className="space-y-4 text-[#1A1A1A]/70 leading-relaxed">
                ...
                <div className="mt-4 bg-[#C8A766]/10 border border-[#C8A766]/20 rounded-lg p-4"><p className="text-[#1A1A1A]/70 text-sm">We operate in accordance with applicable UAE laws and regulatory frameworks. We are not a regulatory authority.</p></div>
              </CCard>
            </section>
            <GoldDivider />
            ...
            <section id="record-management" className="scroll-mt-8">
              ...
              <CCard className="space-y-4 text-[#1A1A1A]/70 leading-relaxed">
                ...
                <p className="text-sm text-[#1A1A1A]/70 mt-2">For further information on data handling, please refer to our <Link to="/privacy" className="text-[#C8A766] hover:underline">Privacy Policy</Link>.</p>
              </CCard>
            </section>
            <GoldDivider />
