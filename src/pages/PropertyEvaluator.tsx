...
const blueCardSecondary = `bg-zinc-900/50 border-gray-800 ${blueCard}`;
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
                        ...
                        <button
                          ...
                          className={`px-3 py-1.5 text-xs rounded-full border transition-all ${
                            property.views.includes(view)
                              ...
                              : 'border-gray-700 text-white/70 hover:border-blue-500/50 hover:text-blue-400'
                          }`}
                        >
                          {view}
                        </button>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      ...
                      <Input type="number" value={property.bedrooms} onChange={(e) => updateProperty('bedrooms', parseInt(e.target.value) || 0)} className="bg-zinc-800 border-gray-700 text-white" />
                    </div>
                    <div>
                      <Label className="text-white/70 text-sm">Bathrooms</Label>
                      <Input type="number" value={property.bathrooms} onChange={(e) => updateProperty('bathrooms', parseInt(e.target.value) || 0)} className="bg-zinc-800 border-gray-700 text-white" />
                    </div>
                    <div>
                      <Label className="text-white/70 text-sm">Parking</Label>
                      <Input type="number" value={property.parkingSpaces} onChange={(e) => updateProperty('parkingSpaces', parseInt(e.target.value) || 0)} className="bg-zinc-800 border-gray-700 text-white" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input type="number" value={property.carpetArea || ''} onChange={(e) => updateProperty('carpetArea', parseInt(e.target.value) || 0)} className="bg-zinc-800 border-gray-700 text-white" />
                    </div>
                    <div>
                      <Label className="text-white/70 text-sm">Floor Level</Label>
                      <Input type="number" value={property.floor || ''} onChange={(e) => updateProperty('floor', parseInt(e.target.value) || 0)} className="bg-zinc-800 border-gray-700 text-white" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input type="number" value={property.serviceCharge || ''} onChange={(e) => updateProperty('serviceCharge', parseInt(e.target.value) || 0)} className="bg-zinc-800 border-gray-700 text-white" />
                    </div>
                    <div>
                      <Label className="text-white/70 text-sm">Handover Year</Label>
                      <Input type="number" value={property.handoverYear} onChange={(e) => updateProperty('handoverYear', parseInt(e.target.value) || 2020)} className="bg-zinc-800 border-gray-700 text-white" />
                    </div>
                  </div>
                ...
                <CardContent>
                  ...
                  <div className="flex flex-wrap gap-4">
                    {property.propertyPhotos.map((photo, i) => (
                      <div key={i} className="relative w-28 h-28 rounded-lg overflow-hidden group border border-gray-700">
          ...
          <TabsContent value="modifications">
                ...
                <CardContent className="space-y-6">
                  ...
                  >
                    <label className={`relative flex flex-col p-4 rounded-xl border-2 cursor-pointer transition-all ${
                      property.hasModifications === 'stock' ? 'border-blue-500 bg-blue-500/10' : 'border-gray-700 hover:border-blue-400/40'
                    }`}>
                    ...
                    <label className={`relative flex flex-col p-4 rounded-xl border-2 cursor-pointer transition-all ${
                      property.hasModifications === 'modified' ? 'border-blue-500 bg-blue-500/10' : 'border-gray-700 hover:border-blue-400/40'
                    }`}>
                          ...
                          {[
                            ...
                            <button
                              ...
                              className={`p-3 rounded-lg border text-left transition-all ${
                                property.modificationType === type.value ? 'border-blue-500 bg-blue-500/10' : 'border-gray-700 hover:border-blue-400/40'
                              }`}
                            >
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-4">
                          {property.renovationPhotos.map((photo, i) => (
                            <div key={i} className="relative w-24 h-24 rounded-lg overflow-hidden group border border-gray-700">
            ...
            <div className="flex justify-center gap-4 mt-8">
              <Button onClick={() => setActiveTab('property')} variant="outline" className="border-gray-700">← Back</Button>
          ...
          <TabsContent value="owner">
            ...
            <div className="flex justify-center gap-4 mt-8">
              <Button onClick={() => setActiveTab('modifications')} variant="outline" className="border-gray-700">← Back</Button>
