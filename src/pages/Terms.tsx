      ...
      <section className="relative py-28 md:py-36 overflow-hidden bg-gradient-to-b from-[#1a1714] to-[#151210] border-b border-[#C8A766]/20">
        ...
        <div className="max-w-5xl mx-auto px-4 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <p className="text-[#5A4A2E] text-base md:text-lg max-w-3xl leading-relaxed mb-2">
            ...
            <p className="text-[#5A4A2E] text-base max-w-3xl leading-relaxed">
              ...
              <nav className="space-y-1">
                {tocItems.map(item => (
                  <button key={item.id} onClick={() => scrollTo(item.id)}
                    className="block w-full text-left text-sm text-[#5A4A2E] hover:text-[#C8A766] hover:bg-[#C8A766]/5 px-3 py-1.5 rounded-lg transition-colors"
                  >{item.label}</button>
                ))}
              </nav>
            </div>
          ...
          <main className="flex-1 min-w-0">
            ...
            <div className="lg:hidden mb-10 p-5 rounded-2xl border border-[#C8A766]/20 bg-[#1a1714]/80">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-1">
                {tocItems.map(item => (
                  <button key={item.id} onClick={() => scrollTo(item.id)}
                    className="text-left text-sm text-[#5A4A2E] hover:text-[#C8A766] px-3 py-1.5 rounded-lg hover:bg-[#C8A766]/5 transition-colors"
                  >{item.label}</button>
                ))}
              </div>
            </div>
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <div className="p-6 rounded-xl bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] border border-[#C8A766]/30 space-y-4">
                <p className="text-[#5A4A2E] leading-relaxed"><strong className="text-[#1A1A1A]">"Platform"</strong> refers to this website and all digital services operated by the Company.</p>
                <p className="text-[#5A4A2E] leading-relaxed"><strong className="text-[#1A1A1A]">"Company"</strong> refers to JBJ Global Real Estate L.L.C. S.O.C, a licensed real estate brokerage registered in the United Arab Emirates.</p>
                <p className="text-[#5A4A2E] leading-relaxed"><strong className="text-[#1A1A1A]">"User"</strong> refers to any individual or entity accessing or using the Platform.</p>
                <p className="text-[#5A4A2E] leading-relaxed"><strong className="text-[#1A1A1A]">"Services"</strong> refers to the real estate advisory, consultancy, coordination, and digital tools provided through the Platform.</p>
                <p className="text-[#5A4A2E] leading-relaxed"><strong className="text-[#1A1A1A]">"Third-Party Providers"</strong> refers to external service providers, developers, legal firms, or government-approved entities engaged in connection with our Services.</p>
              </div>
            </motion.div>
            <GoldDivider />
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <div className="p-6 rounded-xl bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] border border-[#C8A766]/30">
                <p className="text-[#5A4A2E] leading-relaxed mb-4">The Platform provides:</p>
                <BulletList items={[
                ...
                <div className="mt-6 flex items-start gap-3 p-4 rounded-xl bg-[#C8A766]/10 border border-[#C8A766]/20">
                  ...
                  <p className="text-sm text-[#5A4A2E]">The Company is a licensed real estate brokerage. It is not a government authority, legal firm, or financial institution.</p>
                </div>
              </div>
            </motion.div>
            <GoldDivider />
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <div className="p-6 rounded-xl bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] border border-[#C8A766]/30">
                <p className="text-[#5A4A2E] leading-relaxed mb-4">By using this Platform, you confirm that you:</p>
                <BulletList items={[
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <div className="p-6 rounded-xl bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] border border-[#C8A766]/30">
                <p className="text-[#5A4A2E] leading-relaxed mb-4">Users shall not:</p>
                <BulletList items={[
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <div className="p-6 rounded-xl bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] border border-[#C8A766]/30 space-y-4">
                <p className="text-[#5A4A2E] leading-relaxed">The Platform does not grant, issue, or approve visas or residency permits.</p>
                <p className="text-[#5A4A2E] leading-relaxed">We coordinate with licensed, government-approved immigration partners to facilitate the application process on behalf of eligible clients.</p>
                <p className="text-[#5A4A2E] leading-relaxed">Final approval of any visa or residency application rests solely with the relevant UAE government authorities, including the Federal Authority for Identity, Citizenship, Customs & Port Security (ICP) and the General Directorate of Residency and Foreigners Affairs (GDRFA).</p>
                <p className="text-[#5A4A2E] leading-relaxed font-medium">We do not guarantee approval of any application.</p>
              </div>
            </motion.div>
            <GoldDivider />
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <div className="p-6 rounded-xl bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] border border-[#C8A766]/30">
                <p className="text-[#5A4A2E] leading-relaxed mb-4">In delivering our Services, we may engage or coordinate with:</p>
                <BulletList items={[
                ...
                <p className="text-[#5A4A2E] text-sm mt-4 leading-relaxed">
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <div className="p-6 rounded-xl bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] border border-[#C8A766]/30">
                <p className="text-[#5A4A2E] leading-relaxed mb-4">All content on this Platform, including but not limited to:</p>
                <BulletList items={[
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <div className="p-6 rounded-xl bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] border border-[#C8A766]/30">
                <p className="text-[#5A4A2E] leading-relaxed mb-4">To the maximum extent permitted by applicable law, the Company shall not be held liable for:</p>
                <BulletList items={[
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <div className="p-6 rounded-xl bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] border border-[#C8A766]/30">
                <p className="text-[#5A4A2E] leading-relaxed mb-4">The Company reserves the right to, at its sole discretion:</p>
                <BulletList items={[
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <div className="p-6 rounded-xl bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] border border-[#C8A766]/30">
                <p className="text-[#5A4A2E] leading-relaxed mb-4">For questions regarding these Terms:</p>
                <div className="flex items-start gap-3 p-4 rounded-xl bg-[#C8A766]/10 border border-[#C8A766]/20">
                  ...
                  <div>
                    ...
                    <p className="text-[#5A4A2E] text-sm mt-1">Email: <a href="mailto:legal@JBJ.ae" className="text-[#C8A766] hover:underline">legal@JBJ.ae</a></p>
                  </div>
                </div>
              </div>
            </motion.div>
