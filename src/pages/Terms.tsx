          ...
          <main className="flex-1 min-w-0">
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <div className="p-6 rounded-xl bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] border border-[#C8A766]/30 space-y-4">
                <p className="text-gray-700 leading-relaxed"><strong className="text-black">"Platform"</strong> refers to this website and all digital services operated by the Company.</p>
                <p className="text-gray-700 leading-relaxed"><strong className="text-black">"Company"</strong> refers to JBJ Global Real Estate L.L.C. S.O.C, a licensed real estate brokerage registered in the United Arab Emirates.</p>
                <p className="text-gray-700 leading-relaxed"><strong className="text-black">"User"</strong> refers to any individual or entity accessing or using the Platform.</p>
                <p className="text-gray-700 leading-relaxed"><strong className="text-black">"Services"</strong> refers to the real estate advisory, consultancy, coordination, and digital tools provided through the Platform.</p>
                <p className="text-gray-700 leading-relaxed"><strong className="text-black">"Third-Party Providers"</strong> refers to external service providers, developers, legal firms, or government-approved entities engaged in connection with our Services.</p>
              </div>
            </motion.div>
            <GoldDivider />
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <div className="p-6 rounded-xl bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] border border-[#C8A766]/30">
                <p className="text-gray-700 leading-relaxed mb-4">The Platform provides:</p>
                <BulletList items={[
                ...
                <div className="mt-6 flex items-start gap-3 p-4 rounded-xl bg-[#C8A766]/10 border border-[#C8A766]/20">
                  ...
                  <p className="text-sm text-gray-700">The Company is a licensed real estate brokerage. It is not a government authority, legal firm, or financial institution.</p>
                </div>
              </div>
            </motion.div>
            <GoldDivider />
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <div className="p-6 rounded-xl bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] border border-[#C8A766]/30">
                <p className="text-gray-700 leading-relaxed mb-4">By using this Platform, you confirm that you:</p>
                <BulletList items={[
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <div className="p-6 rounded-xl bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] border border-[#C8A766]/30">
                <p className="text-gray-700 leading-relaxed mb-4">Users shall not:</p>
                <BulletList items={[
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <div className="p-6 rounded-xl bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] border border-[#C8A766]/30 space-y-4">
                <p className="text-gray-700 leading-relaxed">The Platform does not grant, issue, or approve visas or residency permits.</p>
                <p className="text-gray-700 leading-relaxed">We coordinate with licensed, government-approved immigration partners to facilitate the application process on behalf of eligible clients.</p>
                <p className="text-gray-700 leading-relaxed">Final approval of any visa or residency application rests solely with the relevant UAE government authorities, including the Federal Authority for Identity, Citizenship, Customs & Port Security (ICP) and the General Directorate of Residency and Foreigners Affairs (GDRFA).</p>
                <p className="text-gray-700 leading-relaxed font-medium">We do not guarantee approval of any application.</p>
              </div>
            </motion.div>
            <GoldDivider />
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <div className="p-6 rounded-xl bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] border border-[#C8A766]/30">
                <p className="text-gray-700 leading-relaxed mb-4">In delivering our Services, we may engage or coordinate with:</p>
                <BulletList items={[
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <div className="p-6 rounded-xl bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] border border-[#C8A766]/30">
                <p className="text-gray-700 leading-relaxed mb-4">All content on this Platform, including but not limited to:</p>
                <BulletList items={[
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <div className="p-6 rounded-xl bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] border border-[#C8A766]/30">
                <p className="text-gray-700 leading-relaxed mb-4">To the maximum extent permitted by applicable law, the Company shall not be held liable for:</p>
                <BulletList items={[
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <div className="p-6 rounded-xl bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] border border-[#C8A766]/30">
                <p className="text-gray-700 leading-relaxed mb-4">The Company reserves the right to, at its sole discretion:</p>
                <BulletList items={[
            ...
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <div className="p-6 rounded-xl bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] border border-[#C8A766]/30">
                <p className="text-gray-700 leading-relaxed mb-4">For questions regarding these Terms:</p>
                <div className="flex items-start gap-3 p-4 rounded-xl bg-[#C8A766]/10 border border-[#C8A766]/20">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm mt-1">Email: <a href="mailto:legal@JBJ.ae" className="text-[#C8A766] hover:underline">legal@JBJ.ae</a></p>
                  </div>
                </div>
              </div>
            </motion.div>
