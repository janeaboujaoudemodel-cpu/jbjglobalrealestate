...
const RequestValuation = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.fullName || !formData.phone || !formData.propertyType || !formData.area || !formData.timeline) {
    ...
    try {
      ...
      if (success) {
        navigate("/thank-you?type=valuation");
      } else {
  ...
  const processSteps = [
    "We review the information and confirm the ownership documents required.",
    "We validate the unit profile and pricing context.",
    "We contact you with the valuation range and recommended positioning approach."
  ];

  return (
    <>
      <SEOHead
        title="Request a Property Valuation | JBJ Global Real Estate"
        description="Get a professional property valuation for your Dubai property. Submit your details and receive expert pricing guidance."
        ...
        <section className="relative pt-32 pb-16 overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              >
                Get a Professional Valuation Review
              </motion.h1>
              ...
              >
                Submit your property details. Our team will review and contact you with the next steps.
              </motion.p>
            </motion.div>
          </div>
        </section>
            ...
            >
              ...
              >
                ...
                <div className="space-y-4 pt-4 border-t border-zinc-700">
                  ...
                  <div>
                    <Label htmlFor="viewFeatures" className="text-zinc-300">View / Key Features</Label>
                    <Input
                      id="viewFeatures"
                      value={formData.viewFeatures}
                      onChange={(e) => handleChange("viewFeatures", e.target.value)}
                      placeholder="e.g., Sea view, upgraded kitchen"
                    />
                  </div>
                </div>
                ...
                {/* Mortgage Status */}
                <div className="space-y-4 pt-4 border-t border-zinc-700">
                  <h3 className="text-lg font-semibold text-white">Mortgage Status</h3>
                  
                  <div>
                    <Label htmlFor="mortgageStatus" className="text-zinc-300">Is the property mortgaged? *</Label>
                    <Select value={formData.mortgageStatus} onValueChange={(v) => handleChange("mortgageStatus", v)}>
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                  ...
                  {formData.mortgageStatus === "yes" && (
                    <div>
                      <Label htmlFor="mortgageDetails" className="text-zinc-300">Bank & Outstanding Estimate</Label>
                      <Input
                        id="mortgageDetails"
                        value={formData.mortgageDetails}
                        onChange={(e) => handleChange("mortgageDetails", e.target.value)}
                        placeholder="e.g., ENBD, approx AED 800,000"
                      />
                    </div>
                  )}
                </div>
                ...
                <div className="space-y-4 pt-4 border-t border-zinc-700">
                  ...
                  <div>
                    <Label htmlFor="timeline" className="text-zinc-300">Preferred Selling Timeline *</Label>
                ...
                <div className="flex items-start gap-3 pt-4">
                  ...
                  <Label htmlFor="consent" className="text-sm text-zinc-400 cursor-pointer">
                    ...
                    consent to being contacted regarding this valuation request.
                  </Label>
                </div>
