  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-[#FDFBF7] via-[#FAF7F2] to-[#F5F0E8]">
        ...
        <section className="relative py-20 md:py-28 overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Link to="/contact" className="inline-flex items-center gap-2 px-6 py-3 bg-[#FDFBF7] border-2 border-[#C8A766]/30 text-[#1A1A1A] font-semibold rounded-xl hover:border-[#C8A766]/60 transition-colors">
        ...
        {/* ─── ANCHOR NAV ─── */}
        <nav className="sticky top-0 lg:top-[48px] z-30 bg-[#FDFBF7]/90 backdrop-blur-md border-b border-[#C8A766]/15 shadow-sm">
        ...
        <div className="max-w-5xl mx-auto px-6 pb-20">
          ...
          <section id="why" className="pt-16">
            ...
            <div className="grid md:grid-cols-2 gap-5">
              ...
              <div className="bg-[#FDFBF7] border-2 border-[#C8A766]/30 rounded-2xl p-6 shadow-sm">
                ...
                {comparisonRows.map((r, i) => (
                  <p key={i} className="text-[#1A1A1A] text-sm py-2 border-b border-[#C8A766]/10 last:border-0 flex items-start gap-2">
          ...
          <section id="methodology">
            ...
            <div className="grid md:grid-cols-2 gap-5">
              {methodologies.map(m => (
                <div key={m.letter} className="bg-[#FDFBF7]/80 border border-[#C8A766]/20 rounded-2xl p-6 shadow-sm">
          ...
          <section id="types">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {serviceTypes.map(s => (
                <div key={s.title} className="bg-[#FDFBF7]/80 border border-[#C8A766]/20 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
