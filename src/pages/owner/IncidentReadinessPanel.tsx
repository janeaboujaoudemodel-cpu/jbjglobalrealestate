...
export default function IncidentReadinessPanel() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="border-2 border-[color:var(--emerald-1)]/30/40 jj-surface-emerald-soft">
        <CardHeader>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              className={lastGateRun?.gate_status === "pass" ? "jj-surface-emerald hover:jj-surface-emerald text-white" : "bg-destructive text-destructive-foreground"}
            >
        ...
        <CardContent>
          {/* Latest gate result */}
          {runGate.data && (
            <div className={`mb-4 p-4 rounded-lg border-2 ${runGate.data.gate_status === "pass" ? "border-[color:var(--emerald-1)]/30/50 jj-surface-emerald-soft" : "border-destructive/50 bg-destructive/5"}`}>
