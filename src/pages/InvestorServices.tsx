    ...
    <>
      ...
      <div className="hidden lg:flex fixed right-6 top-1/2 -translate-y-1/2 z-[50] flex-col gap-3">
        <button
          ...
          className="w-12 h-12 jj-surface-emerald hover:jj-surface-emerald rounded-full flex items-center justify-center text-white shadow-lg transition-all hover:scale-110"
          aria-label="WhatsApp"
        >
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-[50] bg-gradient-to-br from-champagne-light to-champagne-dark backdrop-blur-sm border-t-2 border-[#B89555]/40 p-3 flex gap-2">
        <button
          onClick={handleWhatsAppClick}
          className="flex-1 h-11 jj-surface-emerald hover:jj-surface-emerald rounded-lg flex items-center justify-center gap-2 text-white font-medium text-sm"
        >
      ...
      <main className="min-h-screen bg-gradient-to-br from-[hsl(32,28%,13%)] via-[hsl(33,27%,15%)] to-[hsl(33,28%,11%)] pb-20 lg:pb-0">
        {/* ═══ HERO ═══ */}
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row items-center justify-center gap-3">
                <Button
                  onClick={handleWhatsAppClick}
                  className="jj-surface-emerald hover:jj-surface-emerald text-white px-6 h-11 rounded-lg gap-2"
                >
                  <MessageCircle className="w-4 h-4" />
                  WhatsApp Us
                </Button>
            ...
            <div className="container mx-auto px-4">
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
                ...
                <motion.div variants={fadeInUp} className="flex justify-center mt-6 gap-3">
                  <Button onClick={handleWhatsAppClick} className="jj-surface-emerald hover:jj-surface-emerald text-white gap-2 rounded-lg">
                  ...
                  <motion.div variants={fadeInUp}>
                    <button onClick={handleWhatsAppClick} className="block w-full h-full text-left">
                      <div className="jj-card-inner p-5 h-full hover:border-[#B89555]/60 transition-all group cursor-pointer">
                        <div className="w-10 h-10 jj-surface-emerald-soft rounded-lg flex items-center justify-center mb-3 group-hover:jj-surface-emerald-soft transition-colors">
