                ...
                <div className="space-y-3">
                  {cameraActive ? (
                    <div className="relative rounded-xl overflow-hidden">
                      ...
                      <Button aria-label="Take a photo" onClick={capturePhoto} className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-[#FDFBF7] text-[#1A1A1A] shadow-lg hover:bg-[#F7F2EA] rounded-full w-16 h-16">
