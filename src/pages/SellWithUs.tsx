        ...
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="max-w-4xl mx-auto text-center">
              <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 bg-white/5 backdrop-blur-md border border-white/10 rounded-full px-5 py-2.5 mb-8">
              ...
              <motion.p variants={fadeInUp} className="text-lg md:text-xl text-zinc-400 mb-10 max-w-2xl mx-auto leading-relaxed">
              ...
              <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button 
                  ...
                  className="border-white/20 text-white hover:bg-white/5 font-medium px-8 py-6 text-base rounded-xl backdrop-blur-sm"
                >
                  List Your Property
        ...
        <section className="py-24 border-t border-white/5">
          <div className="container mx-auto px-4">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="max-w-4xl mx-auto text-center">
              ...
              <motion.p variants={fadeInUp} className="text-lg text-zinc-400 leading-relaxed">
          ...
          <div className="container mx-auto px-4">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="max-w-3xl mx-auto">
              <motion.div variants={fadeInUp} className="text-center mb-10">
                ...
                <p className="text-zinc-400">Get an estimated market value based on DLD data and comparable transactions</p>
              </motion.div>
                ...
                {!valResult ? (
                  <div className="space-y-5">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <Label className="text-zinc-300 text-sm mb-1.5 block">Community *</Label>
                        <Input value={valCommunity} onChange={(e) => setValCommunity(e.target.value)} placeholder="e.g., Dubai Marina" className="bg-zinc-900/50 border-white/10 text-white placeholder:text-zinc-500 focus:border-blue-400" />
                      </div>
                      <div>
                        <Label className="text-zinc-300 text-sm mb-1.5 block">Property Type</Label>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <Label className="text-zinc-300 text-sm mb-1.5 block">Size (sq ft) *</Label>
                        <Input type="number" value={valSize} onChange={(e) => setValSize(e.target.value)} placeholder="e.g., 1200" className="bg-zinc-900/50 border-white/10 text-white placeholder:text-zinc-500 focus:border-blue-400" />
                      </div>
                      <div>
                        <Label className="text-zinc-300 text-sm mb-1.5 block">Bedrooms</Label>
                  ...
                  <div className="text-center space-y-5">
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center justify-center gap-3">
                        <span className="text-xl text-zinc-500">AED {valResult.estimatedValue?.low?.toLocaleString()}</span>
                        <span className="text-zinc-700">—</span>
                        <span className="text-4xl font-bold text-white">AED {valResult.estimatedValue?.mid?.toLocaleString()}</span>
                        <span className="text-zinc-700">—</span>
                        <span className="text-xl text-zinc-500">AED {valResult.estimatedValue?.high?.toLocaleString()}</span>
                      </div>
                      <p className="text-zinc-500 text-sm">AED {valResult.estimatedValue?.pricePerSqFt?.toLocaleString()} per sq ft</p>
                    </div>
                    <p className="text-sm text-zinc-400 leading-relaxed max-w-lg mx-auto">{valResult.marketInsights}</p>
                    <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2">
                      ...
                      <Button variant="outline" onClick={() => setValResult(null)} className="border-white/20 text-white hover:bg-white/5 rounded-xl">
          ...
          <div className="container mx-auto px-4">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="max-w-3xl mx-auto">
              <motion.div variants={fadeInUp} className="text-center mb-10">
                ...
                <p className="text-zinc-400">Submit your details and our team will handle the rest</p>
              </motion.div>
                ...
                {!listSubmitted ? (
                  <div className="space-y-5">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input value={listName} onChange={(e) => setListName(e.target.value)} placeholder="Your name" className="bg-zinc-900/50 border-white/10 text-white placeholder:text-zinc-500" />
                      </div>
                      <div>
                        <Label className="text-zinc-300 text-sm mb-1.5 block">Phone Number *</Label>
                        <Input value={listPhone} onChange={(e) => setListPhone(e.target.value)} placeholder="+971 50 123 4567" className="bg-zinc-900/50 border-white/10 text-white placeholder:text-zinc-500" />
                      </div>
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                      ...
                      <div>
                        <Label className="text-zinc-300 text-sm mb-1.5 block">Community *</Label>
                        <Input value={listCommunity} onChange={(e) => setListCommunity(e.target.value)} placeholder="e.g., Dubai Marina" className="bg-zinc-900/50 border-white/10 text-white placeholder:text-zinc-500" />
                      </div>
                    </div>
                    <div>
                      <Label className="text-zinc-300 text-sm mb-1.5 block">Email (optional)</Label>
                      <Input type="email" value={listEmail} onChange={(e) => setListEmail(e.target.value)} placeholder="your@email.com" className="bg-zinc-900/50 border-white/10 text-white placeholder:text-zinc-500" />
                    </div>
                  ...
                  <div className="text-center py-8 space-y-4">
                    ...
                    <div className="flex gap-3 justify-center pt-2">
                      <Button asChild variant="outline" className="border-white/20 text-white hover:bg-white/5 rounded-xl">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="max-w-4xl mx-auto">
              <div className="grid md:grid-cols-2 gap-6">
                <motion.div variants={fadeInUp} className="p-8 rounded-2xl backdrop-blur-xl bg-white/[0.03] border border-white/[0.08] text-center">
                  ...
                  <p className="text-zinc-400 text-sm mb-6">Get personalized guidance from our licensed team</p>
                ...
                <motion.div variants={fadeInUp} className="p-8 rounded-2xl backdrop-blur-xl bg-white/[0.03] border border-white/[0.08] text-center">
                  ...
                  <p className="text-zinc-400 text-sm mb-6">Use our AI tools to get an instant valuation</p>
