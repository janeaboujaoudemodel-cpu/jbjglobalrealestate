      ...
      <div className="container mx-auto px-4 pb-20 space-y-12">
                    ...
                    {supportTickets.map((ticket: any) => (
                      ...
                      >
                        ...
                        <Badge className={
                          ...
                          ticket.status === 'resolved' ? 'jj-surface-emerald-soft text-[color:var(--emerald-on)] border-[color:var(--emerald-1)]/30/30' :
        ...
        <div className="bg-[#F7F2EA] border border-[#B89555]/30 rounded-2xl p-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <Button onClick={() => navigate('/ai-hub?suite=productivity')} className="jj-surface-emerald hover:jj-surface-emerald text-white font-medium">
