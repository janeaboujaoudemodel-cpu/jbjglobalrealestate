...
<body>
  ...
  <div class="footer">
    ...
    <p>Powered & Made by JJ Global Capital — Real Estate Brokerage</p>
    <p>Contact: contact@jjglobalcapital.com | www.jjglobalcapital.com</p>
  </div>
</body>
</html>
    `;
...
Best regards`);
    ...
    window.location.href = `mailto:contact@jjglobalcapital.com?subject=${subject}&body=${body}`;
