...
const MortgageCalculatorPage = () => {
  ...
  return (
    <section className="min-h-screen bg-black">
      {/* Hero Section */}
      <div className="relative py-16 md:py-24 bg-gradient-to-b from-black via-zinc-900/30 to-black">
        {/* Background effects */}
      ...
      {/* Benefits Section */}
      <div className="py-16 md:py-24 bg-zinc-900/50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {benefits.map((benefit, index) => (
              <div 
                key={index}
                className="group bg-zinc-900/80 border border-gold/20 rounded-xl p-6 hover:border-gold/40 transition-all duration-500 hover:-translate-y-1 hover:shadow-lg"
              >
      ...
      <div className="py-16 border-t border-gold/20 bg-black">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            <p className="text-zinc-500 text-sm uppercase tracking-wider mb-2">Partnered With</p>
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12 opacity-70">
            {["Emirates NBD", "ADCB", "FAB", "Mashreq", "DIB", "RAKBANK"].map((bank) => (
              <div key={bank} className="text-zinc-400 font-semibold text-lg hover:text-gold transition-colors">
                {bank}
              </div>
            ))}
          </div>
      ...
      {/* CTA Section */}
      <div className="py-16 md:py-24 bg-gradient-to-b from-zinc-900/50 to-black">
        <div className="container mx-auto px-4">
