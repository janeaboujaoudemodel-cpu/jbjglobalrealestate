...
export const clientRelationsTeam: TeamMember[] = sortByHierarchy([
  {
    ...
    hierarchyLevel: 3,
    reportsTo: 'michael-anderson',
    directReports: ['victoria-ashworth', 'khalil-haddad'],
    status: 'online',
    canConductInterviews: true,
  },
  {
    ...
    department: 'Client Relations',
    avatar: khalilHaddadClient,
    isAI: true,
    bio: 'Experienced client relations manager specializing in Arabic-speaking clients and Gulf region investors.',
    specializations: ['Arabic Clients', 'Gulf Investors', 'Relationship Building'],
    languages: ['English', 'Arabic', 'French'],
    nationality: 'Lebanese',
    yearsExperience: 9,
    hierarchyLevel: 4,
  ...
  },
  {
    ...
    department: 'Client Relations',
    avatar: oliviaHendersonClient,
    isAI: true,
    bio: 'Dedicated client relations specialist ensuring seamless communication and exceptional service delivery.',
    specializations: ['Client Communication', 'Service Coordination', 'Follow-up Management'],
    languages: ['English'],
    nationality: 'British',
    yearsExperience: 5,
    hierarchyLevel: 5,
  ...
  },
  {
    ...
    department: 'Client Relations',
    avatar: kenjiNakamuraClient,
    isAI: true,
    bio: 'Strategic portfolio manager specializing in Asian investor relations and portfolio optimization.',
    specializations: ['Portfolio Management', 'Asian Markets', 'Investment Advisory'],
