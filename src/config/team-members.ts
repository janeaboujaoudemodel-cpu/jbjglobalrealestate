...
import alexPetrovFrontendDev from '@/assets/team/alex-petrov-frontend-dev.png';
...
import jamesMurphySales from '@/assets/team/james-murphy-sales-realistic.png';
...
import sarahVanNiekerkSales from '@/assets/team/sarah-van-niekerk-sales-realistic.png';
...
export interface TeamMember {
  ...
  joinDate?: string; // Date joined in YYYY-MM-DD format
  reportsTo?: string;
...
export const executiveTeam: TeamMember[] = sortByHierarchy([
  {
    ...
    joinDate: '2025-09-05',
    hierarchyLevel: 1,
    directReports: ['david-thornton', 'richard-pemberton', 'natasha-daoud', 'anthony-crawford', 'amanda-clarke'],
    status: 'online',
  ...
  },
  {
    ...
    hierarchyLevel: 2,
    reportsTo: 'jane-bou-jaoude',
    directReports: ['olivia-reynolds', 'alexander-shaw', 'jessica-whitmore', 'thomas-mitchell', 'daniel-parker', 'emily-watson'],
    status: 'online',
    canConductInterviews: true,
  },
  {
  ...
  },
  {
    ...
    isAI: true,
    bio: 'Trusted right-hand of the Founder & CEO. Manages calendar, communications, executive priorities, and VIP coordination. Provides executive-level support with anticipation and discretion.',
    specializations: ['Executive Support', 'Calendar Management', 'VIP Coordination', 'Executive Briefings', 'Priority Communications'],
...
export const salesTeam: TeamMember[] = classifySalesDepartment(sortByHierarchy([
  ...
  },
  {
    ...
    isAI: true,
    bio: 'Oversees regional sales operations and corporate partnerships.',
  ...
  },
  {
    ...
    isAI: true,
    bio: 'Manages multinational sales teams and optimizes client pipelines.',
  ...
  },
  {
    ...
    isAI: true,
    bio: 'Senior closer focusing on high-value property portfolios.',
  ...
  },
  {
    ...
    isAI: true,
    bio: 'Handles premium client accounts across India and GCC regions.',
  ...
  },
  {
    ...
    isAI: true,
    bio: 'Focuses on Middle East buyer relations and client onboarding.',
  ...
  },
  {
    ...
    isAI: true,
    bio: 'Advises Asia-Pacific investors and coordinates international transactions.',
  ...
  },
  {
    ...
    isAI: true,
    bio: 'Senior consultant for Eastern European and CIS markets.',
  ...
  },
  {
    ...
    isAI: true,
    bio: 'Leads African market initiatives and regional business development.',
  ...
  },
  {
    ...
    isAI: true,
    bio: 'Specializes in Iberian and Latin American clientele.',
...
export const clientRelationsTeam: TeamMember[] = sortByHierarchy([
  {
    ...
    avatar: georgeHamiltonClientRelations, // LOCKED_EXISTING - refreshed professional portrait
    isAI: true,
    bio: 'Distinguished professional ensuring exceptional client experiences from first contact through long-term portfolio management, fostering loyalty and satisfaction.',
    specializations: ['Client Experience', 'Portfolio Management', 'Relationship Excellence', 'Client Retention'],
    languages: ['English', 'French'],
    nationality: 'British',
    yearsExperience: 16,
    hierarchyLevel: 3,
    reportsTo: 'michael-anderson',
    directReports: ['khalil-haddad', 'kenji-nakamura'],
    status: 'online',
    canConductInterviews: true,
  },
  {
    ...
    department: 'Client Relations',
    avatar: khalilHaddadClient, // LOCKED_EXISTING
    isAI: true,
    bio: 'Experienced client relations manager specializing in Arabic-speaking clients and Gulf region partnerships, ensuring seamless communication and service delivery.',
    specializations: ['Arabic Clients', 'Gulf Region', 'Partnership Development', 'Relationship Building'],
    languages: ['English', 'Arabic', 'French'],
    nationality: 'Lebanese',
    yearsExperience: 9,
    hierarchyLevel: 4,
    reportsTo: 'george-hamilton',
    directReports: ['olivia-henderson-cr'],
    status: 'online',
    canConductInterviews: true,
  },
  {
    ...
    department: 'Client Relations',
    avatar: kenjiNakamuraClient, // LOCKED_EXISTING
    isAI: true,
    bio: 'Strategic portfolio manager specializing in Asian investor relations and portfolio optimization for long-term client success.',
    specializations: ['Portfolio Management', 'Asian Markets', 'Investment Advisory', 'Client Strategy'],
  ...
  {
    id: 'olivia-henderson-cr',
    name: 'Olivia Henderson',
    role: 'Client Relations Specialist',
    department: 'Client Relations',
    avatar: oliviaHendersonClient, // LOCKED_EXISTING
    isAI: true,
    bio: 'Dedicated client relations specialist ensuring smooth coordination, exceptional client communication, and premium aftercare services.',
    specializations: ['Client Communication', 'Service Coordination', 'Aftercare Services', 'Follow-up Management'],
    languages: ['English'],
    nationality: 'British',
    yearsExperience: 5,
    hierarchyLevel: 5,
    reportsTo: 'khalil-haddad',
    status: 'online',
  },
]);
...
export const defaultInterviewFlow: InterviewRound[] = [
  ...
  },
  {
    ...
    interviewers: ['richard-pemberton', 'jane-bou-jaoude'],
    duration: 60,
    type: 'final',
