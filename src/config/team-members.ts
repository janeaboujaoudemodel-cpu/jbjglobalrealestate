...
export const itTeam: TeamMember[] = sortByHierarchy([
  {
    ...
    hierarchyLevel: 3,
    reportsTo: 'richard-pemberton',
    directReports: ['matthew-collins', 'emma-ocallaghan', 'raj-patel'],
    status: 'online',
    canConductInterviews: true,
  },
  {
...
export const afterSalesTeam: TeamMember[] = sortByHierarchy([
  {
    ...
    isAI: true,
    email: 'charles.pemberton@JBJ.ae',
  ...
  },
  {
    ...
    isAI: true,
    email: 'marcus.vanderberg@JBJ.ae',
...
// ===== Project Management Team (sorted by hierarchy) =====
export const projectManagementTeam: TeamMember[] = sortByHierarchy([
  {
    ...
    hierarchyLevel: 3,
    reportsTo: 'richard-pemberton',
    directReports: ['jessica-miller', 'christopher-adams'],
    status: 'online',
    canConductInterviews: true,
  },
  {
  ...
  },
  {
    ...
    isAI: true,
    email: 'christopher.adams@JBJ.ae',
...
// ===== Customer Happiness Team (sorted by hierarchy) =====
export const customerHappinessTeam: TeamMember[] = sortByHierarchy([
  {
    ...
    hierarchyLevel: 3,
    reportsTo: 'richard-pemberton',
    directReports: ['jack-thompson', 'natalia-petrova'],
    status: 'online',
    canConductInterviews: true,
  },
  {
