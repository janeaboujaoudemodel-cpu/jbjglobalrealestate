...
const STAFF: DocumentTemplate[] = [
  {
    ...
    aiInstructions: [
      ...
      "9. Conditional Offer — This offer is conditional upon satisfactory documentation, background verification where applicable, visa/work-permit requirements where applicable, and signing of all Company documents.",
      "",
