...
const STAFF: DocumentTemplate[] = [
  {
    ...
    aiInstructions: [
      "Draft the JBJ GLOBAL REAL ESTATE formal Employment Offer Letter. This is an OFFER LETTER ONLY — it must NOT contain the full employment agreement, NDA, non-compete pack, or duplicated legal pack. It MAY include offer-letter-specific UAE real-estate protections for commission, early-exit cost reimbursement, confidentiality/data misuse, and indemnity where listed below. Use <h2> for numbered headings, <p> for body. Substitute bracketed placeholders only when values are provided; otherwise keep the brackets. Follow the structure VERBATIM:",
      "",
      "Date: [Date]",
      ...
      "4. Compensation — Your commission entitlement is structured as follows: [Commission Structure, written in clean premium prose, no slashes], as further detailed in the Compensation & Commission Structure table above. No commission is earned unless and until the Company receives the corresponding cleared payment from the developer, landlord, seller, buyer, client, or other third party, unless otherwise agreed in writing.",
      "5. Benefits — [Benefits, e.g. annual leave, medical insurance, visa, end-of-service gratuity per UAE Labour Law].",
      "6. Probation Period — Your employment will be subject to a probation period of [Probation Period], during which either party may terminate the employment in accordance with UAE law, as also reflected in the Terms of Employment table above.",
      "7. Confidentiality Acknowledgement — You acknowledge that you will have access to confidential Company information and agree to keep it confidential.",
      "8. Leads and Clients — Company leads, client contacts, owner/developer contacts, CRM records, WhatsApp leads, listing material and pipeline information remain Company assets and may not be copied, exported, diverted or used outside the Company.",
      "9. Conflict of Interest and Non-Circumvention — The employee must not compete, divert transactions, bypass the Company, or deal with Company clients/leads for personal or third-party benefit without written approval.",
      "10. Training, Onboarding and Early-Exit Reimbursement — If the employee leaves before completing six (6) months, the employee must reimburse reasonable and proportionate onboarding, training, administrative setup, tools, materials and Company time investment, assessed by the Company fairly and in good faith, excluding amounts that cannot lawfully be recovered under UAE law.",
      "11. Misuse, Theft or Unauthorised Use of Company Information — Theft, copying, exporting, screenshotting, transferring, deleting, disclosing or personal use of Company data, numbers, photos, videos, listing material, confidential documents, CRM data, WhatsApp conversations or Company material is a serious breach. The employee shall compensate and indemnify the Company for loss, damages, costs, expenses, lost commission, reputational harm and lost business opportunity, assessed fairly by the Company by reference to actual or reasonably estimated loss and the seriousness of the breach.",
      "12. Separation & Post-Termination Commission — Upon resignation/termination or during notice/run-off, any enhanced commission uplift ceases and reverts to the standard 50/50 split unless separately agreed in writing.",
      "13. Conditional Offer — This offer is conditional upon satisfactory documentation, background verification where applicable, visa/work-permit requirements where applicable, and signing of all Company documents.",
      "",
  ...
  // NOTE: The former "Employment Protective Clauses (Insert Pack)" template
  // has been removed. All employment-related legal protections (confidentiality,
  // lead ownership, non-solicit, non-circumvention, non-compete, indemnity,
  // training reimbursement, data deletion) now live in the standalone
  // "Employment Agreement" template above. Pure confidentiality clauses live
  // in the standalone "Non-Disclosure Agreement (NDA)" template. This avoids
  // clause duplication across templates.
  {
...
const PARTNER_PARTY_A_FIELDS: DocumentField[] = [
  ...
  { key: "partyAPhone", label: "Party A — Phone", type: "text", placeholder: "+971 54 15 15 015", group: "Party A" },
