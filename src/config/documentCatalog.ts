...
const STAFF: DocumentTemplate[] = [
  {
    ...
    aiInstructions: [
      "Draft the JBJ GLOBAL REAL ESTATE formal employment offer letter. Do NOT include letterhead or top signature block (those are rendered by locked chrome). Follow this EXACT structure, headings, numbering, and clause wording verbatim — only substitute the bracketed placeholders with provided field values. If a value is missing, keep the bracketed placeholder.",
      "",
      "Date: [Date]",
      ...
      "Dear [Candidate Name],",
      "",
      "We are pleased to offer you the position of [Job Title] with [Company Legal Name], a UAE real estate agency, subject to the terms below and the signing of the Company’s employment contract, confidentiality agreement, policies, and any required UAE employment documentation.",
      "",
      "1. Position",
      "Your position will be [Job Title]. Your duties include, but are not limited to, real estate sales/leasing, lead handling, client follow-up, developer coordination, CRM updates, property presentations, marketing support, and any other duties reasonably assigned by the Company.",
      "",
      "2. Start Date",
      "Your expected start date is [Start Date].",
      "",
      "3. Place of Work",
      "Your primary place of work will be [Office Address], with field visits, developer offices, client meetings, property viewings, and remote work where approved by the Company.",
      "",
      "4. Compensation",
      "Your compensation shall be:",
      "Basic Salary: AED [Amount] per month / Commission-only structure: [Details]",
      "Commission: [Commission structure]",
      "Allowances: [If any]",
      "Payment Cycle: [Monthly / upon company receipt of commission / other]",
      ...
      "",
      "5. Probation Period",
      "Your employment will be subject to a probation period of [up to six months], during which either party may terminate the employment in accordance with UAE law and the employment contract.",
      "",
      "6. Confidentiality and Company Data",
      "You must keep confidential all Company information, including leads, client data, owner data, buyer data, seller data, tenant data, landlord data, developer contacts, prices, commission structures, marketing strategies, CRM data, WhatsApp leads, call recordings, email communications, documents, contracts, business methods, and internal policies.",
      "",
      "7. Leads and Clients",
      "All leads, inquiries, clients, prospects, contacts, databases, property owners, developers, landlords, sellers, buyers, tenants, and investors introduced, generated, received, accessed, assigned, or handled during your work are the exclusive business assets of the Company. You may not use, transfer, sell, leak, copy, export, screenshot, close, redirect, or complete any transaction involving Company leads or clients outside the Company, during or after employment.",
      "",
      "8. Conflict of Interest",
      "You must not work with, represent, assist, advise, own, manage, or financially participate in any competing real estate business, brokerage, marketing agency, holiday-home operator, property management company, or commission-based arrangement without the Company’s prior written approval.",
      "",
      "9. Non-Solicitation and Non-Circumvention",
      "You must not solicit, approach, divert, or deal directly or indirectly with the Company’s clients, leads, developers, owners, suppliers, consultants, employees, brokers, or partners for personal benefit or for any third party.",
      "",
      "10. Training and Onboarding Reimbursement During Probation",
      ...
      "This offer is conditional upon satisfactory completion of documentation, background verification where applicable, visa/work permit requirements where applicable, and signing all Company documents.",
      "",
      ...
      "Date: [Date]",
      "",
      "DEFAULTS: [Company Legal Name] = J B J GLOBAL REAL ESTATE L.L.C S.O.C. [Office Address] = Office SM1-195, Port Saeed, Deira, Dubai, UAE. Working hours when referenced = 10:00 AM – 7:00 PM, Monday to Saturday. Use clean HTML: <h2> for numbered section titles, <p> for paragraphs, no inline color. SURGICAL PATCH MODE — never rewrite this structure, only fill placeholders.",
    ].join("\n"),
    fields: [
      RECIPIENT_NAME,
