...
const STAFF: DocumentTemplate[] = [
  {
    ...
    aiInstructions: [
      ...
      "3. Place of Work — Your primary place of work will be [Office Address], with field visits and remote work where approved by the Company. Your standard working hours are [Working Hours], consistent with the Terms of Employment table above.",
