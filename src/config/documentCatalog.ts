...
const STAFF: DocumentTemplate[] = [
  {
    ...
    audience: "staff",
    label: "Offer Letter",
    description: "Formal employment offer — position, compensation, start date, signature.",
    icon: Briefcase,
    needsPosition: true,
    emailSubject: "Your Offer of Employment — JBJ GLOBAL REAL ESTATE",
    aiInstructions: [
      "Draft the JBJ GLOBAL REAL ESTATE formal Employment Offer Letter. This is an OFFER LETTER ONLY — it must NOT contain the NDA, the full employment agreement, protective clauses, non-compete, non-solicitation, indemnity, or any duplicated legal pack. Use <h2> for numbered headings, <p> for body. Substitute bracketed placeholders only when values are provided; otherwise keep the brackets. Follow the structure VERBATIM:",
      "",
      "Date: [Date]",
      ...
      "3. Place of Work — Your primary place of work will be [Office Address], with field visits and remote work where approved by the Company.",
      "4. Working Hours — [Working Hours].",
      "5. Compensation — Basic Salary: AED [Amount] per month. Commission: [Commission Structure]. Allowances: [Allowances]. Payment Cycle: [Payment Cycle]. No commission is earned unless and until the Company receives the corresponding payment from the developer, client, or other third party, unless otherwise agreed in writing.",
      "6. Benefits — [Benefits, e.g. annual leave, medical insurance, visa, end-of-service gratuity per UAE Labour Law].",
      "7. Probation Period — Your employment will be subject to a probation period of [Probation Period], during which either party may terminate the employment in accordance with UAE law.",
      "8. Confidentiality Acknowledgement — You acknowledge that you will have access to confidential Company information and agree to keep it confidential.",
      "9. Agreement to Sign Company Documents — By accepting this offer, you agree to sign and comply with the Company’s Employment Agreement, Non-Disclosure Agreement, Company Policies, Data Protection Policy, and any other required company documents. The detailed legal obligations (including confidentiality, non-solicitation, non-circumvention, lead ownership, post-termination restrictions, and indemnity) are governed by those separate documents.",
      "10. Conditional Offer — This offer is conditional upon satisfactory documentation, background verification where applicable, visa/work-permit requirements where applicable, and signing of all Company documents.",
      "",
    ...
    fields: [
      ...
      START_DATE,
      { key: "salary", label: "Basic Salary", type: "text", placeholder: "AED 25,000 per month" },
  ...
  },
  {
    ...
    description: "Full UAE employment agreement: confidentiality, lead ownership, non-solicit, non-compete, indemnity.",
    icon: FileSignature,
    needsPosition: true,
    emailSubject: "Your Employment Agreement — JBJ GLOBAL REAL ESTATE",
    aiInstructions: [
      "Draft the JBJ GLOBAL REAL ESTATE Employment Agreement under UAE law. This document carries ALL employment-related legal protections. Use <h2> for each numbered clause heading and <p> for body. Substitute bracketed placeholders only when values are supplied; otherwise keep brackets. Render the clauses VERBATIM in this order:",
      "",
      "1. Parties — This Employment Agreement is made between [Company Legal Name] (the “Company”) and [Full Name], holder of Passport [Passport Number], Emirates ID [Emirates ID Number], of [Home Address] (the “Employee”).",
      "2. Position, Duties and Reporting — The Employee is engaged as [Job Title], reporting to [Reporting Line], and shall perform the duties customarily associated with that role and any other duties reasonably assigned by the Company.",
      "3. Term and Working Hours — Commencement Date: [Start Date]. Term: [Contract Duration]. Working Hours: [Working Hours]. Place of Work: [Office Address].",
      "4. Compensation — Basic Salary: AED [Amount]. Commission: [Commission Structure]. No commission is earned unless and until the Company receives the corresponding payment from the developer, client, or third party, unless otherwise agreed in writing.",
      "5. Confidentiality — The Employee shall keep strictly confidential all Company information, including leads, client data, owner/landlord/seller/buyer/tenant/investor data, developer relationships, CRM data, WhatsApp conversations, call records, emails, documents, contracts, pricing, commission structures, marketing plans, passwords, business methods and internal systems, and shall not disclose, copy, export, screenshot, transfer, sell, misuse, or store such information externally except strictly for Company business.",
      "6. Company Ownership of Leads, CRM and Databases — All leads, inquiries, clients, prospects, contacts, CRM entries, WhatsApp conversations, call recordings, viewings, owner/developer/landlord/seller/buyer/tenant/investor contacts, property information, documents, and transaction opportunities created, received, assigned, accessed or handled by the Employee belong exclusively to the Company. The Employee has no personal ownership or continuing right to use such data.",
      "7. Client Ownership — Any client, prospect, owner, developer, buyer, seller, tenant, landlord, investor or opportunity introduced through, generated by, assigned by, received through, or connected to the Company is a Company client and must only be handled and closed through the Company.",
      "8. Non-Solicitation — For a period of [Restriction Period] after termination, the Employee shall not, directly or indirectly, solicit, approach, accept business from, interfere with or deal with any Company client, lead, owner, developer, landlord, seller, buyer, tenant, investor, broker, supplier, employee, consultant or partner with whom the Employee had contact, or about whom the Employee received information, during employment.",
      "9. Non-Circumvention — The Employee shall not bypass the Company in any transaction, referral, partnership, collaboration, listing, management, holiday-home operation, maintenance arrangement, leasing, sale, resale or developer deal that was introduced by or connected to the Company.",
      "10. Conflict of Interest and No Competing Business — During employment, the Employee shall not, without prior written approval, work for, advise, represent, manage, support, refer business to, or receive commission from any competing real estate agency, brokerage, developer sales team, property management company, holiday-home company, maintenance company or marketing agency.",
      "11. No Ownership of Competing Companies — During employment and for [Restriction Period] thereafter, the Employee shall not own, invest in, or hold any material interest in a business that competes with the Company, save for passive holdings in publicly listed companies of less than 1%.",
      "12. Commission Protection — The Employee shall not take any action that causes the Company to lose, reduce, delay or be deprived of its commission, referral fee, management fee, holiday-home fee, maintenance fee, leasing fee, sales commission, renewal fee or other income. Any diversion, concealment, circumvention or misuse of a Company opportunity entitles the Company to claim the lost commission and damages, subject to UAE law.",
      "13. Return of Company Property — Upon request or termination, the Employee must immediately return all Company property, documents, devices, access cards, passwords, files, contracts, client lists, data, leads and materials.",
      "14. Training Reimbursement During Probation — If the Employee resigns during the probation period, the Employee agrees, where legally enforceable and subject to UAE law, to reimburse the Company for reasonable, documented and proportionate onboarding, training, education, time-investment, tools, materials and Company-provided lead/data costs incurred specifically for the Employee.",
      "15. Six-Month Training Reimbursement Exception — After six (6) months of completed employment, the Employee shall not owe reimbursement for ordinary onboarding or training costs unless a separate written agreement applies.",
      "16. One-Year Post-Termination Restriction — For one (1) year after termination, the Employee shall not use Company confidential information, client data, lead data, strategies, documents, pricing, commission structures or business relationships to compete with the Company. Where enforceable under UAE law, the Employee shall not join, work with, own, operate, assist, consult for or provide part-time or freelance services to a competing business within [Geographic Scope] in a role involving the same clients, leads, business relationships, confidential information or work type handled during employment. This restriction shall be interpreted only to the extent necessary to protect the Company’s legitimate business interests and shall be subject to UAE law.",
      "17. Data Deletion Obligations — Upon termination or at any time on Company request, the Employee shall permanently delete all Company information from personal phones, laptops, drives, WhatsApp, emails, cloud storage and social media accounts, and shall confirm such deletion in writing.",
    ...
    fields: [
      ...
      { key: "reportingLine", label: "Reporting Line", type: "text" },
      START_DATE,
  ...
  },
  {
    ...
    description: "Full UAE confidentiality agreement — CRM, leads, pricing, developer & client data, non-circumvention, indemnity.",
    icon: ShieldCheck,
    emailSubject: "Non-Disclosure Agreement — JBJ GLOBAL REAL ESTATE",
    aiInstructions: [
      "Draft the JBJ GLOBAL REAL ESTATE Non-Disclosure Agreement (NDA) under UAE law. This is the STANDALONE confidentiality document — it must NOT include employment terms (salary, probation, working hours) or partnership/collaboration commercial terms. Use <h2> for numbered headings and <p> for body. Substitute bracketed placeholders only when supplied; otherwise keep brackets. Render VERBATIM:",
      "",
      "1. Parties — This Non-Disclosure Agreement is made between [Company Legal Name] (the “Disclosing Party” / “Company”) and [Full Name / Counterparty] of [Counterparty Address] (the “Receiving Party”).",
      "2. Purpose — The Receiving Party will have access to Confidential Information for the purpose of: [Purpose of Disclosure].",
      "3. Definition of Confidential Information — “Confidential Information” means all non-public information of the Company, in any form, including: company data, business plans, financial information, internal procedures, methods of operation, trade secrets, software, systems, and any information marked or reasonably understood as confidential.",
      "4. Company Data Protection — All Company records, databases, files, documents, contracts, presentations, training materials, and internal communications are Confidential Information of the Company.",
      "5. Client Information — All client identities, contact details, requirements, budgets, viewing history, transaction history, correspondence, and personal data are Confidential Information of the Company and shall be processed in accordance with applicable UAE data-protection law.",
      "6. CRM Protection — All CRM data — including stages, notes, tags, activities, tasks, calls, meetings, and pipeline information — is Confidential Information of the Company and may not be exported, screenshotted, copied, transferred or replicated outside the Company’s systems.",
      "7. Lead Protection — All leads (including WhatsApp leads, web leads, portal leads, walk-ins, referrals and call-in leads), inquiries, prospects and contacts are Confidential Information of the Company.",
      "8. Commission Information — All commission rates, splits, payout schedules, deal economics, developer commercial terms and incentive arrangements are Confidential Information of the Company.",
      "9. Internal Procedures — All internal procedures, scripts, playbooks, SOPs, policies, marketing plans and operational systems are Confidential Information of the Company.",
      "10. Trade Secrets — All trade secrets, including proprietary methodologies, algorithms, automation, AI prompts, analytics, dashboards and pricing logic, are Confidential Information of the Company.",
      "11. Developer Information — All developer relationships, contacts, allocations, inventory, pricing, payment plans, EOIs, broker terms and side-letters are Confidential Information of the Company.",
      "12. Pricing Information — All Company pricing, fees, discounts, negotiated rates, vendor costs and quotations are Confidential Information of the Company.",
      "13. Non-Disclosure Obligation — The Receiving Party shall not disclose, publish, communicate, post, share or make available any Confidential Information to any third party without the Company’s prior written consent.",
      "14. Non-Use Obligation — The Receiving Party shall not use Confidential Information for any purpose other than the Purpose stated above, and shall not use it for personal benefit or for the benefit of any third party.",
      "15. Return or Deletion of Confidential Information — Upon request or upon termination of the underlying relationship, the Receiving Party shall promptly return or permanently delete all Confidential Information (including copies on personal devices, drives, cloud accounts, WhatsApp, email and social media) and shall confirm such deletion in writing.",
      "16. Non-Circumvention — The Receiving Party shall not bypass the Company by directly or indirectly contacting, soliciting, transacting with, or completing any deal with any client, lead, developer, owner, landlord, seller, buyer, tenant, investor, supplier, employee or partner introduced through or connected to the Company.",
      "17. Ownership of Information — All Confidential Information, and all intellectual property contained in or derived from it, remains the exclusive property of the Company. Nothing in this Agreement grants any licence, ownership right or implied right in the Confidential Information.",
      "18. Survival of Confidentiality — The confidentiality obligations in this Agreement shall survive termination of any underlying relationship and shall continue for a period of [Term of Confidentiality], and indefinitely with respect to trade secrets, to the extent permitted by UAE law.",
      "19. Breach, Damages and Indemnity — If either Party breaches this Agreement, that Party shall be liable for all direct losses, damages, costs, expenses, legal fees (where recoverable), and other losses suffered by the non-breaching Party arising directly from such breach, to the extent permitted under applicable UAE law. The breaching Party shall compensate the non-breaching Party for such proven losses within the period specified by the Company in its written demand, which shall not exceed thirty (30) calendar days from the date of the written notice, unless otherwise required by applicable law or agreed in writing.",
      "20. Legal Remedies — The Company shall be entitled to seek injunctive relief, specific performance, account of profits, recovery of lost commission and any other remedy available under UAE law, in addition to damages.",
      "21. Severability and Governing Law — If any clause is found invalid or unenforceable, it shall be reduced to the maximum extent permitted by UAE law and the remaining clauses shall remain valid. This Agreement is governed by the laws of the United Arab Emirates and the applicable laws of [Emirate].",
      "",
    ...
    fields: [
      ...
      START_DATE,
      { key: "term", label: "Term of Confidentiality", type: "text", placeholder: "e.g., 3 years", default: "3 years" },
  ...
  {
    id: "employment_protective_clauses",
    audience: "staff",
    label: "Employment Protective Clauses (Insert Pack)",
    description: "Drop-in confidentiality, lead-ownership, non-solicit, non-compete, indemnity clauses for employment contracts.",
    icon: ShieldCheck,
    emailSubject: "Employment Protective Clauses — JBJ GLOBAL REAL ESTATE",
    aiInstructions: [
      "Render the following UAE-compliant protective clauses VERBATIM with <h2> for each numbered clause heading and <p> for body. Do NOT rewrite or summarise. Substitute bracketed placeholders only if values are supplied; otherwise keep the brackets.",
      "",
      "1. Confidential Information — The Employee acknowledges that the Company’s confidential information includes all information not publicly available relating to the Company, its clients, leads, developers, landlords, sellers, buyers, tenants, investors, employees, commission structures, CRM, WhatsApp data, emails, contracts, marketing plans, pricing, negotiations, passwords, documents, business methods, and internal systems. The Employee shall not disclose, copy, export, screenshot, transfer, sell, misuse, store externally, or use confidential information except strictly for Company business.",
      "2. Company Ownership of Leads and Data — All leads, client data, inquiries, contacts, CRM entries, WhatsApp conversations, call records, viewings, developer contacts, owner contacts, property information, documents, and transaction opportunities created, received, assigned, accessed, or handled by the Employee belong exclusively to the Company. The Employee has no personal ownership or continuing right to use such data.",
      "3. Closing Company Leads Only Through the Company — Any lead, client, prospect, owner, developer, buyer, seller, tenant, landlord, investor, or opportunity introduced through, generated by, assigned by, received through, or connected to the Company must only be handled and closed through the Company. The Employee must not close, redirect, transfer, leak, sell, assign, conceal, or complete such lead or client through another company, personal arrangement, competing broker, third party, friend, relative, side business, or personal account, during or after employment.",
      "4. Commission Protection — The Employee shall not take any action that causes the Company to lose, reduce, delay, divert, or be deprived of its commission, referral fee, management fee, holiday-home fee, maintenance fee, leasing fee, sales commission, renewal fee, or any other income. If the Employee diverts, conceals, circumvents, or misuses a Company opportunity, the Employee shall indemnify the Company for all losses, commissions, damages, investigation costs, legal costs, and reputational harm, subject to UAE law.",
      "5. Non-Solicitation — For a period of [Restriction Period] after termination, the Employee shall not directly or indirectly solicit, approach, accept business from, interfere with, or deal with any Company client, lead, owner, developer, landlord, seller, buyer, tenant, investor, broker, supplier, employee, consultant, or partner with whom the Employee had contact or about whom the Employee received information during employment.",
      "6. Non-Circumvention — The Employee shall not bypass the Company in any transaction, referral, partnership, collaboration, listing, management, holiday-home operation, maintenance arrangement, leasing, sale, resale, or developer deal that was introduced by or connected to the Company.",
      "7. Conflicts of Interest and Competing Work — During employment, the Employee shall not, without prior written approval, work for, advise, represent, own, manage, invest in, support, refer business to, or receive commission from any competing real estate agency, brokerage, developer sales team, property management company, holiday-home company, maintenance company, marketing agency, or related business.",
      "8. One-Year Post-Termination Restriction — For one year after termination, the Employee shall not use Company confidential information, client data, lead data, strategies, documents, pricing, commission structures, or business relationships to compete with the Company. Where enforceable under UAE law, the Employee shall not join, work with, own, operate, assist, consult for, or provide part-time or freelance services to a competing business within [Geographic Scope] in a role involving the same clients, leads, business relationships, confidential information, or work type handled during employment. This restriction shall be interpreted only to the extent necessary to protect the Company’s legitimate business interests and shall be subject to UAE law.",
      "9. Probation Resignation Reimbursement — If the Employee resigns during the probation period, the Employee agrees, where legally enforceable and subject to UAE law, to reimburse the Company for reasonable, documented, and proportionate onboarding, training, education, administrative, time-investment, tools, materials, and Company-provided lead/data costs incurred specifically for the Employee. This clause shall not apply to any costs that UAE law prohibits the Company from recovering from the Employee. After six months of completed employment, the Employee shall not owe reimbursement for ordinary onboarding or training costs unless another separate written agreement applies.",
      "10. Return and Deletion of Company Property — Upon request or termination, the Employee must immediately return all Company property, documents, devices, access cards, passwords, files, contracts, client lists, data, leads, and materials, and permanently delete Company information from personal phones, laptops, drives, WhatsApp, emails, cloud storage, and social media accounts.",
      "11. Penalties, Damages, and Indemnity — If the Employee misuses confidential information, steals data, diverts leads, closes Company clients outside the Company, shares information with competitors, or causes commission loss, the Company may claim damages, lost commission, indemnity, injunctions, legal costs, investigation costs, and any other remedies available under UAE law. Any fixed penalty amount shall be subject to UAE law and court adjustment where applicable.",
      "",
      "Master Clause — Data, Leads & Commission Protection: The parties acknowledge that the Company’s leads, client data, property data, CRM records, WhatsApp inquiries, owner contacts, buyer contacts, seller contacts, tenant contacts, landlord contacts, developer relationships, investor contacts, referral sources, pricing, commission arrangements, and business opportunities are valuable commercial assets of the Company. No person receiving such information may use, copy, export, screenshot, transfer, sell, leak, conceal, redirect, close, or exploit such information for personal benefit or for any third party. Any transaction connected to Company data, leads, clients, introductions, or relationships must be completed only through the Company unless the Company gives prior written approval. Any breach may result in claims for damages, lost commission, indemnity, injunctions, legal costs, investigation costs, and any other remedy available under UAE law.",
      "Master Clause — Legal Enforceability: If any clause is found invalid, excessive, or unenforceable, it shall be interpreted and reduced to the maximum extent permitted by UAE law, and the remaining clauses shall remain valid and enforceable.",
    ].join("\n"),
    fields: [
      RECIPIENT_NAME,
      { key: "jobTitle", label: "Employee Position", type: "text" },
      { key: "restrictionPeriod", label: "Non-Solicit Restriction Period", type: "text", placeholder: "12 months", default: "12 months" },
      { key: "geographicScope", label: "Geographic Scope (Non-Compete)", type: "text", placeholder: "Dubai / UAE / specific area", default: "Dubai, UAE" },
      START_DATE,
    ],
  },
  {
    ...
    description: "Influencer / consultant / marketing collaboration with deliverables, fees, lead ownership and non-circumvention.",
    icon: Handshake,
    emailSubject: "Collaboration Agreement — JBJ GLOBAL REAL ESTATE",
    aiInstructions: [
      "Draft a UAE Collaboration Agreement between JBJ GLOBAL REAL ESTATE and the Collaborator using the EXACT structure below. Use <h2> for numbered headings, <p> for body. Substitute placeholders only if values are provided; otherwise keep brackets.",
      "",
      "1. Collaboration Purpose — The parties agree to collaborate for: [Purpose].",
      "2. Deliverables — The Collaborator shall provide: [Deliverables]. Delivery Date: [Delivery Date]. Platform/Location: [Platform].",
      "3. Fees and Payment — Total Fee: [Fee]. Payment Terms: [Payment Terms]. Invoice Required: [Yes/No]. No additional fees shall be payable unless agreed in writing.",
      "4. Content Approval — All content, captions, visuals, claims, pricing, payment plans, property details, developer names, and promotional statements must be approved in writing by the Company before publication.",
      "5. No False Claims — The Collaborator shall not make false, misleading, exaggerated, unapproved, or non-compliant claims about any property, developer, return on investment, payment plan, discount, guarantee, licensing, or availability.",
      "6. Confidentiality — The Collaborator shall keep confidential all Company information, campaign details, client data, leads, prices, contracts, strategies, and unpublished materials.",
      "7. Leads and Inquiries — All inquiries, leads, messages, calls, and client contacts generated from the collaboration shall belong to the Company unless otherwise agreed in writing. The Collaborator shall not redirect, sell, retain, or close such leads independently.",
      "8. Non-Circumvention — The Collaborator shall not bypass the Company by directly dealing with its clients, developers, owners, suppliers, employees, or partners introduced through this collaboration.",
      "9. Intellectual Property — Unless otherwise agreed, approved final content may be used by the Company for marketing, reposting, ads, presentations, websites, CRM, and business purposes.",
      "10. Cancellation — [Cancellation Terms]. If the Collaborator fails to deliver approved deliverables, the Company may request correction, replacement, refund, or damages.",
      "11. Breach — The Collaborator shall indemnify the Company for losses, claims, penalties, reputational damage, legal costs, and lost business caused by breach, false claims, misuse of data, or unauthorized publication.",
      "12. Governing Law — This Agreement shall be governed by UAE law and the applicable laws of [Emirate].",
    ].join("\n"),
    fields: [
      { key: "recipientName", label: "Collaborator Name", type: "text", required: true },
      { key: "counterparty", label: "Collaborator Company / Handle", type: "text" },
      { key: "purpose", label: "Collaboration Purpose", type: "textarea", required: true, placeholder: "Marketing campaign, content, event, property promotion…" },
      { key: "deliverables", label: "Deliverables", type: "textarea", required: true },
      { key: "platform", label: "Platform / Location", type: "text", placeholder: "Instagram / TikTok / Event / Office" },
      { key: "deliveryDate", label: "Delivery Date", type: "date" },
      { key: "fee", label: "Total Fee (AED)", type: "text", required: true },
      { key: "paymentTerms", label: "Payment Terms", type: "text", placeholder: "Advance / upon completion / milestones" },
      { key: "cancellationTerms", label: "Cancellation Terms", type: "textarea" },
      { key: "emirate", label: "Governing Emirate", type: "text", default: "Dubai" },
      START_DATE,
    ],
  },
...
const CLIENT: DocumentTemplate[] = [
  ...
  {
    id: "post_sale_management_agreement",
    audience: "client",
    label: "Property Management / Holiday-Home Agreement",
    description: "Post-sale client agreement for property management, maintenance and holiday-home operations.",
    icon: Key,
    needsClient: true,
    emailSubject: "Property Management Agreement · JBJ GLOBAL REAL ESTATE",
    aiInstructions: [
      "Draft a UAE post-sale property management / maintenance / holiday-home agreement using the EXACT structure below. <h2> for numbered headings, <p> for body. Substitute placeholders only if values are provided.",
      "",
      "1. Services — The Client appoints the Company to provide: property management, tenant coordination, maintenance coordination, inspection and reporting, holiday-home setup and coordination, cleaning coordination, guest support coordination, furnishing and fit-out coordination, renewal, handover, snagging and contractor follow-up, plus: [Other Services].",
      "2. Authority — The Client authorizes the Company to coordinate with tenants, guests, contractors, building management, developers, authorities, service providers and agents to manage the Property. The Company shall not sign binding legal documents, lease agreements, sale agreements or major contracts on behalf of the Client unless separately authorized in writing.",
      "3. Fees — Property Management Fee: [Management Fee]. Maintenance Coordination Fee: [Maintenance Fee]. Holiday-Home Management Fee: [Holiday Home Fee]. Setup Fee: [Setup Fee]. Renewal Fee: [Renewal Fee]. Other Fees: [Other Fees].",
      "4. Expenses and Third-Party Costs — The Client is responsible for all third-party costs including maintenance, repairs, cleaning, furnishing, utilities, service charges, permits, approvals, government fees, contractor charges, guest supplies and emergency works. The Company may request advance payment before arranging third-party services.",
      "5. Maintenance — The Company may coordinate maintenance using approved contractors. The Company is not liable for contractor defects, delays, warranties or workmanship unless caused by the Company’s proven gross negligence or willful misconduct. Emergency works required to protect the Property, guest safety, building safety or prevent further damage may be arranged up to AED [Emergency Limit] without prior approval. Amounts above this require Client approval where reasonably possible.",
      "6. Holiday-Home Operations — If holiday-home services are selected, the Client acknowledges that operations may require permits, platform listings, photography, cleaning, guest rules, pricing, availability calendars, check-in procedures, deposits and compliance with applicable regulations. The Company does not guarantee occupancy, income, rental yield, guest behavior, platform approval or market performance unless expressly agreed in writing.",
      "7. Client Responsibilities — The Client shall provide: proof of ownership or authority, keys/access cards, building rules, utility details, permit documents, payment for approved expenses, accurate property information and timely approvals.",
      "8. Commission and Agency Protection — If any tenant, buyer, guest, contractor, investor or client introduced by the Company enters into a transaction relating to the Property, the Company shall be entitled to its agreed fee or commission. The Client shall not bypass the Company or directly deal with Company-introduced contacts to avoid fees.",
      "9. Confidentiality — The Client shall keep confidential the Company’s pricing, contractors, operational methods, guest strategy, management systems, documents and business information.",
      "10. Limitation of Liability — The Company shall not be liable for market conditions, vacancy, tenant default, guest misconduct, building restrictions, authority delays, contractor failures, utility issues, force majeure or third-party acts. The Company’s liability shall be limited to fees paid to the Company under this Agreement for the affected service, except in cases of proven fraud, gross negligence or willful misconduct.",
      "11. Indemnity — The Client shall indemnify the Company against claims, penalties, losses, damages, complaints, authority fines, guest claims, tenant claims, contractor claims and third-party costs arising from the Property, Client instructions, unpaid expenses, inaccurate information or breach of this Agreement.",
      "12. Term and Termination — This Agreement starts on [Start Date] and continues for [Term]. Either party may terminate by giving [Notice Period] days’ written notice. All unpaid fees, approved expenses, commissions and third-party costs remain payable after termination.",
      "13. Governing Law — This Agreement shall be governed by UAE law and the applicable laws of [Emirate].",
    ].join("\n"),
    fields: [
      { key: "recipientName", label: "Client / Owner Name", type: "text", required: true },
      { key: "propertyRef", label: "Property Address / Unit", type: "text", required: true },
      { key: "managementFee", label: "Property Management Fee", type: "text", placeholder: "AED 5,000 / year or 5%" },
      { key: "maintenanceFee", label: "Maintenance Coordination Fee", type: "text" },
      { key: "holidayHomeFee", label: "Holiday-Home Management Fee", type: "text", placeholder: "% of gross revenue" },
      { key: "setupFee", label: "Setup Fee", type: "text" },
      { key: "renewalFee", label: "Renewal Fee", type: "text" },
      { key: "otherFees", label: "Other Fees", type: "text" },
      { key: "otherServices", label: "Other Services (if any)", type: "textarea" },
      { key: "emergencyLimit", label: "Emergency Approval Limit (AED)", type: "text", placeholder: "2,000", default: "2,000" },
      { key: "term", label: "Term", type: "text", placeholder: "12 months, auto-renew" },
