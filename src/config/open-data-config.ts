 ...
 * All data sources are official government open data
 */
...
export const OPEN_DATA_SOURCES: OpenDataSource[] = [
  ...
  },
  {
    ...
    description: 'Real estate transaction data',
    updateFrequency: 'monthly',
    lastUpdated: '2026-01-01',
    dataTypes: ['sales', 'rentals', 'registrations'],
  },
];
...
// Simulated aggregated data from open sources
...
export const MARKET_OVERVIEW_STATS = {
  ...
  dataSource: 'Dubai Government Open Data',
};
...
export const MARKET_DISCLAIMER = `Market Intelligence is powered by official government Open Data and aggregated analytics.
