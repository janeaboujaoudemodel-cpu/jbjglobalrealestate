...
export const AI_OUTPUT_SAFEGUARDS = {
  ...
  mandatory_disclosures: {
    ...
    not_advice: {
      required: true,
      text: 'This is not financial, legal, or investment advice.',
    },
    consult_professional: {
      required: true,
      text: 'Consult a licensed professional for personalized guidance.',
    },
    data_limitations: {
      required: true,
...
export function getAIDisclosure(type: 'full' | 'compact' | 'minimal' = 'full'): string {
  switch (type) {
    case 'full':
      return `This content is AI-generated by JBJ GLOBAL REAL ESTATE for informational purposes only. It is not financial, legal, or investment advice. Market conditions change and past performance does not guarantee future results. Always consult licensed professionals for personalized guidance regarding BUY · SELL · RENT decisions.`;
    case 'compact':
      return `AI-generated content for information only. Not financial advice. Consult professionals for guidance.`;
    case 'minimal':
      return `AI-generated | For information only`;
    default:
