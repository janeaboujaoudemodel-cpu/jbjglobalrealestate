...
export const COMPANY_NAP = {
  ...
  description:
    "RERA-licensed Dubai brokerage for luxury apartments, villas, penthouses and off-plan investments across the UAE. Buy, sell, rent or list with JBJ.",
  shortDescription:
    "RERA-licensed Dubai brokerage for luxury apartments, villas, penthouses and off-plan investments across the UAE. Buy, sell, rent or list with JBJ.",
  ...
  // Contact
  phoneE164: "+971541515015", // Display / tel: links
  phoneDisplay: "+971 54 15 15 015",
  whatsappE164: "+971541515015",
