...
export const toolColorThemes: Record<string, {
  ...
  'neighborhood-insights': { bg: 'bg-teal-950/40', accent: 'text-teal-400', border: 'border-[color:var(--emerald-1)]/30/30', gradient: '/20 to-teal-950/40', ring: 'ring-teal-500/30' },
  ...
  // Investment
  'roi-calculator': { bg: 'bg-emerald-950/40', accent: 'text-emerald-400', border: 'border-[color:var(--emerald-1)]/30/30', gradient: '/20 to-emerald-950/40', ring: 'ring-emerald-500/30' },
  ...
  'rental-index': { bg: 'bg-emerald-950/40', accent: 'text-emerald-400', border: 'border-[color:var(--emerald-1)]/30/30', gradient: '/20 to-emerald-950/40', ring: 'ring-emerald-500/30' },
  'investment-report': { bg: 'bg-green-950/40', accent: 'text-green-400', border: 'border-[color:var(--emerald-1)]/30/30', gradient: '/20 to-green-950/40', ring: 'ring-green-500/30' },
  ...
  // Communication
  'email-generator': { bg: 'bg-teal-950/40', accent: 'text-teal-400', border: 'border-[color:var(--emerald-1)]/30/30', gradient: '/20 to-teal-950/40', ring: 'ring-teal-500/30' },
  ...
  'cv-builder': { bg: 'bg-emerald-950/40', accent: 'text-emerald-400', border: 'border-[color:var(--emerald-1)]/30/30', gradient: '/20 to-emerald-950/40', ring: 'ring-emerald-500/30' },
  ...
  'followup-scheduler': { bg: 'bg-green-950/40', accent: 'text-green-400', border: 'border-[color:var(--emerald-1)]/30/30', gradient: '/20 to-green-950/40', ring: 'ring-green-500/30' },
  ...
  'image-resize': { bg: 'bg-teal-950/40', accent: 'text-teal-400', border: 'border-[color:var(--emerald-1)]/30/30', gradient: '/20 to-teal-950/40', ring: 'ring-teal-500/30' },
};
