...
export const ACCOUNT_SHORTCUTS: AccountShortcut[] = [
  ...
  { href: "/favorites",                   label: "Favorites",         icon: Heart,            description: "Your saved properties", inHeader: true, inSidebar: true },
  { href: "/favorites?tab=shortlist",     label: "Shortlisted",       icon: Star,             inSidebar: true },
  { href: "/favorites?tab=designs",       label: "My Design",         icon: PenTool,          description: "Your saved design work", inHeader: true, inSidebar: true },
