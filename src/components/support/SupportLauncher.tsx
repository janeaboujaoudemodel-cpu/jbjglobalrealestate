...
export default function SupportLauncher() {
  ...
  return (
    <>
      ...
      {/* Desktop vertical "Contact Us" edge tag removed per owner directive —
          it was rendering as a rogue emerald vertical bar across the site.
          Mobile FAB above remains the sole support launcher. */}
    </>
  );
}
