...
export const recipientColorStyles = [
  ...
  { bg: "jj-surface-emerald", border: "border-[color:var(--emerald-1)]/30", text: "text-[color:var(--emerald-1)]", light: "jj-emerald-soft", hex: "#059669" },
  { bg: "bg-purple-500", border: "border-purple-500", text: "text-purple-700", light: "bg-purple-50", hex: "#B89555" },
  { bg: "bg-orange-500", border: "border-orange-500", text: "text-orange-700", light: "bg-orange-50", hex: "#EA580C" },
  { bg: "bg-pink-500", border: "border-pink-500", text: "text-pink-700", light: "bg-pink-50", hex: "#B89555" },
];
