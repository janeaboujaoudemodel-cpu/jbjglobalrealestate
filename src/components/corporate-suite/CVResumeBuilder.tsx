...
// ─── PDF Export ───────────────────────────────────────────────────────────────
async function exportCVAsPDF(data: CVData, template: Template, options?: { qrEnabled?: boolean; qrData?: string; qrColor?: string; qrSize?: number }) {
  ...
  if (options?.qrEnabled && options?.qrData) {
    try {
      ...
      // Silent fail — don't block PDF export
    }
  }
