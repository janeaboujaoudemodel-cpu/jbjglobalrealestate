...
const TEMPLATES: LandingTemplate[] = [
  ...
  },
  {
    ...
    colors: { primary: '#ffffff', secondary: '#000000', accent: '#C8A766', bg: '#111111', text: '#ffffff' },
    font: 'Montserrat',
    layout: 'centered',
  },
  {
    ...
    colors: { primary: '#10b981', secondary: '#1e293b', accent: '#34d399', bg: '#0f172a', text: '#e2e8f0' },
    font: 'Nunito',
    layout: 'card-grid',
  },
  {
    ...
    colors: { primary: '#1a1a1a', secondary: '#f5f0eb', accent: '#8B7355', bg: '#faf8f5', text: '#1a1a1a' },
  ...
  },
  {
    ...
    colors: { primary: '#C8A766', secondary: '#f8f6f3', accent: '#A8925A', bg: '#ffffff', text: '#1a1a1a' },
    font: 'Cinzel',
    layout: 'centered',
  },
];
