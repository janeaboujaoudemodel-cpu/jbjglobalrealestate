  ...
  return (
    <div className="min-h-screen bg-[#F7F2EA]">
      ...
      <GlobalContactGating>
        ...
        */}
        <main data-company-legal-page={isCompanyLegalPage ? "true" : undefined} className={`jj-main-shell w-full max-w-full overflow-x-hidden bg-[#F7F2EA] min-h-screen transition-[margin-left,width] duration-100 ease-out ${usesStandalonePortalChrome ? "jj-main-shell--standalone" : ""} ${needsHeaderSpacing && !isHomePage ? "pt-[56px]" : "pt-0"}`}>
