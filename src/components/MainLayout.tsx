...
const MainLayout = ({ children }: MainLayoutProps) => {
  ...
  return (
    <div className="min-h-screen bg-background md:bg-[#E8DCC8]">
      ...
      <GlobalContactGating>
        <main className={`w-full max-w-full overflow-x-hidden transition-all duration-300 ${!isBackOfficeRoute ? "[body.jj-vertical-nav-active_&]:md:pl-[200px] [body.jj-vertical-nav-collapsed_&]:md:pl-[48px]" : ""} ${needsHeaderSpacing ? "pt-24 sm:pt-28 md:pt-[88px]" : "md:pt-0 pt-0"}`}>
