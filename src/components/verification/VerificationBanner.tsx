  ...
  return (
    <>
      <motion.div
        ...
        className="relative overflow-hidden bg-[#142d52]"
      >
        <div className="max-w-[1600px] mx-auto px-4 py-4 sm:py-5 relative z-10">
          <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-5">
            {/* Shield icon */}
            <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-[#1d3d66] border border-white/20 flex items-center justify-center">
