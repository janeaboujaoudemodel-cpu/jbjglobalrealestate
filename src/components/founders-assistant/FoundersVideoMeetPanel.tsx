  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="bg-white border-2 border-[#B89555]/30 hover:border-[#B89555]/50 transition-all cursor-pointer group" onClick={() => setIsCreating(true)}>
            ...
            <CardContent className="space-y-4">
              ...
              {generatedLink && (
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="mt-4 p-4 rounded-lg bg-green-50 border-2 border-green-500/30">
                  ...
                  <div className="flex items-center gap-2 mb-3">
                    <Input value={generatedLink} readOnly className="bg-white border-[#B89555]/30 text-black flex-1" />
          ...
          {scheduledMeetings.length === 0 ? (
            ...
            <div className="space-y-3">
              {scheduledMeetings.map((meeting) => (
                <Card key={meeting.id} className="bg-white border-2 border-[#B89555]/10">
