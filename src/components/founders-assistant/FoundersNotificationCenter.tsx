                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center justify-between gap-2">
                              <p className={`font-medium text-sm truncate ${notification.is_read ? 'text-[#1A1A1A]/70' : 'text-[#1A1A1A]'}`}>
                            ...
                            {notification.subject && (
                              <p className={`text-sm truncate mt-1 ${notification.is_read ? 'text-[#1A1A1A]/70' : 'text-[#1A1A1A]/70'}`}>
                                {notification.subject}
                              </p>
                            )}
                            <p className="text-xs text-[#1A1A1A]/70 line-clamp-2 mt-1">{notification.content}</p>
                            <div className="flex items-center justify-between mt-3">
                              ...
                              <button
                                ...
                                className="p-1.5 rounded-lg opacity-0 group-hover:opacity-100 hover:bg-red-50 text-[#1A1A1A]/70 hover:text-red-500 transition-all"
                              >
