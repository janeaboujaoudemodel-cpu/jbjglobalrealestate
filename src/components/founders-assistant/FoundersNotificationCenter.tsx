...
const categoryConfig: Record<string, { color: string; bgColor: string; borderColor: string }> = {
  ...
  spam: { color: 'text-gray-600', bgColor: 'bg-gray-50', borderColor: 'border-gray-200' },
};
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            {notification.subject && (
                              <p className={`text-sm truncate mt-1 ${notification.is_read ? 'text-gray-600' : 'text-gray-700'}`}>
                                {notification.subject}
                              </p>
                            )}
                            ...
                            <div className="flex items-center justify-between mt-3">
                              ...
                              <button
                                ...
                                className="p-1.5 rounded-lg opacity-0 group-hover:opacity-100 hover:bg-red-50 text-gray-600 hover:text-red-500 transition-all"
                              >
