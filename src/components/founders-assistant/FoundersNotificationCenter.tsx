...
const categoryConfig: Record<string, { color: string; bgColor: string; borderColor: string }> = {
  ...
  spam: { color: 'text-[#5A4A2E]', bgColor: 'bg-[#F7F2EA]', borderColor: 'border-[#B89555]/30' },
};
                ...
                <button
                  ...
                  className={`flex-1 px-3 py-2 rounded-lg text-xs font-medium transition-all ${
                    activeTab === tab 
                      ...
                      : 'text-[#5A4A2E] hover:text-[#1A1A1A] hover:bg-[#B89555]/10'
                  }`}
                >
              ...
              <div className="p-4 space-y-2">
                {loading ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-[#1A1A1A] font-medium">No notifications</p>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center justify-between gap-2">
                              <p className={`font-medium text-sm truncate ${notification.is_read ? 'text-[#5A4A2E]' : 'text-[#1A1A1A]'}`}>
                            ...
                            {notification.subject && (
                              <p className={`text-sm truncate mt-1 ${notification.is_read ? 'text-[#5A4A2E]' : 'text-[#5A4A2E]'}`}>
                                {notification.subject}
                              </p>
                            )}
                            <p className="text-xs text-[#5A4A2E] line-clamp-2 mt-1">{notification.content}</p>
                            <div className="flex items-center justify-between mt-3">
                              ...
                              <button
                                ...
                                className="p-1.5 rounded-lg opacity-0 group-hover:opacity-100 hover:bg-red-50 text-[#5A4A2E] hover:text-red-500 transition-all"
                              >
