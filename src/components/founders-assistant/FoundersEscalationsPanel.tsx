...
const getEmotionLucideIcon = (emotion: string) => {
  switch (emotion) {
    ...
    default: return <Bell className="h-5 w-5 text-[#1A1A1A]/70" />;
  }
};
        ...
        <Card className="bg-[#FDFBF7] border-2 border-red-300">
          <CardContent className="p-4 text-center">
            <div className="flex items-center justify-center gap-1 mb-1">
              ...
              <p className="text-xs text-[#1A1A1A]/70">Critical</p>
            </div>
        ...
        <Card className="bg-[#FDFBF7] border-2 border-blue-300">
          <CardContent className="p-4 text-center">
            <div className="flex items-center justify-center gap-1 mb-1">
              ...
              <p className="text-xs text-[#1A1A1A]/70">Acknowledged</p>
            </div>
            ...
            {filteredEscalations.length === 0 ? (
              <Card className="bg-[#FDFBF7] border-2 border-[#B89555]/20">
                <CardContent className="p-12 text-center">
                  ...
                  <p className="text-[#1A1A1A]/70">No escalations found</p>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-2 flex-wrap">
                              ...
                              <Badge variant="outline" className="text-xs text-[#1A1A1A]/70 border-[#B89555]/30">
                            ...
                            <p className="text-sm text-[#1A1A1A]/70 mt-2 line-clamp-2">
                              &ldquo;{event.originalMessage}&rdquo;
                            </p>

                            <div className="flex items-center gap-4 mt-3 text-xs text-[#1A1A1A]/70">
                        ...
                        {expandedId === event.id && (
                          ...
                          >
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                              ...
                              <div className="bg-[#F7F2EA] rounded-lg p-3 border border-[#B89555]/30">
                                <p className="text-xs text-[#1A1A1A]/70">Keywords</p>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-[#F7F2EA] rounded-lg p-4 border border-[#B89555]/30 text-center">
              <Bell className="h-6 w-6 text-[#1A1A1A]/70 mx-auto mb-2" />
              <p className="text-2xl font-bold text-[#1A1A1A]/70">
                {allEscalations.filter(e => e.emotionAnalysis.sentiment === 0).length}
              </p>
              <p className="text-xs text-[#1A1A1A]/70">Neutral</p>
            </div>
            <div className="bg-amber-50 rounded-lg p-4 border border-amber-200 text-center">
              ...
              <p className="text-xs text-[#1A1A1A]/70">Concerned</p>
            </div>
            <div className="bg-red-50 rounded-lg p-4 border border-red-200 text-center">
              ...
              <p className="text-xs text-[#1A1A1A]/70">Unhappy</p>
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <DialogContent className="bg-[#FDFBF7] border-2 border-[#B89555]/30">
          ...
          {selectedEscalation && (
            <div className="space-y-4">
              ...
              <div>
                <label className="text-sm text-[#1A1A1A]/70 mb-1 block">Resolution Notes</label>
                <Textarea
