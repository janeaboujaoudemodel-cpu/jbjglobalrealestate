...
const BusinessSuiteToolCard = ({
  ...
  return (
    ...
    >
      <Link
        to={href}
        className={`flex flex-col h-full p-5 rounded-2xl bg-[#FDFBF7]/70 backdrop-blur-sm border-2 ${borderColorClass} hover:border-gold/60 hover:shadow-[0_8px_32px_rgba(200,167,102,0.25)] transition-all duration-300 group`}
      >
