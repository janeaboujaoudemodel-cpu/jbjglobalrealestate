...
const BusinessSuiteToolCard = ({
  ...
  return (
    ...
    >
      <Link
        to={href}
        className={`block p-6 rounded-xl bg-zinc-900/80 border ${borderColorClass} hover:border-opacity-60 transition-all duration-300 group`}
      >
        <div className={`w-12 h-12 rounded-lg bg-gradient-to-br ${gradientFrom} ${gradientTo} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}>
