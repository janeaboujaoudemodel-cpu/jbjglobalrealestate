  ...
  return (
    ...
    >
      ...
      >
        ...
        <h3 className={`text-base font-bold text-gray-900 group-hover:text-gold mb-2 transition-colors`}>
          {title}
        </h3>
        <p className="text-sm text-gray-600 leading-relaxed flex-grow min-h-[60px]">
          {description}
        </p>
