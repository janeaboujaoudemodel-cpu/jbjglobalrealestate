    ...
    <div className="border-2 border-gold/30 rounded-2xl bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] shadow-lg overflow-hidden">
      ...
      <div className="p-6 border-b border-gold/20 bg-gradient-to-r from-purple-900/10 to-purple-800/5">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Powered by advanced market analysis</p>
          </div>
        </div>
      </div>
      ...
      {isLoading && !insights && (
        <div className="p-8 space-y-4">
          ...
          <p className="text-gray-500 text-sm text-center">Loading market intelligence for {name}...</p>
          {isTimedOut && (
            <div className="text-center mt-4">
              <p className="text-gray-500 text-sm mb-2">Taking longer than expected...</p>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="p-4 bg-white/60 rounded-xl border border-gold/20 text-center">
              ...
              <p className="text-xs text-gray-500 mb-1">Supply/Demand</p>
            ...
            <div className="p-4 bg-white/60 rounded-xl border border-gold/20 text-center">
              ...
              <p className="text-xs text-gray-500 mb-1">vs Market</p>
