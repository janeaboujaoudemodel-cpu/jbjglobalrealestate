  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div className="max-w-4xl mx-auto bg-gradient-to-br from-white via-[#FDFBF7] to-[#F5F0E6] backdrop-blur-xl border border-gold/40 rounded-2xl shadow-2xl shadow-gold/10 overflow-hidden">
