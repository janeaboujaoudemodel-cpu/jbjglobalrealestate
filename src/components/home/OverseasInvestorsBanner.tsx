            ...
            {homepageGuideBooks.map((book) => (
              ...
              >
                ...
                <div className="relative flex-shrink-0" style={{ perspective: '1200px' }}>
                  ...
                  <div
                    className="relative w-28 h-40 md:w-32 md:h-44 transition-transform duration-500 group-hover:[transform:rotateY(-8deg)]"
                  ...
                  >
                    ...
                    />
                    {/* 3D Pages edge intentionally removed to avoid white cut-through line on covers */}
                  </div>
                </div>
