...
import { Upload, FolderOpen, PartyPopper, ListChecks, Briefcase, FileSignature, UserCheck, CheckCircle2, Clock, XCircle, ArrowRight, Handshake, Users, MessageSquare, Rocket } from "lucide-react";
...
const DeveloperPortalCTA = () => {
  ...
  // Show to everyone — benefits for unregistered, portal for approved
    ...
    <section className="py-12 md:py-16 bg-gradient-to-br from-[hsl(38,35%,12%)] via-[hsl(36,30%,16%)] to-[hsl(34,25%,12%)]">
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          ...
          {/* ── STATE: Approved — show clickable shortcut cards ── */}
          {isApproved && (
          ...
          {/* ── STATE: Pending — show application status ── */}
          {isPending && (
          ...
          {/* ── STATE: Unregistered — show benefits + CTA ── */}
