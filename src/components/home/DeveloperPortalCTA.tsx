...
const DeveloperPortalCTA = () => {
  ...
  // portal CTA appears. All branches now render through the shared
  // <PortalShowcaseCard /> so the homepage portal pitches stay 1:1.
  // ─────────────────────────────────────────────────────────────────────
  ...
  // BROKER — auth-aware href resolution
  if (isBrokerMode) {
