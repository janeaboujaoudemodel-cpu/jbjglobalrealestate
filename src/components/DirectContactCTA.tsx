    ...
    <section className={`py-12 bg-black ${className}`}>
      <div className="mx-4 sm:mx-6 md:mx-4 lg:mx-6 bg-gradient-to-br from-champagne-light via-champagne to-champagne-dark rounded-2xl border border-gold/30 shadow-[0_0_40px_rgba(200,167,102,0.18)] p-4 sm:p-6 md:p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-4 max-w-2xl mx-auto mb-6">
          ...
          <a 
            href={getWhatsAppUrl()}
            className="flex items-center gap-3 bg-gradient-to-br from-[#FDFBF7] via-[#F5F0E6] to-[#EDE4D3] border-2 border-emerald-500 rounded-xl p-3 sm:p-5 transition-all duration-300 group hover:shadow-[0_8px_25px_rgba(16,185,129,0.4)] hover:-translate-y-2 hover:scale-[1.02]"
          >
          ...
          <a 
            href={getCallUrl()}
            className="flex items-center gap-3 bg-gradient-to-br from-[#FDFBF7] via-[#F5F0E6] to-[#EDE4D3] border-2 border-blue-500 rounded-xl p-3 sm:p-5 transition-all duration-300 group hover:shadow-[0_8px_25px_rgba(59,130,246,0.4)] hover:-translate-y-2 hover:scale-[1.02]"
          >
          ...
          <a 
            ...
            className="flex items-center gap-3 bg-gradient-to-br from-[#FDFBF7] via-[#F5F0E6] to-[#EDE4D3] border-2 border-gold rounded-xl p-3 sm:p-5 transition-all duration-300 group hover:shadow-[0_8px_25px_rgba(200,167,102,0.4)] hover:-translate-y-2 hover:scale-[1.02]"
          >
