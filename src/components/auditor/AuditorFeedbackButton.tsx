  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 z-[9999] w-14 h-14 rounded-full bg-gold hover:bg-gold/90 text-black shadow-2xl flex items-center justify-center transition-all hover:scale-110"
