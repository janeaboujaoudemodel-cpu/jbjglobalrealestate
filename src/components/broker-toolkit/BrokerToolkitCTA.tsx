                ...
                {!user ? (
                  ...
                  >
                    ...
                    <span className="relative flex items-center gap-1">
                      ...
                      <span className="text-black group-hover:text-gold transition-colors">Join Now</span>
                      <span className="text-gold group-hover:text-black transition-colors">— Completely Free</span>
                  ...
                  >
                    ...
                    <span className="relative flex items-center gap-1">
                      ...
                      <span className="text-black group-hover:text-gold transition-colors">Access Your</span>
