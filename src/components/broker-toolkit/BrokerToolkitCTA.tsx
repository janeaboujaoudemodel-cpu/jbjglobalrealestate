...
export function BrokerToolkitCTA() {
  ...
  return (
    <section id="section-cta" className="jj-band jj-band--surface py-14 md:py-20">
      <div className="container mx-auto px-4">
        <motion.div
          initial={{ opacity: 0, y: 16 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="max-w-3xl mx-auto bg-[#FDFBF7] border border-[#B89555]/30 rounded-2xl p-8 md:p-10 text-center"
        >
