...
export function BrokerToolkitCRM() {
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Manage Leads <span className="text-emerald-300">Like a Pro</span>
            </h2>
      ...
      {/* CRM Preview Card - Darker emerald card */}
          ...
          >
            <Card className="bg-gradient-to-br from-emerald-900 via-emerald-800 to-emerald-900 border-2 border-emerald-500/50 shadow-xl shadow-emerald-500/30">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-emerald-100 mb-2 max-w-xl mx-auto">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                  ...
                  >
                    ...
                    <span className="relative flex items-center justify-center gap-2">
                      ...
                      <span className="text-black">CRM Dashboard</span>
