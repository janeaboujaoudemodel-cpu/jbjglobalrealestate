 ...
 * LOCKED DESIGN — Do not modify cover visuals.
 * Clicking triggers the download dialog with email capture.
 */
export default function MarketReportHeroBook({ className, pageSource = "homepage" }: MarketReportHeroBookProps) {
