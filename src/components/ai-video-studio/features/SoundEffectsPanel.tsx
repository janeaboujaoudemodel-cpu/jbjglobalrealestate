            ...
            return (
              <div key={cat.label} className="rounded-lg border border-[#1A1A1A] overflow-hidden">
                <button
                  ...
                  className="w-full flex items-center justify-between px-3 py-2 bg-[#1A1A1A] hover:bg-[#1A1A1A] text-left transition-colors"
                >
                        ...
                        >
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              <p className="text-[11px] font-semibold text-[#1A1A1A] truncate leading-tight">{preset.label}</p>
