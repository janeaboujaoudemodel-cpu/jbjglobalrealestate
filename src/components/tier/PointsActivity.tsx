...
const CATEGORY_BADGES: Record<string, { label: string; className: string }> = {
  'deal': { label: 'Deal', className: 'jj-surface-emerald-soft text-[color:var(--emerald-on)] border-[color:var(--emerald-1)]/30/30' },
                ...
                return (
                  ...
                  >
                    <div className={cn(
                      ...
                      isPositive ? "jj-surface-emerald-soft" : "bg-red-500/20"
                    )}>
                      <Icon className={cn(
                        "w-4 h-4",
