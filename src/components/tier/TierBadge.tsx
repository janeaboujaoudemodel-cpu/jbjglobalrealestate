...
const TIER_CONFIGS: Record<string, { icon: typeof Crown; color: string; bgClass: string }> = {
  // Broker tiers
  'Starter': { icon: Star, color: '#6B7280', bgClass: 'bg-gray-500/20 text-gray-600 border-gray-500/30' },
  ...
  // Client tiers
  'Explorer': { icon: Star, color: '#6B7280', bgClass: 'bg-gray-500/20 text-gray-600 border-gray-500/30' },
