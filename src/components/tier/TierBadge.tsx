...
const TIER_CONFIGS: Record<string, { icon: typeof Crown; color: string; bgClass: string }> = {
  // Broker tiers
  'Starter': { icon: Star, color: '#6B7280', bgClass: 'bg-[#B89555]/20 text-[#5A4A2E] border-[#B89555]/30/30' },
  ...
  // Client tiers
  'Explorer': { icon: Star, color: '#6B7280', bgClass: 'bg-[#B89555]/20 text-[#5A4A2E] border-[#B89555]/30/30' },
