              ...
              <Table>
                ...
                <TableBody>
                  {filteredCommissions.length === 0 ? (
                    <TableRow><TableCell colSpan={6} className="text-center text-gray-600 py-8">No commission records</TableCell></TableRow>
          ...
          <Card className="bg-white border-gray-200">
            ...
            <CardContent>
              <Table>
                ...
                <TableBody>
                  {salaries.length === 0 ? (
                    <TableRow><TableCell colSpan={4} className="text-center text-gray-600 py-8">No salary records</TableCell></TableRow>
                  ) : salaries.map((s) => (
          ...
          <Card className="bg-white border-gray-200">
            ...
            <CardContent>
              <Table>
                ...
                <TableBody>
                  {payments.length === 0 ? (
                    <TableRow><TableCell colSpan={5} className="text-center text-gray-600 py-8">No payment records</TableCell></TableRow>
                  ) : payments.map((p) => (
          ...
          <Card className="bg-white border-gray-200">
            ...
            <CardContent>
              <Table>
                ...
                <TableBody>
                  {summaries.length === 0 ? (
                    <TableRow><TableCell colSpan={6} className="text-center text-gray-600 py-8">No earnings data</TableCell></TableRow>
                  ) : summaries.map((s) => (
                    <TableRow key={s.id} className="border-gray-100 hover:bg-gray-50">
                      <TableCell className="font-medium text-black">{s.employee_name}</TableCell>
                      <TableCell><Badge variant="outline" className="border-gray-300 text-gray-600">{s.department}</Badge></TableCell>
