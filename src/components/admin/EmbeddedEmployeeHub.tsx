          ...
          {filteredMembers.map((member) => {
            ...
            return (
              ...
              >
                ...
                {isTopPerformer && (
                  <div className="absolute top-0 right-0 bg-gradient-to-bl from-gold to-amber-600 text-[#1A1A1A] px-2 py-0.5 text-[10px] font-bold flex items-center gap-1 rounded-bl-lg">
