      ...
      <DialogContent className="bg-zinc-900 border-zinc-700 max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <Tabs defaultValue="profile" className="mt-4">
          ...
          <TabsContent value="profile" className="space-y-4 mt-4">
            ...
            <div>
              <Label className="text-gray-300 mb-2 block">Languages</Label>
            ...
            <div>
              <Label className="text-gray-300 mb-2 block">Specializations</Label>
              <div className="flex flex-wrap gap-2 mb-2">
                {formData.specialization?.map((spec) => (
                  <Badge
                    key={spec}
                    className="bg-gold/20 text-gold flex items-center gap-1"
                  >
                    {spec}
                    <X
                      className="h-3 w-3 cursor-pointer hover:text-red-400"
          ...
          <TabsContent value="behavior" className="space-y-4 mt-4">
            <div>
              <Label className="text-gray-300">Daily Interaction Limit</Label>
              <Input
                type="number"
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label className="text-gray-300">Min Response Delay (seconds)</Label>
                <Input
                  type="number"
              ...
              <div>
                <Label className="text-gray-300">Max Response Delay (seconds)</Label>
                <Input
                  type="number"
          ...
          <TabsContent value="schedule" className="space-y-4 mt-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label className="text-gray-300">Working Hours Start</Label>
                <Input
                  type="time"
              ...
              <div>
                <Label className="text-gray-300">Working Hours End</Label>
                <Input
                  type="time"
          ...
          <TabsContent value="personality" className="space-y-4 mt-4">
            <div>
              <Label className="text-gray-300">Personality Prompt</Label>
              <Textarea
