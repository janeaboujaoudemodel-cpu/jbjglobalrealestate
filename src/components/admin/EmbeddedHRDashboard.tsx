      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        ...
        >
          <CardContent className="pt-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-[#1A1A1A]/70 text-xs">CVs Collected</p>
                <p className="text-2xl font-bold text-amber-600">{statsLoading ? "..." : String(stats?.totalCVs || 0)}</p>
                <p className="text-[10px] text-[#1A1A1A]/70">{stats?.pendingCVs || 0} pending</p>
              </div>
        ...
        <Card className="bg-[#FDFBF7] border-2 border-purple-500/30 cursor-pointer hover:border-purple-500/60 active:scale-95 transition-all" onClick={() => setActiveTab('hunting')}>
          <CardContent className="pt-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-[#1A1A1A]/70 text-xs">AI Insights</p>
