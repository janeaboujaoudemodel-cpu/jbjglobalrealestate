    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        ...
        <Card className="bg-white border-2 border-green-500/30 cursor-pointer hover:border-green-500/60 active:scale-95 transition-all" onClick={() => setActiveTab('performance')}>
          <CardContent className="pt-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-600 text-xs">New Hires</p>
        ...
        >
          <CardContent className="pt-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-600 text-xs">CVs Collected</p>
                <p className="text-2xl font-bold text-amber-600">{statsLoading ? "..." : String(stats?.totalCVs || 0)}</p>
                <p className="text-[10px] text-gray-600">{stats?.pendingCVs || 0} pending</p>
              </div>
        ...
        <Card className="bg-white border-2 border-purple-500/30 cursor-pointer hover:border-purple-500/60 active:scale-95 transition-all" onClick={() => setActiveTab('hunting')}>
          <CardContent className="pt-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-600 text-xs">AI Insights</p>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        <TabsList className="bg-gradient-to-r from-[#F7F1E6] to-[#ECE2D2] border-2 border-gold/30 p-1.5 h-auto flex-wrap rounded-xl shadow-sm">
          <TabsTrigger 
            value="performance" 
            className="gap-2 rounded-lg data-[state=active]:bg-gradient-to-r data-[state=active]:from-[#F7F1E6] data-[state=active]:via-[#ECE2D2] data-[state=active]:to-[#D8C7A6] data-[state=active]:text-black data-[state=active]:border-gold/40 data-[state=active]:shadow-sm text-xs"
          >
