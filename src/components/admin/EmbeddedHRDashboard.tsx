  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        <Card className="bg-[#FDFBF7] border-2 border-gold/30 cursor-pointer hover:border-gold/60 active:scale-95 transition-all" onClick={() => setActiveTab('performance')}>
          <CardContent className="pt-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-[#5A4A2E] text-xs">Active Employees</p>
                <p className="text-2xl font-bold text-[#1A1A1A]">{statsLoading ? "..." : String(stats?.activeEmployees || 0)}</p>
              </div>
        ...
        <Card className="bg-[#FDFBF7] border-2 border-blue-500/30 cursor-pointer hover:border-blue-500/60 active:scale-95 transition-all" onClick={() => setActiveTab('positions')}>
          <CardContent className="pt-4">
            <div className="flex items-center justify-between">
              <div>
        ...
        <Card className="bg-[#FDFBF7] border-2 border-green-500/30 cursor-pointer hover:border-green-500/60 active:scale-95 transition-all" onClick={() => setActiveTab('performance')}>
          <CardContent className="pt-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-[#5A4A2E] text-xs">New Hires</p>
        ...
        <Card 
          className="bg-[#FDFBF7] border-2 border-amber-500/30 cursor-pointer hover:border-amber-500/60 active:scale-95 transition-all"
          onClick={() => setActiveTab('cv-center')}
        >
          <CardContent className="pt-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-[#5A4A2E] text-xs">CVs Collected</p>
                <p className="text-2xl font-bold text-amber-600">{statsLoading ? "..." : String(stats?.totalCVs || 0)}</p>
                <p className="text-[10px] text-[#5A4A2E]">{stats?.pendingCVs || 0} pending</p>
              </div>
        ...
        <Card className="bg-[#FDFBF7] border-2 border-purple-500/30 cursor-pointer hover:border-purple-500/60 active:scale-95 transition-all" onClick={() => setActiveTab('hunting')}>
          <CardContent className="pt-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-[#5A4A2E] text-xs">AI Insights</p>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        <TabsList className="bg-gradient-to-r from-[#F7F1E6] to-[#ECE2D2] border-2 border-gold/30 p-1.5 h-auto flex-wrap rounded-xl shadow-sm">
          <TabsTrigger 
            value="performance" 
            className="gap-2 rounded-lg data-[state=active]:bg-gradient-to-r data-[state=active]:from-[#F7F1E6] data-[state=active]:via-[#ECE2D2] data-[state=active]:to-[#D8C7A6] data-[state=active]:text-[#1A1A1A] data-[state=active]:border-gold/40 data-[state=active]:shadow-sm text-xs"
          >
