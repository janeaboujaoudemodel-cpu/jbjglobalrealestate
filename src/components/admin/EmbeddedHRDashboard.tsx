  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        <Card className="bg-[#FDFBF7] border-2 border-[#B89555]/30 cursor-pointer hover:border-[#B89555]/60 active:scale-95 transition-all" onClick={() => setActiveTab('performance')}>
