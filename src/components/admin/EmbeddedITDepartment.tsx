      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Card className="bg-white border-2 border-blue-500/30">
          <CardContent className="pt-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-500 text-xs">Open IT Tasks</p>
          ...
          <div className="flex items-center gap-2">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-8 bg-white border-2 border-gold/30 text-black w-48 h-9 text-sm placeholder:text-gray-400"
              />
            </div>
            <Button
              size="sm"
