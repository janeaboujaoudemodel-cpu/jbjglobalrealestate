          ...
          <div className="mt-4 border border-zinc-700 rounded-lg overflow-hidden">
            {searchResults.map((project) => (
              <button
                ...
                className="w-full flex items-center justify-between p-4 hover:bg-zinc-800 transition-colors border-b border-zinc-700 last:border-0 text-left"
              >
                <div>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {selectedProjects.map((project, index) => (
              <motion.div
                ...
                className="relative bg-zinc-800/50 border border-zinc-700 rounded-lg p-4"
              >
                <button
        ...
        <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-6">
          ...
          >
            <label className={`flex items-start gap-3 cursor-pointer rounded-xl border-2 p-4 transition-all ${
              recommendationType === "ai" ? "border-purple-500 bg-purple-500/10" : "border-zinc-700 hover:border-zinc-600"
            }`}>
            ...
            <label className={`flex items-start gap-3 cursor-pointer rounded-xl border-2 p-4 transition-all ${
              recommendationType === "manual" ? "border-gold bg-gold/10" : "border-zinc-700 hover:border-zinc-600"
            }`}>
