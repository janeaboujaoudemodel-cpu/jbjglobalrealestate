    ...
    <div className="space-y-8">
          ...
          <div className="space-y-3">
            {selectedProjects.map((project, index) => (
              <motion.div
                ...
                className="flex items-center justify-between p-4 bg-zinc-800/50 border border-gray-700 rounded-lg"
              >
                <div className="flex items-center gap-3">
      ...
      {showBrandingOptions && canCustomBrand && (
        <motion.div
          ...
          className="bg-zinc-900/50 border border-gray-800 rounded-xl p-6"
        >
          <h3 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
      ...
      <div className="flex justify-center">
        <Button
          ...
          className="bg-gradient-to-r from-gold via-gold to-gold-dark text-black hover:brightness-110 py-6 px-8 text-lg"
        >
          {isGenerating ? (
            <>
