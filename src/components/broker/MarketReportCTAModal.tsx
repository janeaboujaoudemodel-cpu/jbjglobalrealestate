...
const CTA_OPTIONS = [
  {
    ...
    subtitle: "Master Real Estate Sales",
    description: "50+ lessons covering closing techniques, lead generation, objection handling, and more",
    icon: GraduationCap,
    color: "from-purple-500 to-purple-700",
    benefits: ["Video courses", "Expert insights", "Certificate on completion"],
    href: "/broker-toolkit#courses",
  },
  {
    id: "tools",
    ...
    benefits: ["PDF generator", "AI recommendations", "Custom branding"],
    href: "/broker-toolkit#pricing",
  },
  {
    id: "full",
    title: "Full Package",
    subtitle: "Academy + Tools",
    description: "Get everything: unlimited access to all courses, tools, and priority support",
    icon: Crown,
    color: "from-gold to-gold-dark",
    benefits: ["Everything included", "Save 40%", "1-on-1 mentorship"],
    href: "/broker-toolkit#pricing",
    recommended: true,
  },
];
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-gradient-to-b from-white via-zinc-50 to-white border-gold/30 text-zinc-900 max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <p className="text-center text-xs text-zinc-400 mt-4">
          Created by Jane Abou Jaoude • Exclusive for JJ Global Capital
        </p>
      </DialogContent>
    </Dialog>
  );
