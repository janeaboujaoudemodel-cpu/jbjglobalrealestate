  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className={`fixed ${isRTL ? 'left-0' : 'right-0'} top-20 lg:top-24 z-[9000] w-full sm:w-[380px] h-[calc(100vh-5rem)] lg:h-[calc(100vh-6rem)] bg-gradient-to-br from-white via-[#FDFBF7] to-[#F5F0E6] border-l-2 border-black shadow-2xl shadow-black/30 flex flex-col overflow-hidden`}
      >
        <ChatHeader 
          step={step} 
