...
const DynamicBrokerSection = ({ forcedUserType }: DynamicBrokerSectionProps) => {
  ...
  return (
    <section className="py-20 md:py-28 bg-gradient-to-br from-[hsl(32,28%,13%)] via-[hsl(33,27%,15%)] to-[hsl(33,28%,11%)]">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          {/* Subtitle */}
          <p className="text-[#1A1A1A]/70 text-lg md:text-xl mb-10 max-w-2xl mx-auto">
            {content.subtitle}
          </p>

          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link aria-label="Open" to={content.primaryButton.link}>
              <Button aria-label="Open" variant="primary" className="gap-2 px-8 py-6 text-lg min-w-[200px]">
                <content.primaryButton.icon className="h-5 w-5" />
                {content.primaryButton.text}
                <ArrowUpRight className="h-5 w-5 text-[#1A1A1A]" />
              </Button>
            </Link>
            <Link aria-label={content.secondaryButton.text} to={content.secondaryButton.link}>
          ...
          <div className="mt-12 flex flex-wrap items-center justify-center gap-2">
            <span className="text-[#1A1A1A]/70 text-sm mr-2">I am a:</span>
