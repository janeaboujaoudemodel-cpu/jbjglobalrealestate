...
export const JBJ_AI_AGENTS: AIAgent[] = [
  {
    ...
    role: 'admin',
    title: 'AI Administrative Director',
  ...
  },
  {
    ...
    name: 'Emily Chen',
    role: 'receptionist',
    title: 'AI Front Desk Coordinator',
  ...
  },
  {
    ...
    name: 'James Anderson',
    role: 'broker',
    title: 'AI Senior Property Advisor',
    avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&h=200&fit=crop&crop=face',
    personality: 'Knowledgeable, consultative, and client-focused. Deep expertise in Dubai real estate market.',
    capabilities: ['Property recommendations', 'Market analysis', 'Investment advice', 'Buyer/seller guidance'],
    isAvailable: true,
  },
  {
    ...
    title: 'AI Property Management Specialist',
