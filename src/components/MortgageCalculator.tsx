    ...
    return (
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-6 md:mb-8">
          ...
          <p className="text-[#5A4A2E] mt-2 md:mt-3 max-w-lg mx-auto text-sm md:text-base">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-6 md:mb-8">
          ...
          <div className="bg-[#FDFBF7] rounded-xl border border-[#B89555]/30 p-4">
            ...
            <Slider
              ...
              className="w-full"
            />
            <div className="flex justify-between text-[10px] text-[#5A4A2E] mt-1">
              <span>AED 500K</span>
              <span>AED 50M</span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
          ...
          <div className="bg-[#FDFBF7] border border-[#B89555]/30 rounded-xl p-4 text-center shadow-sm">
            ...
            <p className="text-[#5A4A2E] font-semibold text-[10px] sm:text-xs mt-1">
          ...
          <div className="bg-[#FDFBF7] border border-[#B89555]/30 rounded-xl p-4 text-center shadow-sm">
            ...
            <p className="text-[#5A4A2E] text-[10px] mt-0.5">Interest: {formatCurrency(calculations.totalInterest)}</p>
          </div>
        </div>
      </div>
    );
