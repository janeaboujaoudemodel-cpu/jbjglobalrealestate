              ...
              <div className="min-w-0 flex-1">
                ...
                {isCombinedMode && investorTierProgress && brokerTierProgress ? (
                  <div className="flex items-center gap-1.5 mt-1.5 flex-wrap">
                    <Badge className="text-xs font-semibold jj-emerald-solid/20 text-[color:var(--emerald-1)] border-[color:var(--emerald-1)]/30/40">
                  ...
                  <>
                    <div className="space-y-1">
                      ...
                      {isOwner && (
                        ...
                        >
                          <div className="w-8 h-8 rounded-lg jj-emerald-solid/10 border-2 border-[color:var(--emerald-1)]/30/40 flex items-center justify-center group-hover:jj-emerald-solid/20 transition-colors">
