  ...
  if (bellOnly) {
    return (
      <button
        ...
        onClick={onOpen}
        className="jj-header-icon-control w-10 h-10 flex items-center justify-center transition-all duration-150 group rounded-full relative"
        aria-label="Notifications"
        data-surface="emerald"
        data-allow-dark-cta
      >
        <Bell
          className="w-4 h-4 transition-colors duration-150 text-white"
