...
const TierCard = ({ tierName, totalPoints, nextTierName, pointsToNext, progressPercent, tierType, compact = false }: TierCardProps) => {
  ...
  const bgClass = isBroker 
    ...
    : 'border-[color:var(--emerald-1)]/30/30 jj-surface-emerald-soft';
  ...
  const badgeClass = isBroker
    ...
    : 'jj-surface-emerald-soft text-emerald-500 border-[color:var(--emerald-1)]/30/40';
          ...
          {isCombinedMode ? (
            ...
            <span className={cn(
              ...
              currentTierType === 'broker' 
                ...
                : 'jj-surface-emerald-soft text-[color:var(--emerald-1)] border border-[color:var(--emerald-1)]/30/30'
            )}>
