...
const PRIORITIES = [
  { value: "low", label: "Low", color: "jj-surface-emerald/15 text-[color:var(--emerald-1)] border-[color:var(--emerald-1)]/30/30" },
      ...
      <DialogContent className="w-[calc(100vw-2rem)] max-w-2xl p-0 overflow-hidden border-2 border-[#B89555]/40 bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="space-y-2">
            <Label className="text-sm font-semibold text-[#1A1A1A]">Task Title *</Label>
            <Input
              value={title}
        ...
        <div className="p-6 pt-3 border-t border-[#B89555]/20 bg-gradient-to-r from-gold/5 to-transparent flex items-center justify-between gap-3">
          ...
          <Button
            ...
            className="bg-gradient-to-r from-gold via-gold to-gold/90 hover:from-gold/90 hover:to-gold text-[#1A1A1A] font-bold px-8 shadow-lg disabled:opacity-50"
          >
            {isSubmitting ? (
