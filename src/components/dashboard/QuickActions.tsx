...
const brokerActions: QuickAction[] = [
  ...
  { label: "Resources", description: "Access broker tools", icon: BookOpen, href: "/broker-resources", color: "text-[#1A1A1A]" },
...
const investorActions: QuickAction[] = [
  ...
  { label: "Market Reports", description: "Access insights", icon: FileText, href: "/market-intelligence", color: "text-[#1A1A1A]" },
...
const ownerActions: QuickAction[] = [
  ...
  { label: "Add Property", description: "List a new property", icon: Plus, href: "/listing-portal", color: "text-[#1A1A1A]" },
  ...
  { label: "Ticket Center", description: "Customer happiness", icon: HelpCircle, href: "/ticket-hub", color: "text-[#1A1A1A]" },
  ...
  { label: "Documents", description: "Manage your files", icon: FolderOpen, href: "/owner/documents", color: "text-[#1A1A1A]" },
...
const developerModeActions: QuickAction[] = [
  ...
  { label: "Request Briefing", description: "Schedule a project briefing", icon: Calendar, href: "/developer-portal?tab=briefing", color: "text-[#1A1A1A]" },
...
const defaultActions: QuickAction[] = [
  ...
  { label: "Contact Us", description: "Get in touch", icon: MessageSquare, href: "/contact", color: "text-[#1A1A1A]" },
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 max-h-[400px] overflow-y-auto jj-scrollbar-gold">
          {actions.map((action, index) => (
            <button
              ...
              className="flex items-center gap-3 rounded-xl border border-border bg-gradient-to-br from-[#F7F1E6] via-[#EDE0C8] to-[#E2D4B8] p-3.5 hover:border-[#B89555]/40 hover:shadow-md transition-all text-left w-full h-[72px]"
            >
              <div className="w-10 h-10 rounded-lg bg-[#FDFBF7]/60 border border-[#B89555]/30 flex items-center justify-center shrink-0">
