    ...
    <div className="min-h-screen bg-gradient-to-br from-[hsl(32,28%,13%)] via-[hsl(33,27%,15%)] to-[hsl(33,28%,11%)] text-white">
      <div className="container mx-auto px-4 py-12">
        ...
        >
                ...
                >
                  ...
                  <CardContent>
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-800">
                      <span className={`text-sm flex items-center gap-2 ${isSelected ? 'text-gold' : 'text-gray-600 group-hover:text-gold'} transition-colors`}>
          ...
          {/* Note */}
          <motion.p variants={fadeInUp} className="text-center text-sm text-gray-600">
