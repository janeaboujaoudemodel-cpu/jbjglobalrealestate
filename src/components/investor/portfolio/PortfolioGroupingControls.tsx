    ...
    <section className="space-y-4">
      ...
      <Tabs value={activeGrouping} onValueChange={(v) => onGroupingChange(v as GroupingType)}>
        <TabsList className="bg-muted/50 h-auto p-1 flex-wrap">
          <TabsTrigger value="objective" className="gap-2 data-[state=active]:bg-gradient-to-r data-[state=active]:from-[#F7F1E6] data-[state=active]:via-[#ECE2D2] data-[state=active]:to-[#D8C7A6] data-[state=active]:border-[#B89555]/40">
            <Target className="w-4 h-4" />
            By Objective
          </TabsTrigger>
          <TabsTrigger value="asset-type" className="gap-2 data-[state=active]:bg-gradient-to-r data-[state=active]:from-[#F7F1E6] data-[state=active]:via-[#ECE2D2] data-[state=active]:to-[#D8C7A6] data-[state=active]:border-[#B89555]/40">
            <Layers className="w-4 h-4" />
            By Asset Type
          </TabsTrigger>
          <TabsTrigger value="location" className="gap-2 data-[state=active]:bg-gradient-to-r data-[state=active]:from-[#F7F1E6] data-[state=active]:via-[#ECE2D2] data-[state=active]:to-[#D8C7A6] data-[state=active]:border-[#B89555]/40">
            <MapPin className="w-4 h-4" />
            By Location
          </TabsTrigger>
          <TabsTrigger value="status" className="gap-2 data-[state=active]:bg-gradient-to-r data-[state=active]:from-[#F7F1E6] data-[state=active]:via-[#ECE2D2] data-[state=active]:to-[#D8C7A6] data-[state=active]:border-[#B89555]/40">
