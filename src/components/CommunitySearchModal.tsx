    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="bg-zinc-950 border-zinc-800 text-white sm:max-w-2xl">
        <DialogHeader>
          ...
          <p className="text-zinc-400 text-sm">Browse all UAE property communities</p>
        </DialogHeader>
        ...
        <div className="relative mt-4">
          ...
          <Input
            ...
            className="pl-12 h-12 bg-zinc-900 border-zinc-800 text-white placeholder:text-zinc-500 focus:border-gold rounded-xl"
          />
          {searchQuery && (
            <button
        ...
        <ScrollArea className="h-[400px] mt-4">
          {isLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-zinc-500">No communities found</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 gap-3">
              {filteredCommunities?.map((community) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {community.location && (
                      <p className="text-zinc-500 text-sm truncate">{community.location}</p>
                    )}
                  </div>
                </Link>
              ))}
