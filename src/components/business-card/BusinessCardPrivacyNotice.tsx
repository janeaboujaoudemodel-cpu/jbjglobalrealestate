    ...
    <div className="min-h-screen bg-gradient-to-br from-zinc-950 via-black to-zinc-950 flex items-center justify-center p-4">
      <Card className="max-w-2xl w-full bg-[#FDFBF7]/80 border-2 border-teal-500/30">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex items-start space-x-3 pt-4 border-t border-[#1A1A1A]/50">
            <Checkbox 
              id="privacy-consent" 
              checked={agreed}
        ...
        <CardFooter className="flex flex-col sm:flex-row gap-3 pt-4">
          <Button 
            variant="outline" 
            className="w-full sm:w-auto border-[#1A1A1A] text-white/85 hover:bg-[#1A1A1A] hover:text-white"
            onClick={onDecline}
          >
