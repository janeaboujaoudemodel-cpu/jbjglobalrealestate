...
export const pagesSEO = {
  ...
  contact: {
    ...
    description: 'Contact JBJ Global Real Estate for property inquiries in Dubai. Call +971 54 15 15 015or email contact@jbj.ae for expert assistance.',
