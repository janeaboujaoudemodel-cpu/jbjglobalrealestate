  ...
  return (
    <section className="py-20 md:py-28 bg-gradient-to-b from-black via-zinc-950 to-black">
      <div className="container mx-auto px-4">
              ...
              <motion.div key={index} variants={fadeInUp}>
                <Card className="bg-zinc-900/60 border-zinc-800 hover:border-gold/40 transition-all duration-300 h-full">
                  <CardContent className="p-5">
                    ...
                    <div className="w-12 h-12 bg-gradient-to-br from-[#FDFBF7] via-[#F5F0E6] to-[#EDE4D3] rounded-xl flex items-center justify-center mb-4 border border-gold/30 shadow-md shadow-gold/20">
        ...
        {/* Benefits Highlights */}
        <motion.div
          className="bg-gradient-to-br from-gold/10 via-gold/5 to-transparent border border-gold/30 rounded-2xl p-8 mb-12"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
          variants={fadeInUp}
