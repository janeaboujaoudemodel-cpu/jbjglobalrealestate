      ...
      <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
        ...
        <div className="flex items-center justify-center lg:justify-start">
          <div className="relative" style={{ perspective: "1500px" }}>
            {/* Ambient glow */}
            <div className="absolute inset-0 bg-gradient-to-br from-gold/20 via-gold/5 to-transparent blur-3xl rounded-full scale-150 -z-10" />
            ...
            >
              ...
              >
                {/* Book Shadow */}
                <div 
                  className="absolute -bottom-8 left-1/2 -translate-x-1/2 w-64 h-12 bg-black/60 blur-2xl rounded-full"
        ...
        <div className="space-y-6">
          ...
          <div className="bg-zinc-900/60 backdrop-blur-sm border border-zinc-800 rounded-2xl p-6 md:p-8">
            <h3 
          ...
          <div className="text-center pt-2">
            <p className="text-zinc-500 text-sm">
              Powered by <span className="text-white font-medium">JJ Global Capital</span>
            </p>
            <p className="text-zinc-600 text-xs mt-1">Part of JJ Holding Group</p>
          </div>
        </div>
      </div>
    </motion.div>
