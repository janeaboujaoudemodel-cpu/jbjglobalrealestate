      ...
      <div className="bg-white rounded-3xl p-8 md:p-12 shadow-2xl shadow-black/50">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="space-y-6">
            ...
            {/* Download Button - Premium 3D Style */}
            <Link to="/market-report" className="block">
              <button 
                className="w-full relative inline-flex items-center justify-center gap-2 px-8 py-7 text-lg font-bold rounded-xl transition-all duration-300 bg-gradient-to-r from-white via-[#FDFBF7] to-[#F5F0E6] border-2 border-gold/50 hover:scale-[1.02] transform active:scale-95 group"
                style={{
                  boxShadow: `
              ...
              >
                ...
                <span className="relative flex items-center justify-center gap-2">
                  <span className="text-gold">Download Your</span>
                  <span className="text-black">Free Book Now</span>
