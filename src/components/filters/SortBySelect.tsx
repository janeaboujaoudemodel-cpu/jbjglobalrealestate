...
export function SortBySelect({
  ...
  return (
    <Select value={value} onValueChange={onChange}>
      <SelectTrigger
        className={`w-[200px] ${h} bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] border-2 border-[#B89555]/40 text-[#1A1A1A] rounded-xl text-sm shadow-sm hover:border-[#B89555] transition-colors ${className}`}
        aria-label="Sort by"
      >
