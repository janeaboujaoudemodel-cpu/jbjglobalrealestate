...
export const AIWebDeveloperPersona: React.FC<AIWebDeveloperPersonaProps> = ({
  ...
  return (
    <div className="space-y-6">
      {/* Persona Header */}
      <Card className="bg-gradient-to-br from-white via-[#FDFBF7] to-[#F5F0E6] border-gold/20 shadow-lg overflow-hidden">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        {/* Task Queue */}
        <Card className="bg-gradient-to-br from-white via-[#FDFBF7] to-[#F5F0E6] border-gold/20">
              ...
              <div className="space-y-3">
                {versions.map((version, index) => (
                  ...
                  >
                    ...
                    <p className="text-sm text-zinc-500 mb-3">{version.description}</p>
                    {index > 0 && isOwner && (
                      <Button 
                        size="sm" 
                        variant="outline"
