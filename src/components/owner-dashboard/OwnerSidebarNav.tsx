    ...
    items: [
      {
        ...
        children: [
          { label: "Overview",            icon: LayoutDashboard, path: "/owner/careers-portal?section=overview" },
          { label: "Open Positions",      icon: Briefcase,       path: "/owner/careers-portal?section=positions" },
          { label: "Applications & CVs",  icon: FileText,        path: "/owner/careers-portal?section=applications" },
          { label: "Candidates",          icon: UserCheck,       path: "/owner/careers-portal?section=candidates" },
          { label: "Hiring & Offers",     icon: FileText,        path: "/owner/careers-portal?section=offers" },
          { label: "Employees",           icon: Users,           path: "/owner/careers-portal?section=employees" },
          { label: "Onboarding",          icon: CheckSquare,     path: "/owner/careers-portal?section=onboarding" },
          { label: "Payroll & Salaries",  icon: BarChart3,       path: "/owner/careers-portal?section=payroll" },
          { label: "Performance",         icon: Star,            path: "/owner/careers-portal?section=performance" },
          { label: "Employee Comms",      icon: MessagesSquare,  path: "/owner/careers-portal?section=comms" },
          { label: "HR Agent (AI)",       icon: Bot,             path: "/owner/careers-portal?section=hr-agent" },
          { label: "Audit & Access",      icon: Shield,          path: "/owner/careers-portal?section=audit" },
        ],
      },
    ],
  },
