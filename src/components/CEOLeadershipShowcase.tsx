...
// Approved CEO landscape photo (executive office with Lebanese & UAE flags) - LOCKED
import ceoLandscapeFlags from "@/assets/ceo/jane-ceo-executive-office-final-v3.jpg";
