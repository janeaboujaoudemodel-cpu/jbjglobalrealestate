...
// Approved CEO landscape photo (executive office with Lebanese & UAE flags) - LOCKED v8 FINAL
import ceoLandscapeFlags from "@/assets/ceo/jane-ceo-executive-office-final-v8.jpg";
