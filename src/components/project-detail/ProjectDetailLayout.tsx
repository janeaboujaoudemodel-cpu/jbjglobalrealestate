...
export default function ProjectDetailLayout({
  ...
  return (
    <>
      ...
      >
        {/* Row 1: Filter Shortcut Bar — hidden on mobile to save vertical space */}
        <div className="hidden sm:block bg-gradient-to-r from-[#FDFBF7] via-[#F5F0E6] to-[#EDE4D3] border-b border-gold/20 py-2 px-4">
