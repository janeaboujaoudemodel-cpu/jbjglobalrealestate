              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <Input 
                            ...
                            {...field}
                            className="bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] border-2 border-[#B89555]/40 focus:border-[#B89555] text-[#1A1A1A] rounded-lg"
                          />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea 
                            ...
                            {...field}
                            className="min-h-[80px] bg-gradient-to-br from-[#FDFBF7] via-[#F7F2EA] to-[#EFE6D6] border-2 border-[#B89555]/40 focus:border-[#B89555] text-[#1A1A1A] rounded-lg"
                          />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                  ...
                  <button
                    ...
                    className="jj-emerald-action w-full h-12 inline-flex items-center justify-center gap-2 text-base font-semibold rounded-md disabled:opacity-60 transition-colors shadow-sm"
                  >
                    {isSubmitting ? (
                      <>
