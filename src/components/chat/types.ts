...
export type ChatStep = 'welcome_choice' | 'shortcuts' | 'cv_submission' | 'check_email' | 'collect_info' | 'chat_history' | 'select_service' | 'agent_joining' | 'chatting' | 'rating' | 'feedback' | 'submitted';
