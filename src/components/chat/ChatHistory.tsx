  ...
  return (
    <div className="flex-1 p-4 overflow-y-auto">
      <div className="text-center mb-4">
        ...
        <p className="text-gray-600 text-sm"><T>Continue a conversation or start fresh</T></p>
      </div>
      ...
      {chatHistory.length > 0 && !isLoading && (
        <div className="relative mb-3">
          ...
          <Input
            ...
            className="pl-9 bg-white/5 border-gray-700 text-white placeholder:text-gray-600 h-9 text-sm"
          />
          {historySearch && (
            <button
      ...
      {isLoading ? (
        ...
        <div className="space-y-2">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-gray-600 text-xs flex-shrink-0 ml-2">{getTimeAgo(updatedAt)}</span>
                    </div>
          ...
          {historySearch && filteredHistory.length === 0 && (
            <p className="text-gray-600 text-sm text-center py-4"><T>{`No conversations match "${historySearch}"`}</T></p>
          )}
        </div>
      ) : (
        <div className="text-center py-6">
          ...
          <p className="text-gray-600 text-sm"><T>No previous conversations</T></p>
