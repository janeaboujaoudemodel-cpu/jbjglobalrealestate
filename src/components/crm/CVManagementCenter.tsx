              ...
              <div className="flex items-start justify-between gap-6">
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-sm">
                    <div>
                      <p className="text-zinc-400 text-xs uppercase tracking-wide font-medium mb-1">Email</p>
                      <p className="text-white font-medium">{cv.email}</p>
                    </div>
                    <div>
                      <p className="text-zinc-400 text-xs uppercase tracking-wide font-medium mb-1">Phone</p>
                      <p className="text-white font-medium">{cv.phone || '—'}</p>
                    </div>
                    <div>
                      <p className="text-zinc-400 text-xs uppercase tracking-wide font-medium mb-1">Experience</p>
                      <p className="text-white font-medium">{cv.experience}</p>
                    </div>
                    <div>
                      <p className="text-zinc-400 text-xs uppercase tracking-wide font-medium mb-1">Education</p>
                      <p className="text-white font-medium">{cv.education}</p>
                    </div>
                    <div>
                      <p className="text-zinc-400 text-xs uppercase tracking-wide font-medium mb-1">Upload Date</p>
