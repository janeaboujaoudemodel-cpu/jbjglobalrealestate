              ...
              <CardContent className="p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="mt-2 flex flex-wrap gap-1.5 text-[11px]">
                      {(r.personal_phone || r.phone_e164) && <a aria-label="Call" href={`tel:${r.personal_phone || r.phone_e164}`} className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full border border-[#B89555]/40 bg-[#F7F2EA] text-[#1A1A1A] hover:bg-[#EFE6D6]"><Phone className="w-3 h-3" />{r.personal_phone || r.phone_e164}</a>}
