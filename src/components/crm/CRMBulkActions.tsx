    ...
    <>
      <div className="fixed bottom-4 left-1/2 -translate-x-1/2 bg-card border border-border rounded-lg shadow-xl p-4 flex items-center gap-3 z-50 flex-wrap max-w-[95vw]">
        ...
        <select
          ...
          disabled={isUpdating}
          className="w-[150px] h-9 px-3 rounded-md border border-gray-700 bg-zinc-950 text-white font-medium focus:outline-none focus:ring-2 focus:ring-primary/50"
        ...
        {brokers.length > 0 && (
          <select
            ...
            disabled={isUpdating}
            className="w-[160px] h-9 px-3 rounded-md border border-gray-700 bg-zinc-950 text-white font-medium focus:outline-none focus:ring-2 focus:ring-primary/50"
            style={{ backgroundColor: '#09090b', color: '#ffffff' }}
            defaultValue=""
          >
