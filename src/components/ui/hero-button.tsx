  ...
  const buttonContent = (
    <button 
      ...
      className={cn(
        ...
        "bg-transparent border border-white/60 hover:border-white hover:bg-[#FDFBF7]",
        className
      )}
      style={{
    ...
    >
      <span className="text-white group-hover:text-[#1A1A1A] transition-colors">{children}</span>
      <ArrowUpRight 
        className="w-3.5 h-3.5 text-white group-hover:text-[#1A1A1A] group-hover:scale-110 transition-all" 
      />
    </button>
  );
