...
>(({ className, children, onPointerDownOutside, onInteractOutside, ...props }, ref) => {
  ...
  return (
    <DialogPortal>
      {!isAdvancedFilterPanel && <DialogOverlay />}
      ...
      >
        ...
        <DialogPrimitive.Close aria-label="Close" className={cn(
          "absolute right-4 top-4 rounded-full aspect-square !w-10 !h-10 !min-w-10 !min-h-10 !max-w-10 !max-h-10 !p-0 flex-none inline-flex items-center justify-center opacity-100 ring-offset-background transition-none focus:outline-none focus:ring-2 focus:ring-[#064E3B]/45 focus:ring-offset-2 disabled:pointer-events-none z-20 leading-none box-border overflow-hidden [&>svg]:shrink-0",
