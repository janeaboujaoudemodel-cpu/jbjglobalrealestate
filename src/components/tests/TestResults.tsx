    ...
    <Card className={cn("bg-[#1A1A1A]/40 border-[#B89555]/20", className)}>
      <CardHeader className="text-center pb-4">
        <div className={cn(
          ...
          passed ? "jj-surface-emerald-soft" : "bg-red-500/20"
        )}>
          {passed ? (
      ...
      <CardContent className="space-y-6">
        ...
        <div className={cn(
          ...
          passed ? "jj-surface-emerald-soft border border-[color:var(--emerald-1)]/30/30" : "bg-red-500/10 border border-red-500/30"
        )}>
          <div className={cn(
          ...
          <Badge className={passed 
            ? "jj-surface-emerald-soft text-[color:var(--emerald-on)] border-[color:var(--emerald-1)]/30/30"
