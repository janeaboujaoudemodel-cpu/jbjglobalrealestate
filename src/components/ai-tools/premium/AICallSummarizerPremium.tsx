...
const AICallSummarizerPremium = () => {
  ...
  const sentimentColor = (s: string) => {
    ...
    return "text-gray-500 bg-zinc-500/20 border-zinc-500/30";
  };
        ...
        <Card className="bg-orange-900/20 border-orange-500/30">
          <CardContent className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <Label className="text-gray-400">Audio Recording (Optional)</Label>
            ...
            <div className="space-y-2">
              <Label className="text-gray-400">Call Notes</Label>
              <Textarea
                value={callNotes}
        ...
        <AnimatePresence mode="wait">
          {result ? (
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-gray-500">Ready to Summarize</h3>
