...
const WHATSAPP_NUMBER = "9741515015";
...
const PropertyReportModal = ({ open, onOpenChange, project }: PropertyReportModalProps) => {
  ...
  if (showReportViewer && reportHtml) {
    return (
      <Dialog open={open} onOpenChange={(isOpen) => {
        ...
        <DialogContent className="bg-[#FDFBF7] border-[#B89555]/30 max-w-4xl h-[90vh] p-0 flex flex-col overflow-hidden">
          {/* Report Viewer Header */}
          <div className="sticky top-0 z-10 bg-[#FDFBF7] border-b border-[#B89555]/30 px-4 py-3 flex items-center justify-between shrink-0">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[#1A1A1A] font-semibold">{project.name} - Report</span>
            </div>
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-[#FDFBF7] border-[#B89555]/30 text-[#1A1A1A] max-w-lg max-h-[85vh] overflow-y-auto my-4">
        <DialogHeader>
