    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          ...
          data-allow-dark-cta
          data-on-dark
          className="jj-header-icon-control allow-white relative h-10 w-10 rounded-full focus:outline-none focus-visible:ring-2 focus-visible:ring-white/40 transition-transform hover:scale-[1.04]"
          style={{
