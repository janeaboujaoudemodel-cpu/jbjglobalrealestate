...
export default function GlobalFilterBar() {
  ...
  return (
    <div
      className="fixed top-[48px] right-0 z-[9996] hidden md:block transition-all duration-300 bg-gradient-to-r from-[#E8DCC8] via-[#DCCFB5] to-[#D4C4A8] border-b border-gold/20 shadow-sm [body.jj-vertical-nav-active_&]:left-[200px] [body.jj-vertical-nav-collapsed_&]:left-[48px] left-[200px]"
    >
