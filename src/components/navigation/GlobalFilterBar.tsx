...
export default function GlobalFilterBar() {
  ...
  return (
    <div
      className="fixed top-[48px] right-0 z-[9996] hidden md:block transition-all duration-300 bg-gradient-to-r from-[hsl(38,35%,12%)] via-[hsl(36,30%,16%)] to-[hsl(34,25%,12%)] border-b border-gold/20 shadow-sm [body.jj-vertical-nav-active_&]:left-[200px] [body.jj-vertical-nav-collapsed_&]:left-[48px] left-[200px]"
    >
