  ...
  const renderNavContent = () => (
    <div data-sidebar-emerald className="flex flex-col h-full w-full min-w-0">
      ...
      <div className="flex-shrink-0">
        ...
        <div className="px-3 pt-3.5 pb-4 bg-gradient-to-t from-[#F0E8D8]/50 to-transparent rounded-xl overflow-hidden">
              ...
              return (
                <>
                  <Link
                    ...
                    className="flex-1 flex items-center justify-center gap-2 text-[12.5px] font-bold tracking-wide leading-none transition-all duration-200 px-2.5 h-11 rounded-lg border will-change-transform"
                  >
                    <span data-emerald-icon-surface className="w-5 h-5 rounded-[5px] flex items-center justify-center">
          ...
          {session ? (
            <button
              ...
              title="Sign Out"
              aria-label="Sign Out"
              className="flex items-center justify-center gap-2 text-[12.5px] font-semibold uppercase tracking-[0.09em] transition-all px-3 h-11 rounded-lg border w-full group"
            ...
            >
              <LogOut data-signout-icon data-no-contrast-guard className="w-4 h-4 jj-signout-icon !text-[#DC2626]" color="#DC2626" stroke="#DC2626" strokeWidth={2.5} style={{ color: '#DC2626', stroke: '#DC2626' }} />
            ...
            <Link
              to="/auth"
              data-no-contrast-guard
              className="flex items-center justify-center gap-2 text-[12.5px] font-semibold transition-all px-3 h-11 rounded-lg border w-full group"
          ...
          <button
            ...
            className="allow-white jbj-sidebar-collapse-control group mt-2 flex items-center justify-center gap-2 w-full px-3 h-11 rounded-lg text-[12px] font-extrabold tracking-[0.22em] uppercase transition-all duration-200 will-change-transform"
            style={{
              color: '#FFFFFF',
          ...
          >
            <PanelLeftClose className="allow-white w-4 h-4 transition-transform duration-200 group-hover:-translate-x-0.5" strokeWidth={2} style={{ color: '#FFFFFF', stroke: '#FFFFFF' }} />
