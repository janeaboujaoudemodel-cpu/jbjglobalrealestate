        ...
        <div className="px-2 py-1 bg-gradient-to-t from-[#F0E8D8]/50 to-transparent rounded-xl overflow-hidden">
              ...
              return (
                <>
                  <Link
                    ...
                    className="flex-1 flex items-center justify-center gap-1.5 text-[11px] font-bold tracking-wide leading-none transition-all duration-200 px-2 h-8 rounded-md border will-change-transform"
                  >
                    <span data-emerald-icon-surface className="w-4 h-4 rounded-[4px] flex items-center justify-center">
          ...
          {session ? (
            <button
              ...
              title="Sign Out"
              aria-label="Sign Out"
              className="flex items-center justify-center gap-1.5 text-[11px] font-semibold uppercase tracking-[0.09em] transition-all px-2 h-8 rounded-md border w-full group"
            ...
            <Link
              to="/auth"
              data-no-contrast-guard
              className="flex items-center justify-center gap-1.5 text-[11px] font-semibold transition-all px-2 h-8 rounded-md border w-full group"
              style={{ color: '#000000', borderColor: 'rgba(0,0,0,0.25)', backgroundColor: '#ffffff' }}
            >
              <User className="w-3.5 h-3.5" style={{ color: '#000000' }} />
          ...
          <button
            ...
            className="allow-white jbj-sidebar-collapse-control group mt-1.5 flex items-center justify-center gap-1.5 w-full px-3 h-8 rounded-md text-[11px] font-extrabold tracking-[0.22em] uppercase transition-all duration-200 will-change-transform"
            style={{
              color: '#FFFFFF',
