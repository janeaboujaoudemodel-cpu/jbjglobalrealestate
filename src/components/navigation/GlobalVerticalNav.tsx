...
export default function GlobalVerticalNav() {
  ...
  // Map prefetch is intentionally hover/focus-only. Auto-prefetching Leaflet +
  // PropertyMap on every page mount competed with the current route's own
  // modules and delayed first meaningful paint by several seconds.
