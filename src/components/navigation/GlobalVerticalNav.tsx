        ...
        <div className="px-4 pt-4 pb-4 bg-gradient-to-t from-[#F0E8D8]/35 to-transparent rounded-xl overflow-hidden">
          ...
          {session ? (
            <button
              ...
              title="Sign Out"
              aria-label="Sign Out"
              className="flex items-center justify-center gap-2 text-[12px] font-semibold uppercase tracking-[0.09em] transition-all px-3 h-10 rounded-lg border w-full group"
          ...
          <button
            ...
            className="allow-white jbj-sidebar-collapse-control group mt-3 flex items-center justify-center gap-2 w-full px-3 h-10 rounded-lg text-[12px] font-extrabold tracking-[0.22em] uppercase transition-all duration-200 will-change-transform"
            style={{
              color: '#FFFFFF',
