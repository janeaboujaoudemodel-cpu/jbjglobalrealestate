 ...
 idx === safeIndex ? 'border-[#B89555]' : 'border-transparent'
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-3">
                  {selectedImport.developer_name && (
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm">
                        <span className="text-[#1A1A1A]/70">Developer:</span>{' '}
                  ...
                  {selectedImport.location && (
                    <div className="flex items-center gap-2">
                      <MapPin className="h-4 w-4 text-[#1A1A1A]/70" />
                      <span className="text-sm">
                        <span className="text-[#1A1A1A]/70">Location:</span>{' '}
                  ...
                  {(selectedImport.bedrooms_min || selectedImport.bedrooms_max) && (
                    <div className="flex items-center gap-2">
                      <Bed className="h-4 w-4 text-[#1A1A1A]/70" />
                      <span className="text-sm">
                        <span className="text-[#1A1A1A]/70">Bedrooms:</span>{' '}
                ...
                <div className="space-y-3">
                  {selectedImport.price_from && (
                    <div className="flex items-center gap-2">
                      <DollarSign className="h-4 w-4 text-[#1A1A1A]/70" />
                      <span className="text-sm">
                        <span className="text-[#1A1A1A]/70">Price From:</span>{' '}
                  ...
                  {selectedImport.size_min && (
                    <div className="flex items-center gap-2">
                      <Ruler className="h-4 w-4 text-[#1A1A1A]/70" />
                      <span className="text-sm">
                        <span className="text-[#1A1A1A]/70">Size:</span>{' '}
                        <span className="font-medium">
              ...
              {selectedImport.payment_plan && (
                <div>
                  ...
                  <p className="text-sm text-[#1A1A1A]/70">{selectedImport.payment_plan}</p>
                </div>
              )}
