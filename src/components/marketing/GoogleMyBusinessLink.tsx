...
export const GoogleMyBusinessLink = ({
  ...
  // Badge variant (default) - Dark premium styling to match footer
  return (
    <a
      href={GMB_URL}
      target="_blank"
      rel="noopener noreferrer"
      className={`inline-flex items-center gap-3 bg-gradient-to-br from-zinc-800/80 via-zinc-900/90 to-black hover:from-zinc-700/80 hover:via-zinc-800/90 border border-gold/20 hover:border-gold/40 rounded-xl px-4 py-3 transition-all group shadow-lg ${className}`}
    >
      <div className="w-10 h-10 bg-zinc-800/50 rounded-lg flex items-center justify-center border border-gold/20">
      ...
      <div className="text-left">
        ...
        <p className="text-zinc-300 text-sm font-medium group-hover:text-gold transition-colors">
