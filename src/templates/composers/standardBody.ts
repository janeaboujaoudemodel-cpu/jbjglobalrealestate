...
const closings: Record<string, (f: Record<string, string>) => string> = {
  job_offer: (f) =>
    `The following standard terms apply to this conditional commission-only offer and are aligned with UAE Federal Decree-Law No. 33 of 2021 on the Regulation of Labour Relations where applicable:\n\n1. Zero Salary — Salary is zero (AED 0). This conditional offer does not grant any fixed payment.\n\n2. Commission Only — Before formal employment/onboarding is documented in writing after the first Company-approved deal, the only monetary entitlement is the commission expressly agreed in the offer: 65% Broker / 35% Company for Broker-sourced direct deals; 55% Broker / 45% Company for Company-sourced leads; and 70% Broker / 30% Company only for the Company-approved premium tier after AED 10,000,000 Company-recognised sales in one year and written management approval. Commission is payable only after JBJ GLOBAL REAL ESTATE receives cleared funds and confirms entitlement in writing. Otherwise, nothing else is owed, processed, provided, reimbursed, or promised.\n\n3. First-Deal Milestone — Formal employment/onboarding, if any, may be considered only after the first Company-approved transaction is closed and the Company receives at least AED 50,000 net cleared commission.\n\n4. Limited Onboarding Items — After the first-deal milestone and written Company approval, the only Company-supported onboarding items contemplated are visa processing, Emirates ID, medical insurance, and RERA card only, subject to legal eligibility, government approval, RERA/DLD requirements, internal approval, and written Company confirmation. No other item is included.\n\n5. Working Hours / Cooperation — Your expected availability is ${f.workingHours || "Monday to Friday: 10:00 AM – 7:00 PM\nSaturday: 11:00 AM – 4:00 PM"}. This does not create any salary entitlement before formal employment/onboarding is approved and documented in writing.\n\nPlease confirm your acceptance of this conditional commission-only offer by countersigning a copy of this letter and returning it to JBJ GLOBAL REAL ESTATE no later than seven (7) calendar days from the date of issue.${f.notes ? `\n\n${f.notes}` : ""}`,
  employment_contract: (f) =>
