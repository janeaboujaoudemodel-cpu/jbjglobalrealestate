...
function composeJobOffer(input: ComposerInput): string {
  ...
  const clauses = [
    ...
    offerClause(4.1, "Company-Approved Premium Tier", `The <strong>Company-approved premium tier</strong> is not automatic. It applies only to the Employee's own direct deals after the Employee achieves at least <strong>AED 10,000,000</strong> in Company-recognised sales volume within one (1) calendar year, and only after written management approval. Once approved, eligible own direct deals may be paid at <strong>70% to the Broker and 30% to the Company</strong> of the net commission actually received by the Company, calculated only on cleared funds received by the Company from the relevant developer, seller, landlord, buyer, client, or third party, after any lawful deductions, chargebacks, cancellations, reversals, taxes, portal/referral costs, or agreed transaction expenses. Company-sourced leads remain governed by the Company-sourced tier (55% Broker / 45% Company) unless the Company expressly approves otherwise in writing.`),
    ...
    offerClause(8, "Conflict of Interest & Non-Compete (During and Post-Employment)", `<strong>During your employment and for a period of two (2) years following its termination</strong> (for any reason, whether by resignation, termination, non-renewal, or mutual separation), you shall not, <strong>directly or indirectly</strong>, whether in your own name or through any spouse, relative, nominee, partner, shareholder, employee, agent, or affiliated entity (existing or to be incorporated): (a) <strong>own, establish, register, incorporate, license, operate, manage, control, or hold any economic interest in any real estate company, brokerage, agency, marketing agency, holiday-home operator, property management company, or commission-based real-estate vehicle</strong> within the United Arab Emirates; (b) work for, represent, advise, consult for, partner with, or financially participate in any business competing with the Company within the UAE real-estate sector; or (c) use, exploit, or benefit from any Company lead, client, Confidential Information, pricing intelligence, or market data acquired during your employment. This restriction is reasonable in scope, geography, and duration given the Company's investment in leads, training, data, and market positioning, and is in addition to all confidentiality and non-solicitation obligations.`),
    ...
    offerClause(12, "Separation & Post-Termination Commission", `Upon resignation or termination, and throughout any notice or run-off period, the enhanced commission uplift described in Clause 4 (65% Broker / 35% Company on direct deals and 55% Broker / 45% Company on Company-sourced deals) and the premium tier in Clause 4.1 (70% Broker / 30% Company) shall <strong>cease to apply</strong> and the commission split shall <strong>revert to the standard 50% Broker / 50% Company</strong> on both direct and Company-sourced deals. Pipeline deals that close after the effective end of employment shall be remunerated, if at all, at the standard 50/50 split and only where the Company has actually received cleared commission, in each case subject to UAE Federal Decree-Law No. 33 of 2021, its Executive Regulations, and any separate written agreement signed by the Parties.`),
    offerClause(13, "Deal Closure, Commission Qualification and Company Determination", `A deal shall be considered closed for commission purposes only when a sale, lease, assignment, referral, or other real-estate transaction has been fully executed by the relevant parties, accepted by the Company in accordance with its internal policy, and the Company has received the required cleared payment, deposit, commission, referral fee, or other consideration from the client, developer, landlord, seller, buyer, tenant, or third party. The Company's determination as to whether a transaction qualifies as a closed deal, the applicable source category, and the commission entitlement shall be final where made in good faith and consistently applied. No oral discussion, WhatsApp message, pipeline entry, booking, reservation, viewing, lead allocation, or pending transaction creates a commission entitlement unless confirmed by the Company in writing and supported by cleared funds actually received by the Company.`),
    offerClause(14, "Qualifications, Declarations and Performance Undertaking", `The Employee confirms that all qualifications, licences, experience, references, statements, documents, and declarations provided to the Company are true, complete, and not misleading. Any fraudulent, inaccurate, withheld, or materially misleading information may be treated as serious misconduct and grounds for immediate disciplinary action or termination in accordance with applicable UAE law. The Employee further undertakes to perform all assigned duties diligently, ethically, and to the best of their abilities; to achieve agreed objectives; to actively develop job skills; to follow Company policies, procedures, CRM requirements, data-handling rules, and lawful instructions; and to conduct themselves in a manner consistent with the laws, customs, traditions, professional standards, and real-estate regulatory expectations of the United Arab Emirates.`),
    offerClause(15, "Management Instructions, Mobility and Business Requirements", `The Employee's duties, reporting line, place of work, working hours, field attendance, developer-office attendance, client meeting schedule, lead-management process, and operational priorities may be adjusted from time to time by the Company in line with business requirements, applicable UAE law, and Company policy. The Employee shall cooperate with reasonable changes, attend required meetings, viewings, trainings, developer briefings, inspections, and client appointments, and perform any related tasks assigned by management that are connected to the Company's real-estate brokerage, marketing, administration, compliance, client-service, or business-development activities.`),
    offerClause(16, "Visa, Permits and Regulatory Eligibility", `Any visa, work permit, labour approval, RERA/DLD broker registration, portal access, SIM card, business tools, or other eligibility support is subject to the Employee providing complete and accurate documents, satisfying legal and regulatory requirements, signing the Company's required documents, and meeting any Company performance, compliance, or deal-closure conditions communicated in writing. Nothing in this offer prevents the Company from delaying, withholding, suspending, or withdrawing such support where documents are incomplete, conditions are not met, regulatory approval is refused, or the Employee breaches Company policy, confidentiality, data-protection, or lead-handling obligations.`),
    offerClause(17, "Conditional Offer and Governing Law", `This offer is conditional upon satisfactory completion of documentation, background verification where applicable, visa/work permit and regulatory requirements where applicable, and signing all Company documents, including the related NDA and employment documents. All terms not expressly stated in this offer shall be governed by the applicable UAE Labour Law, its Executive Regulations, and the Company's lawful policies as updated from time to time. This offer and the related signed documents form the entire understanding between the Parties regarding the subject matter and supersede prior oral or written discussions to the extent they conflict with the signed documents.`),
    backdatedClause ? offerClause(18, "Retroactive Effective Date for Leads & Confidential Data", backdatedClause) : "",
  ].join("");
