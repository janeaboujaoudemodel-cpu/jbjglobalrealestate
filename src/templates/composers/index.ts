...
function composeJobOffer(input: ComposerInput): string {
  ...
  const compensationTerms = compensationAndCommissionTable(
    [
      ["Salary", "AED 0 — zero salary; commission-only as set out in the Commission Tiers below", "salary"],
      ["Post-first-deal onboarding items only", "Only after the first Company-approved deal is closed, the Company receives the required cleared commission, and formal employment/onboarding is documented and approved in writing: visa processing, Emirates ID, medical insurance, and RERA card only — no other items", "postFirstDealBenefits"],
  ...
  const clauses = [
    ...
    offerClause(11, "Zero Salary and Commission Before Documented Onboarding", `Before formal employment/onboarding is approved and documented in writing by the Company, <strong>Salary is zero (AED 0)</strong>. You shall not be entitled to any fixed payment, visa processing, Emirates ID, medical insurance, RERA card, or any other onboarding item unless and until you close the first Company-approved deal, the Company receives the required cleared commission, and the Company confirms formal onboarding in writing. After that first-deal milestone and written Company approval, the only Company-supported onboarding items are <strong>visa processing, Emirates ID, medical insurance, and RERA card only</strong>. Your only monetary entitlement under this conditional offer is the commission expressly agreed above: <strong>65% Broker / 35% Company for Broker-sourced direct deals</strong>, <strong>55% Broker / 45% Company for Company-sourced leads</strong>, and <strong>70% Broker / 30% Company only for Company-approved premium-tier direct deals after AED 10,000,000 Company-recognised sales in one year and written management approval</strong>. Any commission or success fee shall only be payable if approved in writing by the Company and only after the Company has actually received the relevant cleared funds. The Company shall determine in good faith whether a transaction qualifies for commission, whether you were the effective cause of the transaction, whether the transaction was Company-approved, whether the commission was actually received, and whether any deductions, reversals, refunds, cancellations, disputes, or third-party claims apply. No verbal promise, WhatsApp message, client discussion, lead allocation, viewing, booking, pending deal, or expected payment shall create a commission entitlement unless confirmed in writing by the Company. The AED 50,000 net cleared commission milestone must first be achieved before the Company considers full onboarding, formal employment/onboarding documentation, visa processing, Emirates ID, medical insurance, RERA card, or any further arrangement.`),
    ...
    offerClause(15, "Zero Salary and Limited Onboarding Items", `The agreed salary under this conditional offer is <strong>zero (AED 0)</strong>. Until the first Company-approved deal is closed, the required cleared commission is received by the Company, and formal employment/onboarding is approved and documented in writing, your only monetary entitlement is the commission expressly agreed in this document and actually payable under its terms. Before that documented onboarding approval, you shall not be entitled to visa processing, Emirates ID, medical insurance, RERA card, or any other onboarding item. After those conditions are satisfied, the only Company-supported onboarding items contemplated by this document are <strong>visa processing, Emirates ID, medical insurance, and RERA card only</strong>, subject always to legal eligibility, government approval, RERA/DLD requirements, internal approval, and written Company confirmation. Nothing in this clause limits any rights that may be mandatory under applicable UAE law if a competent authority determines that an employment relationship legally exists.`),
