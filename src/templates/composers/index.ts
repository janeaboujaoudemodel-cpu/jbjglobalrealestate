...
function composeJobOffer(input: ComposerInput): string {
  ...
  const clauses = [
    ...
    offerClause(11, "Zero Salary, Commission Only and Commission Qualification", `The Candidate's salary under this offer is <strong>AED 0</strong>. The Candidate is not entitled to any fixed salary, fixed allowance, fixed payment, or guaranteed monthly income. The Candidate's only monetary entitlement is commission, where the commission is expressly earned under this document, approved by the Company, and payable after the Company has actually received the relevant cleared commission. The standard Company commission structure is <strong>50% Broker / 50% Company</strong> for both direct deals and Company-sourced leads. However, because the Candidate is expected to perform additional duties beyond sales, including administrative support, HR support, marketing support, phone-based content tasks, developer coordination, Company coordination, and other management-assigned tasks, the Company has agreed to an enhanced commission structure as follows: (1) <strong>65% Broker / 35% Company</strong> for the Candidate's own direct deals; (2) <strong>55% Broker / 45% Company</strong> for Company-sourced leads; (3) <strong>70% Broker / 30% Company</strong> for Company-approved premium-tier direct deals only after the Candidate achieves AED 10,000,000 in Company-recognised sales in one year and receives written management approval. The enhanced commission structure is conditional upon the Candidate continuing to perform the additional administrative, HR, marketing, coordination, and support duties required by the Company. If the Candidate stops performing these duties, is repeatedly absent from them, refuses them, neglects them, or performs only sales duties, the Company may revert the Candidate's commission to the standard 50% Broker / 50% Company structure from the start of the next applicable commission period or as otherwise notified by the Company. No commission or success fee shall be payable unless approved in writing by the Company and unless the Company has actually received the relevant cleared funds. The Company shall determine in good faith whether a transaction qualifies for commission, whether the Candidate was the effective cause of the transaction, whether the transaction was Company-approved, whether the commission was actually received, and whether any deductions, reversals, refunds, cancellations, disputes, or third-party claims apply. No verbal promise, WhatsApp message, client discussion, lead allocation, viewing, booking, pending deal, or expected payment shall create a commission entitlement unless confirmed in writing by the Company.`),
