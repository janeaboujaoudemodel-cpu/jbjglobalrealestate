...
export const FOOTER_ICON_SVG: Record<"location" | "phone" | "mail" | "globe", string> = {
  ...
  location: `<svg width="12" height="12" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="display:block;width:12px;height:12px;flex:0 0 12px;overflow:visible;shape-rendering:geometricPrecision;"><path d="M8 14.25s5-4.45 5-8.05A5 5 0 0 0 3 6.2c0 3.6 5 8.05 5 8.05Z" fill="none" stroke="${JBJ_GOLD}" stroke-width="1.35" stroke-linecap="round" stroke-linejoin="round"/><circle cx="8" cy="6.25" r="1.72" fill="none" stroke="${JBJ_GOLD}" stroke-width="1.2"/></svg>`,
  // Hollow handset — elegant single-line construction
  phone: `<svg width="12" height="12" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="display:block;width:12px;height:12px;flex:0 0 12px;overflow:visible;shape-rendering:geometricPrecision;"><path d="M4.08 2.05 5.9 4.5c.3.4.24.96-.13 1.3l-.9.83a.56.56 0 0 0-.12.66 9.05 9.05 0 0 0 3.96 3.96c.23.11.5.06.66-.12l.83-.9a.96.96 0 0 1 1.3-.13l2.45 1.82c.43.32.52.93.2 1.36l-.63.84c-.56.75-1.54 1.05-2.43.75-4.6-1.53-8.4-5.33-9.93-9.93-.3-.89 0-1.87.75-2.43l.84-.63c.43-.32 1.04-.23 1.36.2Z" fill="none" stroke="${JBJ_GOLD}" stroke-width="1.35" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
  // Hollow envelope — kept refined, now outline-only for parity with the other icons
  mail: `<svg width="12" height="12" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="display:block;width:12px;height:12px;flex:0 0 12px;overflow:visible;shape-rendering:geometricPrecision;"><rect x="1.75" y="3.5" width="12.5" height="9" rx="1.35" fill="none" stroke="${JBJ_GOLD}" stroke-width="1.3"/><path d="M2.55 4.55 8 8.42l5.45-3.87" fill="none" stroke="${JBJ_GOLD}" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
  // Hollow globe with meridians + equator
  globe: `<svg width="12" height="12" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="display:block;width:12px;height:12px;flex:0 0 12px;overflow:visible;shape-rendering:geometricPrecision;"><circle cx="8" cy="8" r="6.15" fill="none" stroke="${JBJ_GOLD}" stroke-width="1.25"/><ellipse cx="8" cy="8" rx="2.55" ry="6.15" fill="none" stroke="${JBJ_GOLD}" stroke-width="1.05"/><path d="M2.15 8h11.7M3.75 4.55h8.5M3.75 11.45h8.5" fill="none" stroke="${JBJ_GOLD}" stroke-width="1.05" stroke-linecap="round"/></svg>`,
};
