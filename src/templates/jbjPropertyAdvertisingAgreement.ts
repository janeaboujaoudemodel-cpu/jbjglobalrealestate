...
export function buildPAAHtml(
  ...
  const html = `
<div dir="ltr" style="direction:ltr;unicode-bidi:isolate;writing-mode:horizontal-tb;transform:none;font-family:Inter,Arial,sans-serif;color:${ink};background:${chrome.surface};padding:24px 36px 0;max-width:794px;margin:0 auto;line-height:1.45;font-size:11.5px;min-height:1123px;display:flex;flex-direction:column;box-sizing:border-box;">
