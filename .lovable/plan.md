...
2. The backend outreach function still hard-appends the wrong CC email: `info.jane@gmail.com`.
...
- Replace every wrong `info.jane@gmail.com` reference with the correct `infoo.jane@gmail.com` in:
...
- Verify with a search that no `info.jane@gmail.com` remains anywhere in the project.