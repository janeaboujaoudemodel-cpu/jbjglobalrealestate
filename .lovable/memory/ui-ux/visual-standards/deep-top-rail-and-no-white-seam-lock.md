...
- The vertical rail (collapsed and expanded, Moon / default) is always darkest at the very top (#01120b), slightly lifted mid-rail (#043524 ~46%), black at the bottom. Any new rule must outrank `html[data-jbj-theme="moon"]:not([data-jbj-backend-lock="1"])` from pass-305, which otherwise repaints the rail with the bright-top `--jj-long-emerald-v`.
