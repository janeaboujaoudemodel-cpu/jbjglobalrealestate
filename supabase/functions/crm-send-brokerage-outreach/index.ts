...
serve(async (req: Request) => {
  ...
  <tr><td align="center" style="padding:22px 16px 18px;background:#ffffff;border-bottom:1px solid rgba(184,149,85,0.4);">
    <img src="https://mdafrewypkkrildjgtey.supabase.co/storage/v1/object/public/email-assets/brand/citi-developers-gold.png" alt="Citi Developers" width="96" height="96" style="display:block;width:96px;height:96px;max-width:96px;margin:0 auto 10px;object-fit:contain;" />
