...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:separate;background:linear-gradient(135deg,#fdfbf7,#F7F2EA);border:2px solid #C8A766;border-radius:18px;margin:16px 0 24px;">
<tr><td style="padding:24px;text-align:center;">
<p style="font-size:16px;color:#333;font-style:italic;margin:0;">"${ideaTitle}"</p>
</td></tr></table>
