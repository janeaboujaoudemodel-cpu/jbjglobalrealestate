  ...
  const defaultKnowledge = [
    {
      ...
      content: 'JBJ Global Real Estate L.L.C S.O.C. is a premier real estate brokerage based in Dubai, UAE. Founded by Jane Bou Jaoude, the company specializes in off-plan properties, luxury real estate, and investment advisory. Contact: +971 54 15 15 015, contact@jbj.ae',
