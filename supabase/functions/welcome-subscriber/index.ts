...
const resend = new Resend(Deno.env.get("RESEND_API_KEY"), { baseUrl: "https://api.ap.resend.com" });
...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const emailResponse = await resend.emails.send({
      from: "JBJ Global Real Estate <newsletter@jbjglobalrealestate.com>",
      to: [email],
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <a href="https://jbjglobalrealestate.lovable.app/properties" class="cta-button">
                Browse Properties →
              </a>
            </div>
            <div class="footer">
