...
export function buildEnvelopeEmailHtml(args: BuildEnvelopeEmailArgs): string {
  ...
  // Premium two-step CTA stack. Both buttons share width, padding and
  // corner geometry so they read as a paired set, not a stretched bar.
  // Step labels live ABOVE the buttons in fine champagne tracking — no
  // bold dividers inside the buttons themselves.
