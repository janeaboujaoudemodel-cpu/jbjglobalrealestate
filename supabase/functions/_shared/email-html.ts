...
export function sharedHeader(departmentLabel: string): string {
  return `<tr><td style="background:#000;padding:28px 32px 24px;text-align:center;">
...
export function lockIconBadge(size = 64): string {
  ...
  return `<table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center"><tr><td style="width:${size}px;height:${size}px;background:linear-gradient(135deg,#fdfbf7,#f5f0e6);border:2px solid #C8A766;border-radius:999px;text-align:center;vertical-align:middle;"><img src="${ICON_LOCK}" alt="Security lock" width="${iconSize}" height="${iconSize}" style="width:${iconSize}px;height:${iconSize}px;display:block;margin:0 auto;" /></td></tr></table>`;
}
...
export function ticketSupportEmbed(): string {
  return `<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:20px 0;"><tr><td style="padding:24px;background:linear-gradient(135deg,#fff5f5,#ffe8e8,#fef2f2);border:2px solid #e74c3c;border-radius:20px;text-align:center;"><img src="${ICON_HEADPHONES}" alt="Support" width="30" height="30" style="display:block;margin:0 auto 10px;" /><p style="margin:0 0 4px;font-size:11px;font-weight:700;color:#e74c3c;text-transform:uppercase;letter-spacing:2px;">24/7 SUPPORT</p><p style="margin:0 0 6px;font-size:16px;font-weight:700;color:#7f1d1d;">Need Help? Open a Support Ticket</p><p style="margin:0 0 14px;font-size:13px;color:#991b1b;">Our team typically responds within 24 hours</p><a href="${SITE_URL}/support" style="display:inline-block;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;text-decoration:none;padding:12px 30px;border-radius:12px;font-weight:700;font-size:13px;">Submit a Ticket</a></td></tr></table>`;
}

function recommendedCard(title: string, href: string, iconUrl: string): string {
  return `<td width="33%" style="text-align:center;padding:4px;vertical-align:top;"><a href="${href}" style="display:block;padding:14px 8px;background:#fff;border:2px solid #C8A766;border-radius:16px;text-decoration:none;"><img src="${iconUrl}" alt="${title}" width="24" height="24" style="display:block;margin:0 auto 8px;" /><p style="margin:0;font-size:12px;color:#1a1a1a;font-weight:700;text-transform:uppercase;letter-spacing:0.5px;">${title}</p></a></td>`;
}

export function recommendedActionsHtml(): string {
  return `<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:28px 0 22px;border-top:2px solid #C8A76633;padding-top:24px;"><tr><td style="text-align:center;"><p style="color:#1a1a1a;font-size:16px;font-weight:700;margin:0 0 14px;">Recommended For You</p><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"><tr>${recommendedCard("AI Tools", `${SITE_URL}/ai-tools`, ICON_AI_TOOLS)}${recommendedCard("Guides", `${SITE_URL}/guides`, ICON_GUIDES)}${recommendedCard("Properties", `${SITE_URL}/properties`, ICON_PROPERTIES)}</tr></table></td></tr></table>`;
}

function bookCard(title: string, subtitle: string, href: string, img: string): string {
  return `<td width="50%" style="text-align:center;padding:4px;vertical-align:top;"><a href="${href}" style="display:block;padding:14px 10px;background:#fff;border:2px solid #C8A766;border-radius:16px;text-decoration:none;"><img src="${img}" alt="${title}" width="120" style="width:120px;max-width:100%;height:auto;display:block;margin:0 auto 10px;border-radius:8px;box-shadow:8px 10px 0 #e8dcc6;" /><p style="margin:0 0 4px;font-size:13px;color:#1a1a1a;font-weight:700;">${title}</p><p style="margin:0;font-size:11px;color:#777;">${subtitle}</p></a></td>`;
}

export function booksShowcaseHtml(): string {
  return `<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:10px 0 18px;"><tr><td style="text-align:center;"><p style="color:#1a1a1a;font-size:14px;font-weight:700;margin:0 0 12px;">Explore Our Books Library</p><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"><tr>${bookCard("Market Report Book", "3D Market Intelligence", `${SITE_URL}/market-intelligence`, BOOK_MARKET_REPORT)}${bookCard("Guides Book Library", "3D Guides Collection", `${SITE_URL}/guides`, BOOK_GUIDES_LIBRARY)}</tr></table></td></tr></table>`;
}

export function suggestedActionsHtml(): string {
  return `<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:14px 0;"><tr><td width="50%" style="padding:4px;"><a href="${SITE_URL}/properties" style="display:block;padding:12px 8px;background:#fff;border:1px solid #C8A76650;border-radius:12px;text-decoration:none;text-align:center;"><span style="font-size:13px;color:#1a1a1a;font-weight:600;">Explore Properties</span></a></td><td width="50%" style="padding:4px;"><a href="${SITE_URL}/ai-tools" style="display:block;padding:12px 8px;background:#fff;border:1px solid #C8A76650;border-radius:12px;text-decoration:none;text-align:center;"><span style="font-size:13px;color:#1a1a1a;font-weight:600;">AI Tools</span></a></td></tr></table>`;
}
...
export function feedbackHtml(context = "general"): string {
  ...
  return `<table width="100%" cellpadding="0" cellspacing="0" style="border-top:2px solid #C8A76633;padding-top:24px;margin-top:22px;"><tr><td align="center"><p style="color:#1a1a1a;font-size:16px;font-weight:700;margin:0 0 6px;">We Value Your Feedback</p><p style="color:#888;font-size:13px;margin:0 0 18px;">Help us improve by sharing your experience</p><table cellpadding="0" cellspacing="0" align="center"><tr><td style="padding:0 6px;"><a href="${reviewUrl}" style="display:inline-block;background:#000;color:#C8A766;text-decoration:none;padding:12px 26px;border-radius:10px;font-weight:700;font-size:13px;border:1px solid #C8A76650;">Leave a Review</a></td><td style="padding:0 6px;"><a href="${surveyUrl}" style="display:inline-block;background:#FDFBF7;border:2px solid #C8A766;color:#1a1a1a;text-decoration:none;padding:10px 24px;border-radius:10px;font-weight:700;font-size:13px;">Take Survey</a></td></tr></table></td></tr></table>`;
}
...
export function readyToGetStartedHtml(): string {
  return `<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:24px 0;background:linear-gradient(135deg,#000,#1a1a1a);border-radius:20px;overflow:hidden;"><tr><td style="padding:26px 20px;text-align:center;"><p style="color:#C8A766;font-size:18px;font-weight:700;margin:0 0 8px;">Ready to Get Started?</p><p style="color:#b9b9b9;font-size:13px;margin:0 0 18px;">Reach out anytime — our team is ready to help.</p><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td width="50%" style="text-align:center;padding:8px;"><p style="color:#C8A766;font-size:11px;text-transform:uppercase;letter-spacing:1px;margin:0 0 4px;">Email</p><a href="mailto:CONTACT@JBJ.AE" style="color:#fff;text-decoration:none;font-size:13px;font-weight:600;">CONTACT@JBJ.AE</a></td><td width="50%" style="text-align:center;padding:8px;"><p style="color:#C8A766;font-size:11px;text-transform:uppercase;letter-spacing:1px;margin:0 0 4px;">Phone</p><a href="tel:+971565911000" style="color:#fff;text-decoration:none;font-size:13px;font-weight:600;">+971 56 591 1000</a></td></tr></table><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:16px;border-top:1px solid #C8A76655;padding-top:14px;"><tr><td style="text-align:center;"><p style="color:#C8A766;font-size:12px;font-weight:700;letter-spacing:1px;margin:0 0 8px;text-transform:uppercase;">Stay in the Loop</p><a href="${SITE_URL}/market-intelligence" style="display:inline-block;color:#fff;text-decoration:none;font-size:12px;border:1px solid #C8A76666;border-radius:999px;padding:8px 16px;">Market updates & new launches</a></td></tr></table></td></tr></table>`;
}
...
export function arabicDivider(): string {
  return `<tr><td style="padding:40px 32px 4px;text-align:center;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="border-top:2px solid #C8A76650;"></td></tr></table></td></tr>`;
}
