  ...
  <div class="page">
    ...
    <div class="cta-box">
      ...
      <div class="cta-buttons">
        <a href="https://wa.me/971541515015?text=${encodeURIComponent(`Hi, I'm interested in ${project.name}. Please share more details.`)}" class="cta-button" target="_blank">
        ...
        <a href="tel:+971541515015" class="cta-button cta-button-white">
    ...
    <div class="footer">
      ...
      <div class="contact-grid">
        ...
        <div class="contact-item">
          ...
          <a href="tel:+971541515015" class="contact-link">+971 54 15 15 015</a>
        </div>
        <div class="contact-item">
          <svg class="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
