...
serve(async (req) => {
  ...
  try {
    ...
    // Build system prompt
    const systemPrompt = `You are a professional real estate consultant at JJ Global Capital, a premium Dubai real estate brokerage.
...
Sign emails as "JJ Global Capital Team".`;
