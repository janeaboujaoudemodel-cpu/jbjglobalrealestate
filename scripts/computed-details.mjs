...
console.log(await page.locator('button[data-emerald-action="true"]').first().evaluate(el=>{const cs=getComputedStyle(el); return {color:cs.color, fill:cs.webkitTextFillColor, transition:cs.transition, animation:cs.animation, animationName: cs.animationName, animationDuration: cs.animationDuration, opacity:cs.opacity, forcedColorAdjust:cs.forcedColorAdjust, all:cs.all, classes:el.className, parent:el.parentElement?.outerHTML.slice(0,250)}}));
await browser.close();
