...
const staticEntries: SitemapEntry[] = [
  ...
  { path: "/guides/selling-off-plan-dubai-before-handover", changefreq: "monthly", priority: "0.85" },
  { path: "/insights/future-of-real-estate-2026", changefreq: "monthly", priority: "0.90" },
  { path: "/ai-hub", changefreq: "weekly", priority: "0.78" },
  { path: "/toolkit/voice-studio", changefreq: "monthly", priority: "0.65" },
  { path: "/toolkit/background-ai", changefreq: "monthly", priority: "0.65" },
