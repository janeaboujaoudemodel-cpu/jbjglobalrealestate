  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Default Tailwind palettes (emerald/red/blue/amber/purple/etc.) restored —
        // semantic data colors used by KPI tiles, charts, and IconTile tones.
      },
      /* ============================================================
