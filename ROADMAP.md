...
- [x] **JBJ-032 — Two independent "who is owner" definitions (audit 3.4). RESOLVED (Aug 17), with the drift guard that was the real gap.**
...
- [x] **JBJ-033 — Three green CI gates were reporting "failure" because posting their PR comment 403'd. RESOLVED (Aug 18).**
...
- [x] **JBJ-034 — The tool-emerald audit silently passed routes it never measured, and its breach count was not reproducible. RESOLVED (Aug 18).**
...
- [ ] **JBJ-035 — Report pill snapshot: 5 pills render differently in the PDF than in the preview, at mobile width only. Pre-existing on `main`.**
