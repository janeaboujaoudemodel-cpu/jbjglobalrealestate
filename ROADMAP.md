...
| JBJ-024 | Media ingestion audit (Aug 17): unauthenticated `process-drive-upload`, unvalidated listing-media uploads, all twelve `rel_*` tables readable by any authenticated user, seller step tabs ignoring forward clicks | **Resolved (Aug 17)** — findings 3.2/3.3/3.5/3.6 fixed; `rel-media`/`rel-logos` left public-read deliberately (product decision) | Resolved |
